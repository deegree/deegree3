...
public class FeatureTypeGraph {
    ...
    /**
     * Write a dot file to the given file. The resulting file can be viewed / converted with the 'dot' application, for
     * example call $> dot -Tpng -o out.png your/file.dot to create a png from the the 'dot' file.
     * 
     * @param schema
     ...
     * @throws IOException
     */
    private static void addNode( BufferedWriter out, FeatureType ft )
                            throws IOException {
        if ( ft != null ) {
