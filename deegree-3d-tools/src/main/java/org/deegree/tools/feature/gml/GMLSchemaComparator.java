...
//        System.out.println( "\n\nFeatureType '" + featureName1 + "' (2006) -> '" + featureName2 + "' (2008)\n" );
//
...
//                    System.out.print( " [minOccurs differs (" + declaration1.minOccurs + " != " + declaration2.minOccurs
//                                      + ")]" );
//                }
//                if ( !declaration1.maxOccurs.equals( declaration2.maxOccurs )) {
//                    System.out.print( " [maxOccurs differs (" + declaration1.maxOccurs + " != " + declaration2.maxOccurs
//                                      + ")]" );
//                }
//                if ( !declaration1.typeName.getLocalPart().equals( declaration2.typeName.getLocalPart())) {
//                    System.out.print( " [type differs (" + declaration1.typeName.getLocalPart() + " != " + declaration2.typeName.getLocalPart()
//                                      + ")]" );
//                }
//                System.out.println ();
//            } else {
//                System.out.println( " - " + declaration1.name.getLocalPart() + ": no match [" + declaration1.toString() + "]" );
//            }
//        }
//
...
//                System.out.println( " - " + declaration.name.getLocalPart() + "[" + declaration.toString() + "]" );
//            }
//        }
    }
...
//        System.out.println( newFeatureDeclarations.size() + " feature declarations with same name:" );
//        for ( String string : newFeatureDeclarations ) {
//            comparator.compareFeatureContentModel( string, string );
//        }
//
//        comparator.compareFeatureContentModel( "GemeentelijkComplex", "Structuurvisiecomplex_G" );
//        comparator.compareFeatureContentModel( "ProvinciaalComplex", "Structuurvisiecomplex_P" );
//        comparator.compareFeatureContentModel( "NationaalComplex", "Structuurvisiecomplex_R" );
//        comparator.compareFeatureContentModel( "GemeentelijkGebied", "Structuurvisiegebied_G" );
//        comparator.compareFeatureContentModel( "ProvinciaalGebied", "Structuurvisiegebied_P" );
//        comparator.compareFeatureContentModel(  "NationaalGebied", "Structuurvisiegebied_R" );
//
//        comparator.compareFeatureContentModel( "StructuurvisieGebied", "Structuurvisieplangebied_G" );
//        comparator.compareFeatureContentModel( "ProvinciaalPlangebied", "Structuurvisieplangebied_P" );
//        comparator.compareFeatureContentModel( "NationaalPlangebied", "Structuurvisieplangebied_R" );
    }
}
