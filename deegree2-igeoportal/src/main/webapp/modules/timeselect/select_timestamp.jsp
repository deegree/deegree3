	...
	<head>
		...
		<script language=javascript>
            ...
            function init() {
                ...
                var layerGroups = opener.parent.controller.mapModel.getLayerList().layerGroups;
             ...
             function initGUI() {
          	...
          	function accept() {
                ...
                // (comment out the blocks in function init() and in html as well)                 
              	...
              	var layerList = opener.parent.controller.mapModel.getLayerList();
              	for ( var i = 0; i < lgs.length; i++) {
            	  	var layerGroup = layerList.getLayerGroupByURL( lgs[i] );
            	  	layerGroup.setTime( s );
              	}
          	  	opener.parent.controller.repaint();
              	window.close();
          	}
		  	//-->
		</script>
	</head>
	<body onload="init()" class="pDateTimeDialog">
