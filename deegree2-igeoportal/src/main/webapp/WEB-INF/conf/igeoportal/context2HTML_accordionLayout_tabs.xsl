...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cntxt="http://www.opengis.net/context" xmlns:sld="http://www.opengis.net/sld" xmlns:deegree="http://www.deegree.org/context" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <!-- 
        ...
        - frontend: creates table structure for arranging footer, header, north, east, south, west and 
                          center section of the client.
        - module: fills the structure
        - init_tabs: creates extJs tabs
    -->
    <xsl:include href="mappanel.xsl"/>
    <xsl:include href="init_tabs.xsl"/>
