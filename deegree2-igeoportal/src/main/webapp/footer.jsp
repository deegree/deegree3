...
<html>
    ...
    <body class="pFooter">
        <p class="pFooter">deegr<span class="pFooter" style="color:#EE7000;">ee</span>&nbsp;iGeoPortal v<%=Version.getVersionNumber()%> &copy; <%= Calendar.getInstance().get(Calendar.YEAR) %>&nbsp;</p>
    </body>
</html>
