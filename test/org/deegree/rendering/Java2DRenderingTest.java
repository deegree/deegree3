...
public class Java2DRenderingTest extends TestCase {
    ...
    public void testPointStyling()
        ...
        r.render( style, geomFac.createPoint( new double[] { 100, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.SQUARE;
        r.render( style, geomFac.createPoint( new double[] { 200, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.CIRCLE;
        r.render( style, geomFac.createPoint( new double[] { 300, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.TRIANGLE;
        r.render( style, geomFac.createPoint( new double[] { 400, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.STAR;
        r.render( style, geomFac.createPoint( new double[] { 500, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.CROSS;
        r.render( style, geomFac.createPoint( new double[] { 600, 100 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.X;
        r.render( style, geomFac.createPoint( new double[] { 700, 100 }, null ) );

        style = new PointStyling();
        style.graphic.size = 32;
        style.graphic.mark.fill.color = red;
        style.graphic.mark.stroke.color = green;
        r.render( style, geomFac.createPoint( new double[] { 500, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.SQUARE;
        r.render( style, geomFac.createPoint( new double[] { 1000, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.CIRCLE;
        r.render( style, geomFac.createPoint( new double[] { 1500, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.TRIANGLE;
        r.render( style, geomFac.createPoint( new double[] { 2000, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.STAR;
        r.render( style, geomFac.createPoint( new double[] { 2500, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.CROSS;
        r.render( style, geomFac.createPoint( new double[] { 3000, 500 }, null ) );
        style.graphic.mark.wellKnown = Mark.SimpleMark.X;
        r.render( style, geomFac.createPoint( new double[] { 3500, 500 }, null ) );

        style = new PointStyling();
        style.graphic.size = 32;
        r.render( style, geomFac.createPoint( new double[] { 500, 1000 }, null ) );
        style.graphic.size = 16;
        r.render( style, geomFac.createPoint( new double[] { 500, 1000 }, null ) );

        style = new PointStyling();
        style.graphic.size = 32;
        r.render( style, geomFac.createPoint( new double[] { 1000, 1000 }, null ) );
        style.graphic.size = 16;
        ...
        style = new PointStyling();
        style.graphic.size = 32;
        r.render( style, geomFac.createPoint( new double[] { 1500, 1000 }, null ) );
        style.graphic.size = 16;
        ...
        style = new PointStyling();
        style.graphic.size = 32;
        r.render( style, geomFac.createPoint( new double[] { 2000, 1000 }, null ) );
        style.graphic.size = 16;
        style.graphic.anchorPointX = 0;
        style.graphic.anchorPointY = 0;
