...
public class JSONParsingException extends RuntimeException {
    ...
    /**
     * Constructs an instance of <code>JSONParsingException</code> with the specified detail message.
     * 
     * @param msg
     *            the detail message.
     */
    ...
    /**
     * Constructs an instance of <code>JSONParsingException</code> with the specified cause.
     * 
     * @param cause
