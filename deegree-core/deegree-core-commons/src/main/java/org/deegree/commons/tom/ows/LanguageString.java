...
/**
 * Text string with the language of the string identified as recommended in the XML 1.0
...
public class LanguageString {
	...
	/**
	 * Creates a new {@link LanguageString} instance with the given string value and
	 * optional language information.
	 * @param value string value
	 * @param lang RFC 4646 language code of the human-readable text, may be null
	 */
