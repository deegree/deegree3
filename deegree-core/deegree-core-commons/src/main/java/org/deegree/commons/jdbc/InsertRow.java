...
public class InsertRow extends TransactionRow {
     ...
     * 
     * @param table
     *            table targeted by the insert, must not be <code>null</code>
     * @param autoGenColumn
     *            column with auto generation, can be <code>null</code> (no auto-generated columns)
     */
     ...
     * @throws SQLException
     */
    public Map<SQLIdentifier, Object> performInsert( Connection conn )
                            throws SQLException {
