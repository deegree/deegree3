...
public class SchemaValidationEvent {
    ...
    /**
     * The domain of the error. The domain can be any string but is suggested to be a valid URI. The domain can be used
     * to conveniently specify a web site location of the relevant specification or document pertaining to this error.
     * 
     * @return domain
     */
