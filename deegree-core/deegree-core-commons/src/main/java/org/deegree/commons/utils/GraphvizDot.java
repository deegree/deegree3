...
/**
 * The <code>GraphvizDot</code> class provides a few methods to create a graphviz 'dot'
 * file. For more information on dot files please see http://www.graphviz.org
 *
...
public class GraphvizDot {
	...
	/**
	 * Writes the starting directed graph definition. and adds the given attributes to the
	 * graph start.
	 * @param writer
	 * @param attribs the attributes to write beneath the opening of the graph. For
	 * example use the {@link #addRankDirLeftToRight(List)} to do left to right drawing of
	 * the graph
	 * @throws IOException
	 * @throws IOException
	 */
	 ...
	 * @param attr_List of attributes to write to the vertex definition
	 * @param writer
	 * @throws IOException
	 */
	 ...
	 * @param to this vertex
	 * @param attr_List of attributes to write to the edge definition
	 * @param writer
	 * @throws IOException
	 */
	...
	private static void writeAttributeList(List<String> attr_List, Writer writer) throws IOException {
	...
	/**
	 * @param style one of 'solid dashed dotted bold invis'
