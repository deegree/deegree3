...
public class EMailMessage implements java.io.Serializable, MailMessage {
	 ...
	 * @param subject the subject
	 * @param messageBody the content of the message
	 * @param mimeType the MIME type of the message body
	 * @throws UnknownMimeTypeException if the given mimeType is not supported
	 */
	...
	/**
	 * Returns the state of this message. If sender and receiver are unequal null then
	 * this message is valid otherwise invalid.
	...
	public String toString() {
		return ("From:" + this.getSender() + ", To:" + this.getReceiver() + ", Subject:" + this.getSubject() + ",Body: "
				+ this.getMessageBody());
	}
	 ...
	 * @param mimeType The new mimeType value
	 * @throws UnknownMimeTypeException if the given MIME type is not supported
	 */
