...
public class QNameUtils {
	 ...
	 * @param qName qualified name, must not be <code>null</code>
	...
	/**
	 * Finds the best possible match for a {@link QName} in a collection of
	 * {@link QName}s.
	 * <p>
	 ...
	 * </ol>
	 * @param present name for which to find the best match, must not be <code>null</code>
	 * @param candidates available candidates, must not be <code>null</code>
