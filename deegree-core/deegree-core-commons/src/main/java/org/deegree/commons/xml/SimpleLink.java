...
public class SimpleLink {
	...
	/**
	 * Creates a new <code>SimpleLink</code> instance with the minimum of neeeded
	 * information.
	 * @param href may even be null (!)
	 */
	 ...
	 * @param arcrole may be null
	 * @param title may be null
	 * @param show valid values: 'new', 'replace', 'embed', 'other', 'none' (or null)
	 * @param actuate valid values: 'onLoad', 'onRequest', 'other', 'none' (or null)
	 */
