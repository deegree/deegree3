...
/**
 * Wrapper around <code>XMLStreamWriter</code> instances that allows to sneak a schema
...
public class SchemaLocationXMLStreamWriter implements XMLStreamWriter {
	...
	/**
	 * Create a new {@link SchemaLocationXMLStreamWriter} that will sneak in the given
	 * schema location attribute.
	 * @param xmlStreamWriter
	 * @param schemaLocation
	 */
	public SchemaLocationXMLStreamWriter(XMLStreamWriter xmlStreamWriter, String schemaLocation) {
