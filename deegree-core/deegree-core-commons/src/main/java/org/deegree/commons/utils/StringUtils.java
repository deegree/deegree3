...
/**
 * This is a collection of some methods that work with strings, like split or replace. It
...
public class StringUtils {
	...
	/**
	 * Remove all double ocurrences of a field. Used as an option for some StringTools
	 * methods.
	 */
	...
	/**
	 * Replaces the first substring of this string that matches the given from string with
	 * the given replacement. Works like {@link String#replaceFirst(String, String)} but
	 ...
	 * {@link StringUtils#split(String, String, int)} for further options. If you need
	 * regular expressions, use {@link String#split(String)}.
	...
	/**
	 * Splits a string on all occurrences of delimiter and returns a list with all parts.
	 * If you need regular expressions, use {@link String#split(String)}.
	 *
	 * This methods offers some options to modify the behaviour of the splitting. You can
	 * combine the options with | (eg. StringTools.split(string, delimiter,
	 * REMOVE_EMPTY_FIELDS | REMOVE_DOUBLE_FIELDS)
	 *
	 * <ul>
	 * <li>{@link StringUtils#REMOVE_DOUBLE_FIELDS} removes all double occurrences of a
	 * field.</li>
	 * <li>{@link StringUtils#REMOVE_EMPTY_FIELDS} removes all empty fields.</li>
	 * <li>{@link StringUtils#NO_TRIM_FIELDS} doesn't remove whitespace around each
	 * field</li>
	 * </ul>
	 * @param string
	 * @param delimiter
	 * @param options a combination (|) of options
	 * @return a list with all parts
	 */
	public static String[] split(String string, String delimiter, int options) {
		...
		// check if we got empty fields at the end and if we want to keep them, because
		// String#split will remove the
		// last delimiter
	...
	/**
	 * Removes all occurrences of a string from the start and end. If you only want to
	 * remove whitespaces use {@link String#trim()}.
	 * @param string
	 * @param mark string to remove from begin and end of <code>string</code>
	...
	/**
	 * Convert the given String to the number of bytes they represent. Incoming values
	 ...
	 * @param size the size representation
	...
	/**
	 * Split string into multiple elements and alow the delimiter to be escaped with a
	 * backslash
	 *
