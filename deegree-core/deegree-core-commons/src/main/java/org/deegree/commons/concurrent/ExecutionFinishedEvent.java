...
/**
 * Event that is sent when an asynchronous task finished. <br/>
 * This can mean:
 * <ul>
...
public class ExecutionFinishedEvent<T> {
	 ...
	 * <p>
	 * If the task produced an exception or error, it is rethrown here. If the task has
	 * been cancelled (usually this means that the time out occurred), a
	 * {@link CancellationException} is thrown.
	 * @return the result value that the task returned
	 * @throws CancellationException if task timed out / has been cancelled
	 * @throws Throwable if task terminated with an exception or error
	 */
