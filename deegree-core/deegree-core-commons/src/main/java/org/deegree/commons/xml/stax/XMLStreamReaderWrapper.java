...
public class XMLStreamReaderWrapper implements XMLStreamReader {
	...
	public QName getElementTextAsQName() throws XMLParsingException {
		QName result = null;
		try {
			...
			if (colonIdx < 0) {
				...
				if (nsUri == null) {
					throw new XMLParsingException(this,
	...
	public double getElementTextAsDouble() throws XMLParsingException {
		String s = null;
		try {
			s = getElementText();
	...
	public int getElementTextAsPositiveInteger() throws XMLParsingException {
	...
	public QName getAttributeValueAsQName(String namespaceURI, String localName) throws XMLParsingException {
		QName result = null;
	...
	/**
	 * Not piped to wrapped reader, because AXIOM provided reader (withoutCaching) behaves
	 * strange here.
	 */
	@Override
