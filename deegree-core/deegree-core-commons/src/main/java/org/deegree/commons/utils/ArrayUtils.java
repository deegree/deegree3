...
/**
 * This is a collection of some methods that work with arrays and lists, like join or
...
public class ArrayUtils {
	 ...
	 * @param delimiter the delimiter to put between every string.
	 * @param strings
	 ...
	 * @param target array to check if it contains <code>value</code>
	 * @param value string to check if it within the array
	 * @param caseSensitive true if the search should be case sensitive
	 * @param exact if the equals test should return true if one of the target strings
	 * contains a part of the value.
	...
	/**
	 * Checks if the array contains the string <code>value</code>. This method is case
	 * insensitive.
	 * @param target array to check if it contains <code>value</code>
	 * @param value string to check if it within the array
	 * @return true if passed array contains value
	 ...
	 * @param delimiter delimiter that marks the end of a token
	 * @param deleteDoubles if it's true all string that are already within the resulting
	 * array will be deleted, so that there will only be one copy of them.
	...
	/**
	 * parse a string and return its tokens as typed List. empty fields will be removed
	 * from the list.
	 * @param s string to parse
	 * @param delimiter delimiter that marks the end of a token
	 * @param deleteDoubles if it's true all string that are already within the resulting
	 ...
	 * @param s to remove the doubles from
	 ...
	 * @throws NumberFormatException if one of the values could not be read.
	 */
	public static float[] splitAsFloats(String str, String delim) throws NumberFormatException {
		String[] ss = str.split(delim);
