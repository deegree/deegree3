...
public class MathUtils {
	...
	/**
	 * This method will return the next power, two must be raised too to give the next
	 * power of two, e.g. if value is 511 it will return 9, if value is 513 it will return
	 * 10.
	 * @param value to use
	...
	/**
	 * This method will return the next power of two for the given value, e.g. if value is
	 * 511 it will return 512, if value is 513 it will return 1024.
	 * @param value to use
