...
/**
 * The <code>SunInfo</code> supplies methods for the calculation of the sun position at a
...
public class SunInfo {
	...
	/**
	 * calculates the solar altitude for given latitude, year, month, date, hour and
	 * minute
	...
	/**
	 * This method calculates the color of the sunlight for the current time and the given
	 * latitude. This method is taken from deegree2, the values are undocumented.
	 * @param latitude
	...
	/**
	 * @param color to calculate the intensity for.
	 * @param cloudFactor scale factor [0,1] describing percentage of clouds covering the
	 * sun
