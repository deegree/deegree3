...
public class SchemaUtils {
	 ...
	 * @param writer xml stream to write to, must not be <code>null</code>
	 * @param targetNamespace target namespace of the document, must not be
	 * <code>null</code>
	 * @param nsImports namespace imports, must not be <code>null</code>
	 * @throws XMLStreamException
	 */
	public static void writeWrapperDoc(XMLStreamWriter writer, String targetNamespace,
			List<Pair<String, String>> nsImports) throws XMLStreamException {
	...
	private static void writeStartDocument(XMLStreamReader reader, XMLStreamWriter writer) throws XMLStreamException {
