...
/**
 * ${link XMLStreamWriter} implementation that only writes out document parts that match given xpaths.
 * 
...
public class FilteringXMLStreamWriter implements XMLStreamWriter {
    ...
    /**
     * The xpaths must contain at least one xpath matching the root element, else an empty document will be written. The
     * xpaths must be simple location paths that only use steps with qualified names (no predicates, no attribute
     * steps).
     * 
     * @param writer
     * @param xpaths
