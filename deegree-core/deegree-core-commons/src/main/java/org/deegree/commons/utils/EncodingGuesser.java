...
public class EncodingGuesser {
	 ...
	 * @throws UnsupportedEncodingException if you don't have i18n.jar from Sun's JDK, I
	 * guess
	 */
	 ...
	 * guess
	 */
	public static Charset guess(InputStream in) throws IOException {
	 ...
	 * guess
	 */
	public static Charset guess(byte[] bs) throws UnsupportedEncodingException {
		TreeMap<Integer, Integer> map = new TreeMap<Integer, Integer>();
