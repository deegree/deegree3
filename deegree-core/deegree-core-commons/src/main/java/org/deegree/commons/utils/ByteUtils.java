...
public class ByteUtils {
	 ...
	 * @throws IOException
	 */
	public static int readLEInt(DataInput in) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static long readLELong(DataInput in) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static double readLEDouble(DataInput in) throws IOException {
		return longBitsToDouble(readLELong(in));
	}

	/**
	 * @param str a hex string with a sequence of byte values
