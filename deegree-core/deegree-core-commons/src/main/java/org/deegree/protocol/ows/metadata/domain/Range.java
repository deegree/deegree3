 ...
 * </p>
 * <p>
 * From OWS Common 2.0: <cite>A range of values of a numeric parameter. This range can be continuous or discrete,
 * defined by a fixed spacing between adjacent valid values. If the MinimumValue or MaximumValue is not included, there
 * is no value limit in that direction. Inclusion of the specified minimum and maximum values in the range shall be
...
public class Range implements Values {
     ...
     * 
     * @param min
     *            minimum value, may be <code>null</code> (no lower limit)
     * @param max
     *            maximum value, may be <code>null</code> (no upper limit)
     * @param spacing
     *            spacing, may be <code>null</code> (continuous range)
     * @param closure
     *            boundary value mode, may be <code>null</code> (implies {@link RangeClosure#CLOSED})
     */
     ...
     * 
     * @param max
     *            maximum value, may be <code>null</code> (no lower limit)
     */
     ...
     * <p>
     * From OWS Common 2.0: <cite>Shall be included when the allowed values are NOT continuous in this range. Shall not
     * be included when the allowed values are continuous in this range.</cite>
     * </p>
     * 
     * @return spacing between values in the range, may be <code>null</code> (continuous range)
     */
     ...
     * 
     * @param spacing
     *            spacing between values in the range, may be <code>null</code> (continuous range)
     */
     ...
     * <p>
     * From OWS Common 2.0: <cite>Shall be included unless the default value applies (closed).</cite>
     * </p>
     * 
