...
public class RasterOptionsParser {
     ...
     */
    public static RasterIOOptions parseRasterIOOptions( CommandLine line )
                            throws ParseException {
     ...
     * @param options
     *            created from {@link #parseRasterIOOptions(CommandLine)}
     ...
     * @return a File denoting a raster location, which may be a directory or a single file.
     * @throws IOException
     *             if the location does not exist.
     */
    public static File getRasterLocation( CommandLine line )
                            throws IOException {
