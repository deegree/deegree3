...
public class RasterDataInfo implements Serializable {
	...
	/**
	 * @param noDataPixel to be used if no data was found in a given subset.
	 * @param bandInfo of the raster data
	 * @param dataType of the raster data
	 * @param interleaveType of the raster data.
	 */
	 ...
	 * array is <code>null</code> or to small
	 */
	...
	/**
	 * Returns the no data values for this raster's bands
	 * @param bands to copy the null data pixel values for.
	 * @return the <code>result</code> array or a new array, if the <code>result</code>
	...
	/**
	 * Returns the no data values for the given band. If the band is outside an empty
	 * array is returned. If the result is <code>null</code> or is to small for the
	 * datasize, a new allocated byte array will be returned. Otherwise the no data value
	 * for the requested band is copied at position 0 of the result array.
	 * @param band to get the value for.
	 * @param result to put the value in.
	 * @return the <code>result</code> array or a new array, if the <code>result</code>
	 * array is <code>null</code>
	 */
	...
	/**
	 * Returns the no data value for the given band, if the band is outside the number of
	 * bands or the given type is not of {@link DataType#BYTE} 0 will be returned.
	 * @param band to get the no data value for.
	...
	/**
	 * Returns the no data value for the given band, if the band is outside the number of
	 * bands or the given type is not of {@link DataType#SHORT} or {@link DataType#USHORT}
	 * 0 will be returned.
	 * @param band to get the no data value for.
	 * @return the no data value for the given band.
	 */
	...
	/**
	 * Returns the no data value for the given band, if the band is outside the number of
	 * bands or the given type is not of {@link DataType#INT} 0 will be returned.
	 * @param band to get the no data value for.
	 * @return the no data value for the given band.
	 */
	...
	/**
	 * Returns the no data value for the given band, if the band is outside the number of
	 * bands or the given type is not of {@link DataType#FLOAT} 0 will be returned.
	 * @param band to get the no data value for.
	 * @return the no data value for the given band.
	 */
	...
	/**
	 * Returns the no data value for the given band, if the band is outside the number of
	 * bands or the given type is not of {@link DataType#DOUBLE} 0 will be returned.
	 * @param band to get the no data value for.
	 * @return the no data value for the given band.
	 */
