 ...
 * (0, 0) to the lower right corner (width-1, height-1). A raster can contain multiple
 * bands. A pixel stores one sample for every band. The sample arrangement is determined
 * by the interleaving type ({@link InterleaveType}). The size of each sample is
 * dertermined by the data type ({@link DataType}).
 *
 * <p>
 * Most get-methods accept an array as a parameter for performance reasons. This parameter
 * is used to store the result. The same array will be returned by the method, filled with
 * requested values. A new array will be created, filled and returned if this parameter is
 * <code>null</code>.
 *
 * <p>
 * TODO: Only defines interface to byte, short and float data at the moment. Copy float
...
public interface RasterData {
	 ...
	 * @param result an array to put the values into or <code>null</code>
	 * @return the <code>result</code> array or a new array, if the <code>result</code>
	 ...
	 * @param values an array with the null values
	 */
	public void setNoDataValue(byte[] values);

	/**
	 * Returns a new RasterData with the same DataType and InterleaveType
	 * @param sampleDomain the raster rectangle defining the sample domain of this raster
	 * data.
	 * @param bands indices to the requested bands
	 * @return new empty raster
	 */
	public RasterData createCompatibleRasterData(RasterRect sampleDomain, BandType[] bands);

	/**
	 * Create a writable compatible raster with the height and width of the given sample
	 * domain.
	 * @param sampleDomain the raster rectangle defining the sample domain of this raster
	 * data.
	 * @param bands indices to the requested bands if <code>null</code> all bands will be
	 * available.
	 * @return new empty raster
	 */
	...
	/**
	 * Returns a view as a new RasterData with the same DataType and InterleaveType but
	 * valid only for the given rect.
	 * @param sampleDomain the raster rectangle defining the sample domain of this raster
	 * data.
	 ...
	 * @param width width of the new raster
	 * @param height height of the new raster
	 * @return new empty raster
	 */
	 ...
	 * @param bands definitions of the new rasterdata.
	 * @return new empty raster
	 */
	...
	/**
	 * Return a read-only version of this RasterData. The result shares the same data as
	 * the original.
	...
	/**
	 * Returns a sample as byte array, regardless of the DataType. i.e. a FLOAT DataType
	 * results in a four byte array
	 * @param x
	 * @param y
	...
	/**
	 * Sets a sample with data from a byte array, regardless of the DataType. i.e. a float
	 * must be packed as a four byte array
	 * @param x
	 * @param y
	 * @param band selected band
	 * @param values array with the sample value
	 */
	public void setSample(int x, int y, int band, byte[] values);

	/**
	 * Returns a pixel as byte array, regardless of the DataType. i.e. a FLOAT DataType
	 * results in a four byte array.
	 * @param x
	 * @param y
	 * @param result a byte array to put the values into or <code>null</code>
	 * @return the <code>result</code> array or a new array, if the <code>result</code>
	 * array is <code>null</code>
	 */
	...
	/**
	 * Sets a pixel with data from a byte array, regardless of the DataType. i.e. a float
	 * sample must be packed as a four byte array.
	 * @param x
	 * @param y
	 * @param pixel
	 */
	...
	/**
	 * Returns a byte array with all sample values from coordinate x/y. The length of the
	...
	/**
	 * Returns a double array with all sample values from coordinate x/y. The length of
	 * the array is equal to the number of bands.
	 * @param x
	 * @param y
	 * @param result an array to put the values into or <code>null</code>
	 * @return the <code>result</code> array or a new array, if the <code>result</code>
	...
	/**
	 * Returns a float array with all sample values from coordinate x/y. The length of the
	 * array is equal to the number of bands.
	 * @param x
	 * @param y
	 * @param result an array to put the values into or <code>null</code>
	...
	/**
	 * Returns an integer array with all sample values from coordinate x/y. The length of
	 * the array is equal to the number of bands.
	 * @param x
	 * @param y
	 * @param result an array to put the values into or <code>null</code>
	...
	/**
	 * Returns a short array with all sample values from coordinate x/y. The length of the
	 * array is equal to the number of bands.
	 * @param x
	 * @param y
	 * @param result an array to put the values into or <code>null</code>
	...
	/**
	 * Sets a single pixel with byte values for each sample. The length of pixel array
	 * must be equal to the number of bands.
	 * @param x
	 * @param y
	 * @param pixel array with one sample per band
	 */
	public void setBytePixel(int x, int y, byte[] pixel);

	/**
	 * Sets a single pixel with double values for each sample. The length of pixel array
	 * must be equal to the number of bands.
	 * @param x
	 * @param y
	 * @param pixel array with one sample per band
	...
	/**
	 * Sets a single pixel with float values for each sample. The length of pixel array
	 * must be equal to the number of bands.
	 * @param x
	 * @param y
	 * @param pixel array with one sample per band
	...
	/**
	 * Sets a single pixel with integer values for each sample. The length of pixel array
	 * must be equal to the number of bands.
	 * @param x
	 * @param y
	 * @param pixel array with one sample per band
	...
	/**
	 * Sets a single pixel with short values for each sample. The length of pixel array
	 * must be equal to the number of bands.
	 * @param x
	 * @param y
	 * @param pixel array with one sample per band
	 ...
	 * @param x
	 * @param y
	 * @param band band number for sample
	 ...
	 * @param y
	 * @param band band number for sample
	 * @param value new value for sample
	 */
	...
	/**
	 * Gets values from the specified rectangle and band. The result is stored row-ordered
	 * in a single array (e.g. {x0y0, x1y0, x2y0,...,x0y1...})
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	...
	/**
	 * Sets values from the array to the specified rectangle and band. The values must be
	 * stored row-ordered in a single array (e.g. {x0y0, x1y0, x2y0,...,x0y1...})
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	 * @param band
	 * @param values the samples to put into the raster
	 */
	 ...
	 * @param rasterRect rectangle for subset
	 ...
	 * @param y insert position
	 * @param width width of the subset
	 * @param height height of the subset
	 * @param sourceRaster data source to copy
	 */
	 ...
	 * @param width width of the subset
	 * @param height height of the subset
	 * @param xOffset x offset in the source raster
	 * @param yOffset y offset in the source raster
	 * @param sourceRaster data source to copy
	 */
	 ...
	 * @param width width of the subset
	 * @param height height of the subset
	 * @param dstBand the index of the destination band
	 * @param sourceRaster data source to copy
	 * @param srcBand the index of the source band of <code>sourceRaster</code>
	 */
