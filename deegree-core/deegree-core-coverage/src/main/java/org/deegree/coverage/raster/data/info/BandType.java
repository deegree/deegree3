...
public enum BandType {
	...
	/**
	 * Convert from {@link BufferedImage}-Types to {@link BandType}s. The size of the
	 * types are irrelevant. (INT_ARGB==3BYTE_ARGB)
	 * @param type The {@link DataBuffer}-Type (eg. TYPE_BYTE, etc.)
	 * @param expectedSize if the type is unknown an array of expectedSize with
	 * {@link BandType#BAND_0}[9] will be returned.
	 * @param sampleModel
	...
	/**
	 * Get Bandtype for the given string. This method is case insensitive, words can be
	 * separated with a whitespace, minus or underscore.
	 * @param band
