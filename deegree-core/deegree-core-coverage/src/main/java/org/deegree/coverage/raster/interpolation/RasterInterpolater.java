...
public class RasterInterpolater {
	 ...
	 * @param sourceRaster the raster to get an interpolation version from
	 * @param dstWidth the width (columns) of the resulting raster
	 * @param dstHeight the height (rows) of the resulting raster
