...
/**
 * This class provides an abstraction from the details of TIFF data access for the purpose
 * of retrieving GeoTIFF metadata from an image.
 * <p>
 * All of the GeoKey values are included here as constants, and the portions of the
 * GeoTIFF specification pertaining to each have been copied for easy access.
 * <p>
 * The majority of the possible GeoKey values and their meanings are NOT reproduced here.
 * Only the most important GeoKey code values have been copied, for others see the
 * specification.
 * <p>
 * Convenience methods have been included to retrieve the various TIFFFields that are not
 * part of the GeoKey directory, such as the Model Transformation and Model TiePoints.
 * Retrieving a GeoKey from the GeoKey directory is a bit more specialized and requires
 * knowledge of the correct key code.
 * <p>
 * Making use of the geographic metadata still requires some basic understanding of the
 * GeoKey values that is not provided here.
 * <p>
...
public class GeoTiffIIOMetadataAdapter {
	...
	/**
	 * GTModelTypeGeoKey Key ID = 1024 Type: SHORT (code) Values: Section 6.3.1.1 Codes
	 ...
	 * two, namely RasterPixelIsPoint and RasterPixelIsArea. No user-defined raster spaces
	 * are currently supported. For variance in imaging display parameters, such as pixel
	 ...
	 *
	 * As with all the "Citation" GeoKeys, this is provided to give an ASCII reference to
	...
	/**
	 * GeographicTypeGeoKey Key ID = 2048 Type = SHORT (code) Values = Section 6.3.2.1
	 * Codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.1
	 *
	...
	/**
	 * GeogGeodeticDatumGeoKey Key ID = 2050 Type = SHORT (code) Values = Section 6.3.2.2
	 * Codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.2
	 *
	 * This key may be used to specify the horizontal datum, defining the size, position
	 * and orientation of the reference ellipsoid used in user-defined geographic
	 * coordinate systems.
	 *
	 * GeoKey Requirements for User-Defined Horizontal Datum: GeogCitationGeoKey
	 * GeogEllipsoidGeoKey
	 *
	 */
	...
	/**
	 * GeogPrimeMeridianGeoKey Key ID = 2051 Type = SHORT (code) Units: Section 6.3.2.4
	 * code http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.4
	 *
	 * Allows specification of the location of the Prime meridian for user-defined
	 * geographic coordinate systems. The default standard is Greenwich, England.
	 *
	 */
	 ...
	 *
	 * This key allows definition of user-defined Prime Meridians, the location of which
	 * is defined by its longitude relative to Greenwich.
	 *
	 */
	 ...
	 *
	 * Allows the definition of user-defined linear geocentric units, as measured in
	 * meters.
	 *
	 */
	...
	/**
	 * GeogAngularUnitsGeoKey Key ID = 2054 Type = SHORT (code) Values = Section 6.3.1.4
	 * Codes
	 *
	 * Allows the definition of geocentric CS Linear units for user-defined GCS and for
	 * ellipsoids.
	 *
	 * GeoKey Requirements for "user-defined" units: GeogCitationGeoKey
	...
	/**
	 * GeogEllipsoidGeoKey Key ID = 2056 Type = SHORT (code) Values = Section 6.3.2.3
	 * Codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.3
	 *
	 * This key may be used to specify the coded ellipsoid used in the geodetic datum of
	 * the Geographic Coordinate System.
	 *
	 * GeoKey Requirements for User-Defined Ellipsoid: GeogCitationGeoKey
	...
	/**
	 * GeogSemiMajorAxisGeoKey Key ID = 2057 Type = DOUBLE Units: Geocentric CS Linear
	 * Units
	 *
	...
	/**
	 * GeogSemiMinorAxisGeoKey Key ID = 2058 Type = DOUBLE Units: Geocentric CS Linear
	 * Units
	 *
	 ...
	 * non-inverted f by: e^2 = 2*f - f^2
	 *
	 * Note: if the ellipsoid is spherical the inverse-flattening becomes infinite; use
	 * the GeogSemiMinorAxisGeoKey instead, and set it equal to the semi-major axis
	 * length.
	 *
	 */
	...
	/**
	 * GeogAzimuthUnitsGeoKey Key ID = 2060 Type = SHORT (code) Values = Section 6.3.1.4
	 * Codes
	 *
	 ...
	 * azimuthal parameters for some projection algorithms, and may not necessarily be the
	 * same angular units used for lat-long.
	 *
	 */
	...
	/**
	 * ProjectedCSTypeGeoKey Key ID = 3072 Type = SHORT (codes) Values: Section 6.3.3.1
	 * codes This code is provided to specify the projected coordinate system.
	 *
	 * GeoKey requirements for "user-defined" PCS families: PCSCitationGeoKey
	 * ProjectionGeoKey
	 *
	 */
	 ...
	 *
	 * As with all the "Citation" GeoKeys, this is provided to give an ASCII reference to
	 * published documentation on the Projected Coordinate System particularly if this is
	 * a "user-defined" PCS.
	 *
	 */
	 ...
	 *
	 * GeoKeys Required for "user-defined" Projections: PCSCitationGeoKey
	 * ProjCoordTransGeoKey ProjLinearUnitsGeoKey (additional parameters depending on
	...
	/**
	 * ProjCoordTransGeoKey Key ID = 3075 Type = SHORT (code) Values: Section 6.3.3.3
	 * codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.3.3
	 *
	 ...
	 *
	 * GeoKeys Required for "user-defined" Coordinate Transformations: PCSCitationGeoKey
	...
	/**
	 * ProjLinearUnitsGeoKey Key ID = 3076 Type = SHORT (code) Values: Section 6.3.1.3
	 * codes
	 *
	 ...
	 * ProjStdParallelGeoKey (from Rev 0.2)
	 *
	...
	/**
	 * ProjFalseEastingGeoKey Key ID = 3082 Type = DOUBLE Units: ProjLinearUnit Gives the
	 * easting coordinate of the map projection Natural origin.
	 *
	 */
	public static final int ProjFalseEastingGeoKey = 3082;

	/**
	 * ProjFalseNorthingGeoKey Key ID = 3083 Type = DOUBLE Units: ProjLinearUnit Gives the
	 * northing coordinate of the map projection Natural origin.
	 *
	 */
	public static final int ProjFalseNorthingGeoKey = 3083;

	/**
	 * ProjFalseOriginLongGeoKey Key ID = 3084 Type = DOUBLE Units: GeogAngularUnit Gives
	 * the longitude of the False origin.
	 *
	 */
	public static final int ProjFalseOriginLongGeoKey = 3084;

	/**
	 * ProjFalseOriginLatGeoKey Key ID = 3085 Type = DOUBLE Units: GeogAngularUnit Gives
	 * the latitude of the False origin.
	 *
	 */
	public static final int ProjFalseOriginLatGeoKey = 3085;

	/**
	 * ProjFalseOriginEastingGeoKey Key ID = 3086 Type = DOUBLE Units: ProjLinearUnit
	...
	/**
	 * ProjFalseOriginNorthingGeoKey Key ID = 3087 Type = DOUBLE Units: ProjLinearUnit
	 ...
	 *
	 * Longitude of Center of Projection. Note that this is not necessarily the origin of
	 * the projection.
	 *
	 */
	...
	/**
	 * ProjCenterEastingGeoKey Key ID = 3090 Type = DOUBLE Units: ProjLinearUnit Gives the
	 * easting coordinate of the center. This is NOT the False Easting.
	 *
	 */
	public static final int ProjCenterEastingGeoKey = 3090;

	/**
	 * ProjCenterNorthingGeoKey Key ID = 3091 Type = DOUBLE Units: ProjLinearUnit Gives
	 * the northing coordinate of the center. This is NOT the False Northing.
	 *
	 ...
	 * ProjScaleAtOriginGeoKey (Rev. 0.2)
	 *
	...
	/**
	 * VerticalCSTypeGeoKey Key ID = 4096 Type = SHORT (code) Values = Section 6.3.4.1
	 * Codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.4.1
	 *
	 ...
	 *
	 * This key may be used to document the vertical coordinate system used, and its
	 * parameters.
	 *
	 */
	...
	/**
	 * VerticalDatumGeoKey Key ID = 4098 Type = SHORT (code) Values = Section 6.3.4.2
	 * codes http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.4.2
	 *
	 * This key may be used to specify the vertical datum for the vertical coordinate
	 * system.
	 *
	 */
	...
	/**
	 * VerticalUnitsGeoKey Key ID = 4099 Type = SHORT (code) Values = Section 6.3.1.3
	...
	/**
	 * 6.3.1.1 Model Type Codes Ranges: 0 = undefined [ 1, 32766] = GeoTIFF Reserved Codes
	 * 32767 = user-defined [32768, 65535] = Private User Implementations GeoTIFF defined
	 * CS Model Type Codes: ModelTypeProjected = 1 Projection Coordinate System
	 * ModelTypeGeographic = 2 Geographic latitude-longitude System ModelTypeGeocentric =
	 * 3 Geocentric (X,Y,Z) Coordinate System
	 *
	 * Notes: 1. ModelTypeGeographic and ModelTypeProjected correspond to the FGDC
	 ...
	 * (GeoTIFF Defined) [1024, 32766] = Reserved 32767 = user-defined [32768, 65535]=
	...
	/**
	 * 6.3.1.3 Linear Units Codes There are several different kinds of units that may be
	 * used in geographically related raster data: linear units, angular units, units of
	 * time (e.g. for radar-return), CCD-voltages, etc. For this reason there will be a
	 * single, unique range for each kind of unit, broken down into the following
	 * currently defined ranges:
	 *
	 * Ranges: 0 = undefined [ 1, 2000] = Obsolete GeoTIFF codes [2001, 8999] = Reserved
	 * by GeoTIFF [9000, 9099] = EPSG Linear Units. [9100, 9199] = EPSG Angular Units.
	...
	/**
	 * 6.3.2.1 Geographic CS Type Codes Note: A Geographic coordinate system consists of
	 * both a datum and a Prime Meridian. Some of the names are very similar, and differ
	 * only in the Prime Meridian, so be sure to use the correct one. The codes beginning
	 * with GCSE_xxx are unspecified GCS which use ellipsoid (xxx); it is recommended that
	 * only the codes beginning with GCS_ be used if possible.
	 *
	 * Ranges:
	 *
	 * 0 = undefined [ 1, 1000] = Obsolete EPSG/POSC Geographic Codes [ 1001, 3999] =
	 * Reserved by GeoTIFF [ 4000, 4199] = EPSG GCS Based on Ellipsoid only [ 4200, 4999]
	 * = EPSG GCS Based on EPSG Datum [ 5000, 32766] = Reserved by GeoTIFF 32767 =
	 * user-defined GCS [32768, 65535] = Private User Implementations Values: Note:
	 * Geodetic datum using Greenwich PM have codes equal to the corresponding Datum code
	 * - 2000. Ellipsoid-Only GCS: Note: the numeric code is equal to the code of the
	 * correspoding EPSG ellipsoid, minus 3000.
	 *
	 * Note: Only a handful of values have been reproduced here, for the remainder see the
	...
	/**
	 * 6.3.3.1 Projected CS Type Codes Ranges: [ 1, 1000] = Obsolete EPSG/POSC Projection
	 * System Codes [20000, 32760] = EPSG Projection System codes 32767 = user-defined
	 * [32768, 65535] = Private User Implementations Special Ranges: 1. For PCS utilizing
	 * GeogCS with code in range 4201 through 4321: As far as is possible the PCS code
	 * will be of the format gggzz where ggg is (geodetic datum code -4000) and zz is
	 * zone. 2. For PCS utilizing GeogCS with code out of range 4201 through 4321 (i.e.
	 * geodetic datum code 6201 through 6319). PCS code 20xxx where xxx is a sequential
	 * number. 3. Other: WGS72 / UTM northern hemisphere: 322zz where zz is UTM zone
	 * number WGS72 / UTM southern hemisphere: 323zz where zz is UTM zone number WGS72BE /
	 * UTM northern hemisphere: 324zz where zz is UTM zone number WGS72BE / UTM southern
	 * hemisphere: 325zz where zz is UTM zone number WGS84 / UTM northern hemisphere:
	 * 326zz where zz is UTM zone number WGS84 / UTM southern hemisphere: 327zz where zz
	 * is UTM zone number US State Plane (NAD27): 267xx/320xx US State Plane (NAD83):
	 * 269xx/321xx Note: These are only a subset of the possible values
	 *
	 */
	...
	/**
	 * The DOM element ID (tag) for a single TIFF double. The value is stored in an
	...
	/**
	 * The DOM element ID (tag) for a single TIFF Short value. The value is stored in an
	 * attribute named "value"
	 */
	...
	/**
	 * The DOM element ID (tag) for a single TIFF Rational value. The value is stored in
	...
	/**
	 * This class is a holder for a GeoKey record containing four short values. The values
	 * are a GeoKey ID, the TIFFTag number of the location of this data, the count of
	 * values for this GeoKey, and the offset (or value if the location is 0).
	 * <p>
	 * If the Tiff Tag location is 0, then the value is a Short and is contained in the
	 * offset. Otherwise, there is one or more value in the specified external Tiff tag.
	 * The number is specified by the count field, and the offset into the record is the
	 * offset field.
	 */
	...
	/**
	 * Gets the version of the GeoKey directory. This is typically a value of 1 and can be
	 * used to check that the data is of a valid format.
	 */
	...
	/**
	 * Gets a GeoKey value as a String. This implementation should be &quotquiet&quot in
	 * the sense that it should not throw any exceptions but only return null in the event
	 * that the data organization is not as expected.
	...
	/**
	 * Gets a record containing the four TIFFShort values for a geokey entry. For more
	 * information see the GeoTIFF specification.
	 ...
	 * @return A String containing the text from the value attribute. In the above
	 * example, the string would be 123
	 */
	...
	/**
	 * Gets a TIFFField node with the given tag number. This is done by searching for a
	 * TIFFField with attribute number whose value is the specified tag value.
	 */
	...
	/**
	 * Gets an array of int values stored in a TIFFShorts element that contains a sequence
	 * of TIFFShort values.
	...
	/**
	 * Gets an array of int values stored in a TIFFRationals element that contains a
	 * sequence of TIFFRational values.
	 * @param tiffField An IIOMetadataNode pointing to a TIFFField element that contains a
	 * TIFFRationals element.
	 */
