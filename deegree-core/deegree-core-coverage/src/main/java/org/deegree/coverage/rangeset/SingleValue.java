...
public class SingleValue<T extends Comparable<T>> {
	...
	/**
	 * @param type describing the type of the value.
	 ...
	 * @return true if the given singlevalue matches this one, e.g. the value and types
	 * are equal.
	 */
	@Override
	 ...
	 */
	public static SingleValue<?> createFromValue(String type, Number value) throws NumberFormatException {
	 ...
	 * @throws NumberFormatException
	 */
	public static SingleValue<?> createFromString(String type, String value) throws NumberFormatException {
		ValueType determined = ValueType.fromString(type);
		SingleValue<?> result = null;
		switch (determined) {
			case Byte:
