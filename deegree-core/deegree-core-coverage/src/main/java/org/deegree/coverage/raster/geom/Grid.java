...
public class Grid {
	 ...
	 * @param depth the depth of the grid in pixel
	 * @param targetEnvelope the envelope of the output grid
	 * @return a new grid
	 */
	 ...
	 * @param resx resolution of a pixel (ie. the width of each grid cell in CRS units)
	 * @param resy resolution of a pixel (ie. the height of each grid cell in CRS units)
	 * @param resz resolution of a pixel (ie. the depth of each grid cell in CRS units)
	 * @param targetEnvelope the envelope of the output grid
	 * @return a new grid
	 */
	...
	public String toString() {
		return "[width: " + width + ", height: " + height + ", depth: " + depth + ", target envelope: " + targetEnvelope
				+ "]";
	}
