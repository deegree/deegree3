...
public class RasterDataFactory {
	 ...
	 * @param dataType data type for samples
	 * @param addToCache if the reader should be added to the cache (almost always should
	 * be true).
	...
	/**
	 * Creates a RasterData object object with given size, number of bands, data type and
	 * interleaving
	 * @param width width of the raster
	 * @param height height of the raster
	 * @param bands number and type of the bands
	 * @param dataType data type for samples
	 * @param interleaveType interleaving type for the raster
	 * @param addToCache if the reader should be added to the cache (almost always should
	 * be true).
	 * @return new RasterData
	 */
	 ...
	 * @param dataType data type for samples
	 * @param interleaveType interleaving type for the raster
	 * @param reader to get the data from, maybe <code>null</code>
	 * @param addToCache if the reader should be added to the cache (almost always should
	 * be true).
	 * @return new RasterData
	 */
	public static ByteBufferRasterData createRasterData(int width, int height, BandType[] bands, DataType dataType,
			InterleaveType interleaveType, RasterReader reader, boolean addToCache) {
	...
	/**
	 * Creates a RasterData object object with given size, number of bands, data type and
	 * interleaving. The view will be 0, 0, width, height, the default raster cache
	 * location will be used.
	 * @param width width of the raster
	 * @param height height of the raster
	 * @param dataInfo defining the bands, datatype and interleave type.
	 * @param reader to get the data from, maybe <code>null</code>
	 * @param addToCache if the reader should be added to the cache (almost always should
	 * be true).
	 * @return new RasterData
	...
	/**
	 * Creates a RasterData object object with given view, number of bands, data type and
	 * interleaving.
	 * @param view valid for the raster data.
	 * @param dataInfo defining the bands, datatype and interleave type.
	 * @param reader to get the data from, maybe <code>null</code>
	 * @param addToCache if the reader should be added to the cache (almost always should
	 * be true).
	 * @param options containing information about the raster cache directory.
	 * @return new RasterData
	 */
		...
		switch (dataInfo.interleaveType) {
			...
			default:
				throw new UnsupportedOperationException(
						"Interleaving type " + dataInfo.interleaveType + " not supported!");
		}
	...
	/**
	 * Creates a RasterData object object with given size, number of bands, data type and
	 * interleaving filled with the given ByteArray. A cachereader will be created.
	 * @param width width of the raster
	 * @param height height of the raster
	 * @param bands number and type of the bands
	 * @param dataType data type for samples
	 * @param interleaveType interleaving type for the raster
	 * @param geoRef needed for the reader.
	 * @param byteBuffer on which the memory reader will operate upon.
	 * @param createCacheFile true if a cache file should back the data
	 * @param cacheId the name of the cache file to use in the default
	 * {@link RasterCache}.
	 * @return new RasterData
	 */
	public static ByteBufferRasterData createRasterData(int width, int height, BandType[] bands, DataType dataType,
			InterleaveType interleaveType, RasterGeoReference geoRef, ByteBuffer byteBuffer, boolean createCacheFile,
			String cacheId) {
	 ...
	 * @param width width of the raster
	 * @param height height of the raster
	 * @param rdi containing the number of bands, the data type and the interleave type.
	 * @param geoRef needed for the reader.
	 * @param byteBuffer on which the memory reader will operate upon.
	 * @param createCacheFile true if a cache file should back the data
	 * @param cacheId the name of the cache file to use in the default
	...
	public static ByteBufferRasterData createRasterData(int width, int height, RasterDataInfo rdi,
			RasterGeoReference geoRef, ByteBuffer byteBuffer, boolean createCacheFile, String cacheId) {
	 ...
	 * @param cacheId the name of the cache file to use in the default
	 * {@link RasterCache}.
	 * @param options which can be used to get the cache data from.
	 * @return new RasterData
	 */
	public static ByteBufferRasterData createRasterData(int width, int height, RasterDataInfo rdi,
			RasterGeoReference geoRef, ByteBuffer byteBuffer, boolean createCacheFile, String cacheId,
			RasterIOOptions options) {
		return createRasterData(new RasterRect(0, 0, width, height), rdi, geoRef, byteBuffer, createCacheFile, cacheId,
				options);
	}
	 ...
	 * @return new RasterData
	 */
	public static ByteBufferRasterData createRasterData(RasterRect view, RasterDataInfo rdi, RasterGeoReference geoRef,
			ByteBuffer byteBuffer, boolean createCacheFile, String cacheId, RasterIOOptions options) {
		RasterCache cache = RasterCache.getInstance(options);
		File cacheFile = null;
		if (createCacheFile) {
			cacheFile = cache.createCacheFile(cacheId);
		}
		RasterReader inMem = new CacheRasterReader(byteBuffer, view.width, view.height, cacheFile, createCacheFile, rdi,
				geoRef, cache);
		if (createCacheFile) {
	...
	/**
	 * Encapsulates a Grid of Raster data as a new Raster data object. This tiled raster
	 * data object cascades the pixel operations for the underlying raster data grid.
	 * @param reader to be used.
	 * @param options holding information on the io settings.
