...
public class RasterDataContainerFactory {
	...
	private static ServiceLoader<RasterDataContainerProvider> rasterContainerLoader = ServiceLoader
		.load(RasterDataContainerProvider.class);
	...
	/**
	 * Create a RasterDataContainer for given LoadingPolicy. The loading policy controlls
	 * if a raster should be loaded immediately, on demand or cached.
	 * @param reader
	 * @param policy
	 ...
	 * @param policy if <code>null</code> it will be ignored.
	 */
