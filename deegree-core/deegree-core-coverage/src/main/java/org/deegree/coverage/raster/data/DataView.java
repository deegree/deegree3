...
public class DataView extends RasterRect {
	...
	/**
	 * Constructor if the info on the view on the data equals the original raster data
	 * info.
	 * @param xOffset offset in the original raster data x-axis
	 * @param yOffset offset in the original raster data y-axis
	 * @param width the width of the new view on the original data
	 * @param height the height of the view on the original data
	 * @param viewOnData information on the view of this data.
	 */
	 ...
	 * Constructor if the info on the view on the data equals the original raster data
	 * info.
	 * @param rasterRect to get the views parameters from.
	 * @param viewOnData information on the view of this data.
	 */
	 ...
	 * @param rasterRect to get the views parameters from.
	 * @param viewOnData information on the view of this data.
	 * @param originalInfo used to calculate the band offsets for this view.
	 */
	...
	/**
	 * Returns the band number of the original data for a requested band in this view on
	 * the data.
	 * @param requestedBand of the view
