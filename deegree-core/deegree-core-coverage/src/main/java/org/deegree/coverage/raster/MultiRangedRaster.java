...
public class MultiRangedRaster extends AbstractRaster {
	 ...
	 * @param x left boundary
	 * @param y upper boundary
	 * @param index index of the destination range
	 * @param source data to copy (first band will be used)
	 */
	@Override
	...
	public SimpleRaster getAsSimpleRaster() {
		...
		SimpleRaster result = raster
			.createCompatibleSimpleRaster(BandType.fromBufferedImageType(0, multiRange.size(), null));
