...
public class ResolutionInfo implements Serializable {
	...
	/**
	 * Different modes to retrieve the next / previous native resolution. They coarsely
	 * resemble the same mathematical functions for floating point numbers.
	 */
	 ...
	 * @param resolution the native resolution of the coverage.
	 */
	 ...
	 * @param resolutions the native resolutions of the coverage.
	 */
	...
	/**
	 * Returns the native resolutions of the coverage. A 'continuous' coverage has no
	 * sample resolutions, it therefore will return the empty list.
	 * @return the native resolutions of the given coverage or the empty list if the
	 * coverage has no 'native' resolution (for example a continuous function). Never
	 ...
	 * If the given coverage does not have a native resolution the given resolution will
	 * be returned.
	 * @param targetResolution the required resolution.
	 * @param mode the mode of the to be used for finding the best fit.
	 * @return the SampleResolution best fitting the given target resolution and mode, if
	 * no 'native' resolution is available, the given targetResolution will be returned,
