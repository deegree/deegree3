...
public class RasterRangeSetTest {
	...
	public void oneBandIntervalTest() throws IOException {
		...
		Interval<?, ?> inter = Interval.createFromStrings("Byte", Short.toString((short) this.colors[4]),
				Short.toString((short) this.colors[2]), org.deegree.coverage.rangeset.Interval.Closure.open, null,
				false, spacing);
		intervals.add(inter);
		inter = Interval.createFromStrings("Byte", Short.toString((short) this.colors[8]),
				Short.toString((short) this.colors[6]), org.deegree.coverage.rangeset.Interval.Closure.open, null,
				false, spacing);
		intervals.add(inter);
		...
		testDefaults(raster);
		BufferedImage newImage = RasterFactory.imageFromRaster(subset);
		testOneBandValues(newImage, -1, -1,
				new int[] { colors[2], colors[3], colors[4], colors[6], colors[7], colors[8] }, nullValue);
	}
	...
	public void oneBandIntervalSinglesTest() throws IOException {
		...
		Interval<?, ?> inter = Interval.createFromStrings("Byte", Short.toString((short) this.colors[3]),
				Short.toString((short) this.colors[1]), org.deegree.coverage.rangeset.Interval.Closure.open, null,
				false, spacing);
		intervals.add(inter);
		...
		BufferedImage newImage = RasterFactory.imageFromRaster(subset);
		testOneBandValues(newImage, -1, -1,
				new int[] { colors[1], colors[2], colors[3], colors[5], colors[6], colors[7], colors[9] }, nullValue);
	}
	...
	public void twoBandIntervalSinglesTest() throws IOException {
		...
		Interval<?, ?> inter = Interval.createFromStrings("Byte", Short.toString((short) this.colors[2]),
				Short.toString((short) this.colors[0]), org.deegree.coverage.rangeset.Interval.Closure.open, null,
				false, spacing);
		intervals.add(inter);
		inter = Interval.createFromStrings("Byte", Short.toString((short) this.colors[7]),
				Short.toString((short) this.colors[6]), org.deegree.coverage.rangeset.Interval.Closure.open, null,
		...
		testDefaults(raster);
		BufferedImage newImage = RasterFactory.imageFromRaster(subset);
		testBandValues(newImage, -1, -1, null, new int[] { colors[5], colors[9] },
				new int[] { colors[0], colors[1], colors[2], colors[6], colors[7] }, nullValues);
	}
