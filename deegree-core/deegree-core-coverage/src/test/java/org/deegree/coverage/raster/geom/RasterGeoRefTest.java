...
public class RasterGeoRefTest {
	...
	private final static RasterGeoReference REF_CENTER = new RasterGeoReference(
			RasterGeoReference.OriginLocation.CENTER, RES_X, RES_Y, ORIG_X, ORIG_Y, defaultCRS);

	private final static RasterGeoReference REF_OUTER = new RasterGeoReference(RasterGeoReference.OriginLocation.OUTER,
			RES_X, RES_Y, ORIG_X, ORIG_Y, defaultCRS);
	...
	/**
	 * Test {@link RasterGeoReference#getRasterCoordinate(double, double)} for a center
	 * reference
	 */
	@Test
	...
	/**
	 * Test {@link RasterGeoReference#getRasterCoordinate(double, double)} for an outer
	 * reference
	 */
	@Test
	...
	/**
	 * Test {@link RasterGeoReference#getRasterCoordinateUnrounded(double, double)} for a
	 * center reference
	 */
	@Test
	...
	/**
	 * Test {@link RasterGeoReference#getRasterCoordinateUnrounded(double, double)} for an
	 * outer reference
	 */
	@Test
	...
	/**
	 * Test {@link RasterGeoReference#getWorldCoordinate(double, double)} for a center
	 * reference
	 */
	@Test
	...
	/**
	 * Test {@link RasterGeoReference#getWorldCoordinate(double, double)} for an outer
	 * reference
	 */
	@Test
	...
	/**
	 * Test the {@link RasterGeoReference#create(OriginLocation, Envelope, int, int)}
	 * method.
	 */
	@Test
	public void create() {
	...
	/**
	 * Test the {@link RasterGeoReference#relocateEnvelope(OriginLocation,Envelope)}
	 * method.
	 */
	@Test
