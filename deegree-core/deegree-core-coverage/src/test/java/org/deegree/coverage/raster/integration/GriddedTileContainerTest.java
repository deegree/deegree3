...
public class GriddedTileContainerTest extends CenterOuterTest {
	...
	private TiledRaster buildRaster(OriginLocation type) throws IOException, NumberFormatException, URISyntaxException {
	...
	public void lr9Overlap() {
		Envelope request = geomFac.createEnvelope(getPositionX(1028.5), getPositionY(1998), getPositionX(1031.5),
				getPositionY(2002), null);
		// center, rb: visually verified 28.10.2009
	...
	public void ul0Inside() {
		Envelope request = geomFac.createEnvelope(getPositionX(1001.5), getPositionY(2026.5), getPositionX(1005.5),
				getPositionY(2029.5), null);
		// center, rb: visually verified 28.10.2009
	...
	public void allStrife() {
		Envelope request = geomFac.createEnvelope(getPositionX(1008.5), getPositionY(2009.5), getPositionX(1021),
				getPositionY(2022), null);
		// center, rb: visually verified 28.10.2009
