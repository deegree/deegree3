...
/**
 * Encapsulates the relevant viewing and projection parameters that are needed for
...
public class ViewParams {
	 ...
	 * @param vf view frustum (volume visible to the viewer)
	 * @param projectionWidth number of pixels of the projected image in the x direction
	 * @param projectionHeight number of pixels of the projected image in the y direction
	 *
	 */
	...
	/**
	 * Returns a guaranteed upper bound for the size that a world-space unit (e.g. a line
	 * with length 1) has in pixels after perspective projection, i.e. in pixels on the
	 * screen.
	 * @param dist distance of the object (from the point-of-view)
