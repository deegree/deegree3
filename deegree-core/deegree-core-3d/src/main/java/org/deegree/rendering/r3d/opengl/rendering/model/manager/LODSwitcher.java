...
/**
 * The <code>LODSwitcher</code> holds (configured) scale values for a
 * {@link WorldRenderableObject} with which the latter can decide which LOD it should use
 * to represent it self. The values are supposed to be units per pixel.
 *
...
public class LODSwitcher {
	 ...
	 * @param sizeInUnits of the building (normally the length of the min-max points of
	 * the bbox)
