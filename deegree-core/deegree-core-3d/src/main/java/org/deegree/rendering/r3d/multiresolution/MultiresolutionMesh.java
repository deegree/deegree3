...
/**
 * Implementation of a fragment based multiresolution model for massive triangle meshes
 * (e.g. large terrain surfaces, but also suitable for free-form surfaces) based on the
 * <a href="http://vcg.isti.cnr.it/Publications/2005/CGGMPS05/BatchedMT_Vis05.pdf">Batched
 * Multi-Triangulation</a> as described by Cignoni et al.
 * <p>
 * This class encapsulates the augmented multiresolution-DAG:
 * <ul>
 * <li>nodes: each node corresponds to a modification (except the root and drain
 * nodes)</li>
 * <li>arcs: each arc describes the refinement of a certain region</li>
 * <li>fragments: each fragment describes a certain region of the geometry at a certain
 * LOD</li>
 * </ul>
 * </p>
 *
...
public class MultiresolutionMesh {
	...
	/**
	 * Contains all {@link MeshFragment}s of the DAG, the array index corresponds to its
	 * id.
	 */
	...
	/**
	 * Creates a new {@link MultiresolutionMesh} by reading the fragment
	 * ({@link #FRAGMENTS_FILE_NAME}) and index ( {@link #INDEX_FILE_NAME}) blobs in the
	 * given directory.
	 * @param dir directory that contains the fragment and index blobs to be read
	 * @throws IOException
	 */
	...
	/**
	 * Creates a new {@link MultiresolutionMesh} by reading the specified fragment
	 * ({@link #FRAGMENTS_FILE_NAME}) and index ( {@link #INDEX_FILE_NAME}) blobs.
	 * @param mrIndex index blob
	 * @param meshFragments fragment blob
	 * @throws IOException
	 */
	...
	/**
	 * @return the domain of this multiresolution mesh as read from the first macro
	 * triangle fragment.
	 */
	 ...
	 * @param crit criterion that the LOD must satisfies
