...
/**
 * The <code>RenderableManager</code> is a collection based on a quadtree which can hold
 * {@link PositionableModel} objects and cull them according to a given {@link ViewParams}
 * view frustum.
 *
...
public abstract class RenderableManager<T extends PositionableModel> implements Collection<T>, JOGLRenderable {
	...
	/**
	 * @param validDomain of this Renderable Manager
	 */
	...
	/**
	 * (Re) set the valid domain of this renderer. Be careful, this will create a new quad
	 * tree.
	 * @param newDomain of this manager
	 */
