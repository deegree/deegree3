...
/**
 * The <code>BOXGeometry</code> a simple box, which might be used as a prototype
 * reference.
 *
...
public class BOXGeometry extends RenderableGeometry {
	...
	private final float[][] cubeData = { { -cubeHalf, -cubeHalf, testObjectSize },
			{ cubeHalf, -cubeHalf, testObjectSize }, { cubeHalf, cubeHalf, testObjectSize },
			{ -cubeHalf, cubeHalf, testObjectSize }, { -cubeHalf, -cubeHalf, 0 }, { cubeHalf, -cubeHalf, 0 },
