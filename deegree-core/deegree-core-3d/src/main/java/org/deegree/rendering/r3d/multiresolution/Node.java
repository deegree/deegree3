...
public class Node {
	 ...
	 * @param mt {@link MultiresolutionMesh} instance that the node is part of
	 * @param id id of the node
	 * @param buffer buffer that contains the binary representation of the node
	 ...
	 * @param lowestOutgoingArc lowest id of all arcs leaving from this node
	 * @param highestOutgoingArc highest id of all arcs leaving from this node
	 * @param lowestIncomingArc lowest id of all arcs entering this node
	 * @param bbox bounding box of this node
	 */
