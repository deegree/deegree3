...
/**
 * Implementation of a shader based color map for the WPVS. Colors will be linear
...
public class Colormap {
	 ...
	 * @param zMin the minimum value of the terrain
	 * @param zMax the maximum value of the terrain
	 */
