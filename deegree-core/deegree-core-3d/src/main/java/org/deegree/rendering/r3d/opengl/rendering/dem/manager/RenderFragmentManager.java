...
/**
 * Manages the loading, unloading and caching of {@link RenderMeshFragment} data and the
...
public class RenderFragmentManager {
	...
	/**
	 * Ensures that the data of the specified fragments is available in main memory or in
	 * GPU memory.
	 * @param fragments
	 * @throws IOException
	 */
	void require(Set<RenderMeshFragment> fragments) throws IOException {
	...
	/**
	 * Ensures that the data of the specified fragments is available in GPU memory (ready
	 * for rendering).
	 * @param fragments
	 * @param gl
	 * @throws IOException
	 */
	void requireOnGPU(Collection<RenderMeshFragment> fragments, GL gl) throws IOException {
	...
	/**
	 * Notifies the manager that the specified fragments are not needed for rendering
	 * anymore.
	 * <p>
	 * It's up to the manager to decide to unload them from GPU and/or memory or to keep
	 * them cached.
	 * </p>
	 * @param fragments
	 * @param gl
	...
	/**
	 *
	 * The <code>Cache</code> is a Map containing renderfragments mapped to their GLBuffer
	 * ids.
	 *
