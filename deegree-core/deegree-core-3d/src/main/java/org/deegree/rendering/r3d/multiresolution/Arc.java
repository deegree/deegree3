...
public class Arc {
	 ...
	 * @param mt {@link MultiresolutionMesh} instance that the arc is part of
	 * @param id id of the arc
	 * @param buffer buffer that contains the binary representation of the arc
	 * @param baseOffset offset in the buffer
	 */
	 ...
	 * @param target buffer where the binary representation is written to
	 * @param sourceNode id of the source node of the arc
	 * @param destinationNode id of the destination node of the arc
	 * @param lowestPatch lowest patch id in the label of the arc
	 * @param highestPatch highest patch id in the label of the arc
	 * @param nextArcWithSameDestination id of the next arc with the same destination node
	 * (-1 if there is none)
	 * @param geometricError geometric error
	 */
	public static void store(ByteBuffer target, int sourceNode, int destinationNode, int lowestPatch, int highestPatch,
			int nextArcWithSameDestination, float geometricError) {
	 ...
	 * @param roi geometry that is tested for interference
