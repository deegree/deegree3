...
public class QualityModel<T extends QualityModelPart> implements Serializable, MemoryAware {
	...
	/**
	 * Creates a GeometryQualityModel with the given geometry patches
	 * @param prototype to be renedered
	 */
	...
	/**
	 * @param part to add to the geometries
	...
	/**
	 * @param parts to add to the quality model
	 * @return true (as specified by Collection.add)
	 */
	...
	/**
	 * @param index
	 * @return the geometry data at given index or <code>null</code> if the index is out
	 * of bounds.
	 */
	...
	/**
	 * @return the reference to the qualityModelParts, alterations to the patches will be
	 * reflected, may be <code>null</code>
	 */
