...
/**
 * Encapsulates a {@link MeshFragment} of a {@link MultiresolutionMesh} that can be
 * rendered via JOGL.
 * <p>
...
public class RenderMeshFragment implements Comparable<RenderMeshFragment> {
	...
	/**
	 * @param fragment a MultiresolutionMesh fragment to create a renderable fragment
	 * from.
	 */
	...
	/**
	 * Disables the fragment in the given OpenGL context and frees the associated VBOs and
	 * texture object.
	 * @param gl
	 */
	 ...
	 * @param gl context to render in.
	 * @param textures may be empty, or null
	 * @param shaderProgram the shader program containing composite texturing code.
	 * @throws RuntimeException if the geometry data is currently not bound to VBOs
	 */
	...
	/**
	 * @return true if the used direct buffer pool can allocate enough direct memory for
	 * the given data.
	 */
	...
	/**
	 * @return the vertices of the macro triangle of this Mesh fragment. The returned
	 * array will have size [3][2], never <code>null</code>.
	 */
