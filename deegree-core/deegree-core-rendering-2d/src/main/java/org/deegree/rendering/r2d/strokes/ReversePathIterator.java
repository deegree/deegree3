...
/**
 * A path iterator which iterates over a path in the reverse direction. This is missing in the java.awt.geom package,
 * although it's quite simple to implement. After initialization the original PathIterator is not used any longer.
 * <p>
 * There are several static convenience methods to create a reverse path iterator from a shape directly:
 * <ul>
 * <li>{@link #getReversePathIterator(java.awt.Shape)} for reversing the standard path iterator</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, double)} for reversing a flattened path iterator</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, java.awt.geom.AffineTransform)} for reversing a transformed path
 * iterator</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, java.awt.geom.AffineTransform, double)} for reversing a
 * transformed flattened path iterator</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, int)} for reversing the standard path iterator while explicitely
 * defining a winding rule</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, double, int)} for reversing a flattened path iterator while
 * explicitely defining a winding rule</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, java.awt.geom.AffineTransform, int)} for reversing a transformed
 * path iterator while explicitely defining a winding rule</li>
 * <li>{@link #getReversePathIterator(java.awt.Shape, java.awt.geom.AffineTransform, double, int)} for reversing a
 * transformed flattened path iterator while explicitely defining a winding rule</li>
 * </ul>
 * 
...
public class ReversePathIterator implements PathIterator {
     ...
     * 
     * @param shape
     *            shape for which a reverse path iterator is needed
     ...
     * 
     * @param shape
     *            shape for which a reverse flattened path iterator is needed
     * @param flatness
     *            flatness epsilon
     ...
     * 
     * @param shape
     *            shape for which a reverse transformed path iterator is needed
     ...
     * 
     * @param shape
     *            shape for which a reverse transformed flattened path iterator is needed
     * @param flatness
     *            flatness epsilon
    ...
    /**
     * Returns the winding rule for determining the interior of the path. This just returns the winding rule of the
     * original path, which may or may not be what is wanted.
     * 
