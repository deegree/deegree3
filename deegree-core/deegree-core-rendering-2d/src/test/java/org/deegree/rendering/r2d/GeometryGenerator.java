...
public class GeometryGenerator {
	...
	/**
	 * @param max generate points between offx/offy and max + offx/offy
	 * @param offx
	 * @param offy
	...
	public static Polygon randomTriangle(int max, double offx, double offy) {
		...
		Point[] ps = { fac.createPoint(null, new double[] { x, y }, mapcs),
				fac.createPoint(null, new double[] { rnd.nextDouble() * max + offx, rnd.nextDouble() * max + offy },
						mapcs),
				fac.createPoint(null, new double[] { rnd.nextDouble() * max + offx, rnd.nextDouble() * max + offy },
						mapcs),
	...
	public static Polygon randomQuad(int max, double offx, double offy) {
		...
		Point[] ps = { fac.createPoint(null, new double[] { x, y }, mapcs),
				fac.createPoint(null,
						new double[] { rnd.nextDouble() * half + half + offx, rnd.nextDouble() * half + offy }, mapcs),
				fac.createPoint(null,
						new double[] { rnd.nextDouble() * half + half + offx, rnd.nextDouble() * half + half + offy },
						mapcs),
				fac.createPoint(null,
						new double[] { rnd.nextDouble() * half + offx, rnd.nextDouble() * half + half + offy }, mapcs),
				fac.createPoint(null, new double[] { x, y }, mapcs) };
		return fac.createPolygon(null, mapcs, fac.createLinearRing(null, mapcs, new PointsList(asList(ps))), null);
	}
	...
	public static Curve randomCurve(int max, double offx, double offy) {
		...
		Point[] ps = { fac.createPoint(null, new double[] { x, y }, mapcs),
				...
				fac.createPoint(null,
						...
						mapcs),
				fac.createPoint(null,
						new double[] { rnd.nextDouble() * half + offx, rnd.nextDouble() * half + half + offy },
						mapcs) };
