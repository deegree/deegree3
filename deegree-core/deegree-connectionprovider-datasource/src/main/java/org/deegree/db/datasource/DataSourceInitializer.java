...
class DataSourceInitializer {
     ...
     * 
     * @param classLoader
     *            class loader to be used, can be <code>null</code> (use default class loader)
     */
    ...
    /**
     * Creates/retrieves a {@link DataSource} instance and applies configuration properties via setters.
     * 
     * @param config
    ...
    private Object[] getJavaArgs( List<Argument> arguments )
                            throws ClassNotFoundException {
    ...
    Object getJavaArg( Argument argument )
                            throws ClassNotFoundException {
    ...
    private Class<?> getClass( String javaClass )
                            throws ClassNotFoundException {
        if ( classLoader == null ) {
