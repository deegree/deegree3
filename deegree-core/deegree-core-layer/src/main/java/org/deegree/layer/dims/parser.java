...
public class parser extends java_cup.runtime.lr_parser {
    ...
    /** Production table. */
    protected static final short _production_table[][] = unpackFromStrings( new String[] { "\000\015\000\002\003\003\000\002\002\004\000\002\004"
    ...
    /** Parse-action table. */
    protected static final short[][] _action_table = unpackFromStrings( new String[] { "\000\022\000\004\006\006\001\002\000\004\002\001\001"
    ...
    protected static final short[][] _reduce_table = unpackFromStrings( new String[] { "\000\022\000\010\003\006\004\003\005\004\001\001\000"
...
class CUP$parser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$parser$do_action( int CUP$parser$act_num,
        ...
        case 12: // interval ::= TOKEN SLASH error
        {
            ...
            Object min = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 2 ) ).value;
        ...
        case 11: // interval ::= TOKEN error
        {
            ...
            Object min = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 1 ) ).value;
        ...
        case 10: // interval ::= TOKEN SLASH TOKEN SLASH TOKEN
        {
            ...
            Object min = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 4 ) ).value;
            ...
            Object max = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 2 ) ).value;
            ...
            Object res = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 0 ) ).value;
        ...
        case 9: // interval ::= TOKEN SLASH TOKEN SLASH
        {
            ...
            Object min = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 3 ) ).value;
            ...
            Object max = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 1 ) ).value;
        ...
        case 8: // interval ::= TOKEN SLASH TOKEN
        {
            ...
            Object max = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 0 ) ).value;
            RESULT = new DimensionInterval( min, max, 0 );
            CUP$parser$result = new java_cup.runtime.Symbol(
                                                             3/* interval */,
                                                             ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 2 ) ).left,
        ...
        case 7: // values ::= interval COMMA error
        {
            ...
            Object val = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 2 ) ).value;
            ...
            Object err = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 0 ) ).value;
            String msg = ( err == null ? "Expected another interval after '" + val + ",'."
        ...
        case 5: // values ::= interval COMMA strt
        {
            ...
            Object vals = ( (java_cup.runtime.Symbol) CUP$parser$stack.elementAt( CUP$parser$top - 0 ) ).value;

            if ( val instanceof Exception ) {
                RESULT = val;
            } else {
                if ( vals instanceof LinkedList )
                    ( (LinkedList) vals ).addFirst( val );
                RESULT = vals;
            }
            CUP$parser$result = new java_cup.runtime.Symbol(
                                                             2/* values */,
