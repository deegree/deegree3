...
/**
 * Provides utility methods for parsing common constructs found in KVP-encoded WFS
 * requests.
 *
...
public abstract class AbstractWFSRequestKVPAdapter {
	 ...
	 * @param kvpUC the parameters of the request, normalized
	 * @param nsBindings namespace bindings, may be null
	 * @return qualified type names or <code>null</code> if no <code>TYPENAME</code>
	 * parameter is present
	 * @throws InvalidParameterValueException if the value of the <code>TYPENAME</code>
	 * attribute contains a syntactical error or uses unbound prefices
	 */
	protected static QName[] extractTypeNames(Map<String, String> kvpUC, Map<String, String> nsBindings)
		...
		if (typeNameString == null) {
			// probably this is what the spec actually wants to specify, there are typos
			// however...
	 ...
	 * </ul>
	 * @param kvpUC the parameters of the request, normalized
	 * @return mapping between prefices and namespaces (key: prefix, value: namespace),
	 ...
	 * @throws InvalidParameterValueException if the value of the NAMESPACE attribute
	 ...
	 * <li><code>NAMESPACE=xmlns(http://www.someserver.com)</code></li>
	 * </ul>
	 * @param param the parameters of the request, normalized, may be <code>null</code>
	 * @return mapping between prefices and namespaces (key: prefix, value: namespace),
	 * empty string as a key ('') is the binding of the default namespace, or
	 * <code>null</code> if no <code>NAMESPACE</code> parameter present
	 * @throws InvalidParameterValueException if the value of the NAMESPACE attribute
	 * contains a syntactical error
	 */
	...
	/**
	 * Transforms a (possibly prefixed) type name into a qualified name using the given
	 * namespace bindings.
	 * @param name possibly prefixed type name
	 * @param nsBindings namespace bindings, may be null
