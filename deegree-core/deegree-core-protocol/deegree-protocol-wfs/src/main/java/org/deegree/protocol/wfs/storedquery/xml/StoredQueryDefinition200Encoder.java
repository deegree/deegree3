...
public class StoredQueryDefinition200Encoder {
	 ...
	 * @param storedQueryDefinition <code>StoredQueryDefinition</code> object to be
	 * serialized, never <code>null</code>
	 * @param writer to export the StoredQueryDefinition in, never <code>null</code>
	...
	private static void writeTitles(List<LanguageString> titles, XMLStreamWriter writer) throws XMLStreamException {
	...
	private static void exportMetadata(List<OMElement> metadataEls, XMLStreamWriter writer) throws XMLStreamException {
