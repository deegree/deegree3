...
public class WFSFeatureCollection<T> {
    ...
    WFSFeatureCollection( XMLStreamReader xmlStream, GMLVersion gmlVersion, AppSchema schema )
        ...
        if ( WFS_200_NS.equals( xmlStream.getNamespaceURI() ) ) {
            ...
            // CR ??? pending:
            // <xsd:attribute name="numberReturned" type="wfs:nonNegativeIntegerOrUnknown" use="required"/>
    ...
    /**
     * Returns the object contained in the <code>wfs:member</code> property that the <code>XMLStreamReader</code>
     * currently points at.
     * <p>
     * <ul>
     * <li>Pre-condition: cursor must point at the <code>START_ELEMENT</code> event (<code>wfs:member</code>)</li>
     * <li>Post-condition: cursor points at the next element event after the corresponding <code>END_ELEMENT</code>
     * event</li>
     * </p>
     * 
