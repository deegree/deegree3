...
public class ProcessDetails {
	 ...
	 * @param describeResponse wps:ProcessDescriptions document containing a single
	 * ProcessDescription, must not be <code>null</code>
	 */
	...
	/**
	 * Returns whether the process supports status information during asynchronous
	 * operation.
