...
public class LiteralInputType extends InputType {
	...
	/**
	 * Triple for (minValue, maxValue, spacing). Both minValue and maxValue are included
	 * in the interval. When the interval is continuous spacing is set to: 1 (for
	 * integers), 0 (for floats)
	 */
	private Range[] range;
	...
	public LiteralInputType(CodeType id, LanguageString inputTitle, LanguageString inputAbstract, String minOccurs,
			String maxOccurs, ValueWithRef dataType, ValueWithRef defaultUom, ValueWithRef[] supportedUoms,
			String[] allowedValues, Range[] range, boolean anyValue, ValueWithRef reference) {
	...
	/**
	 * @return an array of {@link Range} instances, each describing the interval in which
	...
	/**
	 * Returns a {@link ValueWithRef} instance (that encapsulates a String and an
	 * {@link URL}), as data type for the literal input.
	...
	/**
	 * Returns a {@link ValueWithRef} instance (that encapsulates a String and an
	 * {@link URL}), as default Unit-of-measure for the literal input.
	...
	/**
	 * Returns an array of {@link ValueWithRef} instances (that encapsulates a String and
	 * an {@link URL}), as default Unit-of-measure for the literal input.
