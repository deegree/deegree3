...
/**
 * The <code>WCSTConstants</code> based on the inspire Draft Technical Guidance for
...
public class WCTSConstants {
	...
	public enum ExceptionCodes {
		...
		NoInputData,
		/**
		 * One or more points are outside of the the domainOfValidity of the in coordinate
		 * operation.
		 */
		InvalidArea,
		/**
		 * Returned in case of a computation error occurring during a coordinate
		 * operation.
		 */
		TransformException,
		...
		/**
		 * Operation request contains an output CRS, which can not used within the output
		 * format.
		 */
		UnsupportedCombination,
		/**
		 * The coordinate transformation with the defined parameters is possible <b>not an
		 * actual exception</b>
		 */
		Transformable,
