...
public class WCSConstants {
	...
	/**
	 * Enum type for discriminating between the different types of WebCoverageService
	 * (WCS) requests.
	 *
	 * @author <a href="mailto:schneider@lat-lon.de">Markus Schneider</a>
	 */
	...
	/**
	 *
	 * The <code>ExeptionCode_1_0_0</code> defines the exception codes for the WCS 1.0.0
	 * specification.
	 *
	...
	/**
	 *
	 * The <code>InterpolationMethod</code> class maps Interpolations to the wcs 1.0.0
	 * protocol name.
	 *
	 * @author <a href="mailto:bezema@lat-lon.de">Rutger Bezema</a>
	 *
	...
	public enum InterpolationMethod {
		...
		/**
		 * @param version of the suspected protocol.
		...
		/**
		 * @param type
		 * @return maps the Raster-API {@link InterpolationType} to the WCS
		...
		/**
		 * @return this WCS interpolation type as a raster api type, or <code>null</code>
		 * if it the interpolation method is not supported by the raster api.
		 */
