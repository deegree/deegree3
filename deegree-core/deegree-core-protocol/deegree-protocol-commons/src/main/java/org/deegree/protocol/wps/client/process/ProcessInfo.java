...
/**
 * Encapsulates all information on a WPS process that's available from the capabilities
 * document.
 *
...
public class ProcessInfo {
	 ...
	 * @param id the identifier of the process, must not be <code>null</code>
	 * @param title the title of the process, must not be <code>null</code>
	 * @param processAbstract the abstract of the process, can be <code>null</code>
	 * @param version the version of the process, must not be <code>null</code>
	 */
