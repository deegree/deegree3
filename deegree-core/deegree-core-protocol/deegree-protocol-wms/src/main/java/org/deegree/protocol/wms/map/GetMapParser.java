...
public class GetMapParser extends AbstractWmsParser {
	 ...
	 * parsing a value
	 */
	public GetMap parse(XMLStreamReader getMap) throws OWSException, XMLStreamException {
	...
	private Output parseOutput(XMLStreamReader in) throws XMLStreamException, OWSException {
	...
	private Color parseColor(XMLStreamReader in) throws XMLStreamException, OWSException {
	...
	private Map<String, List<?>> parseDimensions(XMLStreamReader in) throws XMLStreamException {
	...
	private void parseAndAddValues(XMLStreamReader in, Map<String, List<?>> dimensions) throws XMLStreamException {
	...
	private void parseAndAddInterval(XMLStreamReader in, Map<String, List<?>> dimensions) throws XMLStreamException {
	...
	private ICRS parseCRS(XMLStreamReader in) throws UnknownCRSException, XMLStreamException {
		String crs = XMLStreamUtils.getRequiredText(in, new QName(SLDNS, "CRS"), true);
		return CRSManager.lookup(crs);
	}

	private Envelope parseBoundingBox(XMLStreamReader in) throws UnknownCRSException, OWSException, XMLStreamException {
	...
	private double[] parseCorner(XMLStreamReader in, QName expectedElement) throws OWSException, XMLStreamException {
