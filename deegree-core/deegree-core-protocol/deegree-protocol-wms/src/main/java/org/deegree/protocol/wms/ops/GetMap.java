...
public class GetMap extends RequestBase {
	...
	private void handleCommon(Map<String, String> map, MapOptionsMaps exts, boolean parseStrict) throws OWSException {
	...
	private void parse130(Map<String, String> map, MapOptionsMaps exts, boolean parseStrict) throws OWSException {
	...
	/**
	 * @return the KVP map of parameters. May not be accurate/empty, especially if this
	 * object has been created by some other means than a KVP request.
	 */
	...
	/**
	 * @return null, or a map with parameters that should be overridden when used as
	 * client parameter object.
	 */
