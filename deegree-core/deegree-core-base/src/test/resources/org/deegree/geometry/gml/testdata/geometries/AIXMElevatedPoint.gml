...
<ElevatedPoint gml:id="P1" xmlns="http://www.aixm.aero/schema/5.1" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <gml:metaDataProperty>
    <gml:GenericMetaData>Example for metadata: Ce point ne pas une GML point, c'est une AIXM point.
    </gml:GenericMetaData>
  </gml:metaDataProperty>
