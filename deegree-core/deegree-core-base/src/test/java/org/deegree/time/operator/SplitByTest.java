...
public class SplitByTest {
    ...
    public void evaluateTContains() {
        assertSplitBy( period( "00:00:02", "00:00:03" ), period( "00:00:03", "00:00:04" ),
                       period( "00:00:04", "00:00:05" ), period( "00:00:02", "00:00:05" ),
                       period( "00:00:03", "00:00:04" ) );
    ...
    public void evaluateAfter() {
        ...
        assertSplitBy( period( "00:00:02", null ), null, null, period( "00:00:02", null ),
                       period( "00:00:00", "00:00:01" ) );
    ...
    public void evaluateBefore() {
        ...
        assertSplitBy( period( null, "00:00:05" ), null, null, period( null, "00:00:05" ),
                       period( "00:00:06", "00:00:07" ) );
    ...
    private void assertSplitBy( final TimeGeometricPrimitive expectedBegin,
                                final TimeGeometricPrimitive expectedIntersection,
                                final TimeGeometricPrimitive expectedEnd, final TimeGeometricPrimitive a,
                                final TimeGeometricPrimitive b ) {
