...
public class GMLAppSchemaWriterTest {
	...
	public void testGML311CurveSegments()
		...
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml", "_CurveSegment"), "http://www.opengis.net/gml", true, true);
	...
	public void testGML311SurfacePatches()
		...
		GMLSchemaInfoSet analyzer = new GMLSchemaInfoSet(null, schemaURL);
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml", "_SurfacePatch"), "http://www.opengis.net/gml", true, true);
		for (XSElementDeclaration elementDecl : elementDecls) {
			LOG.debug(elementDecl.getName());
		}
	}
	...
	public void testGML321CurveSegments()
		...
		GMLSchemaInfoSet analyzer = new GMLSchemaInfoSet(null, schemaURL);
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml/3.2", "AbstractCurveSegment"), "http://www.opengis.net/gml/3.2",
				true, true);
		for (XSElementDeclaration elementDecl : elementDecls) {
			LOG.debug(elementDecl.getName());
		}
	...
	public void testGML321SurfacePatches()
		...
		GMLSchemaInfoSet analyzer = new GMLSchemaInfoSet(null, schemaURL);
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml/3.2", "AbstractSurfacePatch"), "http://www.opengis.net/gml/3.2",
				true, true);
		for (XSElementDeclaration elementDecl : elementDecls) {
			LOG.debug(elementDecl.getName());
		}
	...
	public void testGML321GeometryElements()
		...
		GMLSchemaInfoSet analyzer = new GMLSchemaInfoSet(null, schemaURL);
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml/3.2", "AbstractGeometry"), "http://www.opengis.net/gml/3.2", true,
				true);
		for (XSElementDeclaration elementDecl : elementDecls) {
			LOG.debug(elementDecl.getName());
		}
	...
	private Set<String> getConcreteSubstitutions(String localName, GMLSchemaInfoSet analyzer) {
		List<XSElementDeclaration> elementDecls = analyzer.getSubstitutions(
				new QName("http://www.opengis.net/gml", localName), "http://www.opengis.net/gml", true, true);
	...
	@Test
	public void testReexportCiteSF1() throws ClassCastException, ClassNotFoundException, InstantiationException,
	...
	@Test
	public void testExportSchemaWrappped() throws Exception {
		...
		assertThat(os.toString(), EvaluateXPathMatcher.hasXPath("count(/xs:schema/xs:include)", is("2"))
