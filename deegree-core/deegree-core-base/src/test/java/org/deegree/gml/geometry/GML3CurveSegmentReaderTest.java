...
/**
 * Tests that check the correct parsing of GML 3.1.1 curve segments, i.e. of elements that
 * are substitutable for <code>gml:_CurveSegment</code>.
 *
...
public class GML3CurveSegmentReaderTest {
	...
	@Test
	public void parseArc() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseArcByBulge() throws XMLStreamException, FactoryConfigurationError, IOException,
	...
	@Test
	public void parseArcByCenterPoint() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseArcString() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseArcStringByBulge() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseBezier() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseBSpline() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseCircle() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseCircleByCenterPoint() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseClothoid() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseCubicSpline() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseGeodesic() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void parseGeodesicString() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseLineStringSegment() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	@Test
	public void parseOffsetCurve() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
	...
	private XMLStreamReaderWrapper getReader(String fileName)
		...
		XMLStreamReaderWrapper xmlReader = new XMLStreamReaderWrapper(
				GML3CurveSegmentReaderTest.class.getResource("../misc/geometry/segments/" + fileName));
		xmlReader.nextTag();
		return xmlReader;
	}

	private GML3CurveSegmentReader getParser() throws FactoryConfigurationError {
