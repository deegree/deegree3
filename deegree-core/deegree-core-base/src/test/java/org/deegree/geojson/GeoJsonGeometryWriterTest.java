...
public class GeoJsonGeometryWriterTest {
    ...
    @Test
    public void testWriteGeometry_Point()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_PointInEPSG4326()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_Line()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_Polygon()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_PolygonWithInteriorRing()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_MultiPoints()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_MultiLineStrings()
                            throws Exception {
    ...
    @Test
    public void testWriteGeometry_MultiPolygons()
                            throws Exception {
    ...
    public void testWriteGeometry_UnsupportedGeometry()
                            throws Exception {
    ...
    private JsonWriter instantiateJsonWriter( StringWriter json )
                            throws IOException {
