...
public class GeoJsonFeatureWriterTest {
    ...
    public void testWrite()
        ...
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.originalMapScaleDenominator", is( 10 ) ) );
        assertThat( featureCollection,
        ...
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.name.GeographicalName.spelling.SpellingOfName.text",
                                 is( "Hamburg" ) ) );
        assertThat( featureCollection, hasJsonPath( "$.features[0].properties.levelName.LocalisedCharacterString.value",
                                                    is( "Bundesland" ) ) );
    ...
    @Test
    public void testWrite_FeatureCollectionWithPrimitiveArray()
                            throws Exception {
        StringWriter featureAsJson = new StringWriter();
        GeoJsonWriter geoJsonFeatureWriter = new GeoJsonWriter( featureAsJson, null );
        Feature cadastralZoning = parseFeature( "CadastralZoningWithPrimitiveArray.gml" );
    ...
    @Test
    public void testWrite_FeatureCollectionWithArrays()
                            throws Exception {
        StringWriter featureAsJson = new StringWriter();
        GeoJsonWriter geoJsonFeatureWriter = new GeoJsonWriter( featureAsJson, null );
        ...
        assertThat( featureCollection, hasJsonPath( "$.features[0].properties.inspireId.Identifier.localId",
                                                    is( "urn:adv:oid:DEHHALKA10000005" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.name[0].GeographicalName.spelling.SpellingOfName.text",
                                 is( "Hamburg" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.name[1].GeographicalName.spelling.SpellingOfName.text",
                                 is( "HH" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.levelName[0].LocalisedCharacterString.value",
                                 is( "Bundesland" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.levelName[1].LocalisedCharacterString.value",
                                 is( "federal state" ) ) );
    }

    @Test
    public void testWrite_complexPropertyWithList()
                            throws Exception {
        StringWriter featureAsJson = new StringWriter();
        GeoJsonWriter geoJsonFeatureWriter = new GeoJsonWriter( featureAsJson, null );
        ...
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element.length()",
                                 is( 62 ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].datum",
                                 is( "2014" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list.length()",
                                 is( 2 ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list[0].country-complex.name",
                                 is( "Myanmar" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list[0].country-complex.name",
                                 is( "Myanmar" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list[1].country-complex.length()",
                                 is( 2 ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list[1].country-complex[0].name",
                                 is( "Indien" ) ) );
        assertThat( featureCollection,
                    hasJsonPath( "$.features[0].properties.wohnungslose_jep.zeitreihe.zeitreihen-element[0].country-list[1].country-complex[1].name",
                                 is( "Nordkorea" ) ) );
    }
