...
public class GetPropertyValueXMLAdapterTest {
    ...
    public void test200Example2()
        ...
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example2.xml" ) );
    ...
    public void test200Example4()
                            throws Exception {
        GetPropertyValueXMLAdapter parser = new GetPropertyValueXMLAdapter();
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example4.xml" ) );
        GetPropertyValue request = parser.parse();
        assertEquals( VERSION_200, request.getVersion() );
        ...
        assertNull( request.getResolveParams().getResolveTimeout() );
        FilterQuery query = (FilterQuery) request.getQuery();
        OperatorFilter filter = (OperatorFilter) query.getFilter();
        Assert.assertTrue( filter.getOperator() instanceof And );
    }
    ...
    public void test200Example6()
                            throws Exception {
        GetPropertyValueXMLAdapter parser = new GetPropertyValueXMLAdapter();
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example6.xml" ) );
        GetPropertyValue request = parser.parse();
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example7()
                            throws Exception {
        GetPropertyValueXMLAdapter parser = new GetPropertyValueXMLAdapter();
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example7.xml" ) );
        GetPropertyValue request = parser.parse();
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example8()
                            throws Exception {
        GetPropertyValueXMLAdapter parser = new GetPropertyValueXMLAdapter();
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example8.xml" ) );
        GetPropertyValue request = parser.parse();
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example9()
                            throws Exception {
        GetPropertyValueXMLAdapter parser = new GetPropertyValueXMLAdapter();
        parser.load( GetPropertyValueXMLAdapterTest.class.getResource( "xml/wfs200/example9.xml" ) );
        GetPropertyValue request = parser.parse();
        assertEquals( VERSION_200, request.getVersion() );
