...
public class GetPropertyValueKVPAdapterTest extends TestCase {
    ...
    public void test200Example1()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example1.kvp" ) );
    ...
    public void test200Example3()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example3.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example4()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example4.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example5()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example5.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example6()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example6.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example7()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example7.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
    ...
    public void test200Example8()
                            throws Exception {
        Map<String, String> kvpParams = readFileIntoMap( GetPropertyValueKVPAdapterTest.class.getResource( "kvp/wfs200/example8.kvp" ) );
        GetPropertyValue request = GetPropertyValueKVPAdapter.parse( kvpParams );
        assertEquals( VERSION_200, request.getVersion() );
