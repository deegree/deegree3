...
public class WKTWriterTest extends TestCase {
	...
	@Test
	public void test_LinearRingDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
	...
	@Test
	public void test_PointDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_LineStringDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	@Test
	public void test_PolygonDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
		...
		assertEquals(
				"POLYGON [id='']((0.0 0.0,10.0 0.0,10.0 10.0,0.0 10.0,0.0 0.0),(1.0 9.0,1.0 9.5,2.0 9.5,2.0 9.0,1.0 9.0),(9.0 1.0,9.0 2.0,9.5 2.0,9.5 1.0,9.0 1.0))",
				writer.toString());
	}

	@Test
	public void test_SurfaceDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
		...
		assertEquals(
				"SURFACE [id=''](((2.0 0.0,0.0 2.0,-2.0 0.0,-4.0 2.0,-6.0 0.0,0.0 10.0,2.0 0.0),(2.0 0.0,0.0 2.0,-2.0 0.0,-4.0 2.0,-6.0 0.0,0.0 10.0,2.0 0.0),(2.0 0.0,0.0 2.0,-2.0 0.0,-4.0 2.0,-6.0 0.0,0.0 10.0,2.0 0.0))"
						+ ","
	...
	@Test
	public void test_CurveDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_EnvelopeDKT() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	// ############################## USING OTHER FLAGS
	@Test
	public void test_LinearRing_FLAGLinearRing() throws XMLParsingException, XMLStreamException,
	...
	@Test
	public void test_Envelope_FLAGEnvelope() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	// ############################## USING NO FLAGS
	@Test
	public void test_Point() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_LineString() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	@Test
	public void test_LinearRing() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	@Test
	public void test_Polygon() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_Curve() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_Surface() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_Envelope() throws XMLParsingException, XMLStreamException, FactoryConfigurationError, IOException,
			UnknownCRSException {
	...
	@Test
	public void test_MultiPolygon() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
	...
	@Test
	public void test_MultiLineString() throws XMLParsingException, XMLStreamException, FactoryConfigurationError,
			IOException, UnknownCRSException {
		...
		WKTwriter.writeGeometry(geom, writer);
		// System.out.print( writer.toString() + "\n" );
		assertEquals("MULTILINESTRING ((7.1 50.7,10.0 53.5,13.4 52.5),(7.1 50.7,10.0 53.5,13.4 52.5))",
				writer.toString());

	}

	// ############################## PARSING THE GEOMETRY-FILE
	private Geometry parseGeometry(String fileName) throws XMLStreamException, FactoryConfigurationError, IOException,
	...
	private Geometry parseEnvelope(String fileName) throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
