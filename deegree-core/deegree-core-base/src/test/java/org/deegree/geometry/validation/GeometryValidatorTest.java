...
/**
 * Testcases that check the correct determination of topological properties by the
 * {@link GeometryValidator}.
 *
...
public class GeometryValidatorTest {
	...
	@Test
	public void validateCurve() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
	...
	@Test
	public void validateCurveDiscontinuity() throws XMLStreamException, FactoryConfigurationError, IOException,
	...
	@Test
	public void validateRing() throws XMLStreamException, FactoryConfigurationError, IOException, XMLParsingException,
			UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validateRingNotClosed() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validateRingSelfIntersection() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validateInvalidRingNotClosedAndSelfIntersection() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygon() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonExteriorAndInterior() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
		Geometry geom = parseGeometry("Polygon.gml");
		...
		// substitute original right handed CRS for a new left handed one, maintaining
		// polygon orientation
	...
	@Test
	public void validatePolygonExteriorClockwise() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonInteriorsCounterClockwise() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonExteriorNotClosed() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonInteriorOutsideExterior() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonInteriorsTouch() throws XMLStreamException, FactoryConfigurationError, IOException,
			XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validateInvalidPolygonInteriorsIntersect() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonInteriorTouchesExterior() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
		...
		Assert.assertTrue(validator.validateGeometry(geom));
		Assert.assertEquals(4, eventHandler.getEvents().size());
		InteriorRingIntersectsExterior intersectionEvent = (InteriorRingIntersectsExterior) eventHandler.getEvents()
			.get(3);
		Assert.assertTrue(intersectionEvent.isSinglePoint());
	}

	@Test
	public void validatePolygonInteriorIntersectsExterior() throws XMLStreamException, FactoryConfigurationError,
			IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
	...
	@Test
	public void validatePolygonInteriorIntersectsExteriorSinglePointOnly() throws XMLStreamException,
	...
	@Test
	public void validatePolygonInteriorIntersectsExteriorTwoPoints() throws XMLStreamException,
			FactoryConfigurationError, IOException, XMLParsingException, UnknownCRSException {
		DummyValidationEventHandler eventHandler = new DummyValidationEventHandler();
		GeometryValidator validator = new GeometryValidator(eventHandler);
