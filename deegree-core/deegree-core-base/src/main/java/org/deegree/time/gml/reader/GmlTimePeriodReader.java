...
public class GmlTimePeriodReader extends AbstractGmlTimeGeometricPrimitiveReader {
     ...
     */
    public TimePeriod read( final XMLStreamReader xmlStream )
                            throws XMLStreamException {
    ...
    private void skipDurationIfPresent( final XMLStreamReader xmlStream )
                            throws XMLStreamException {
    ...
    private void skipTimeIntervalIfPresent( final XMLStreamReader xmlStream )
                            throws XMLStreamException {
