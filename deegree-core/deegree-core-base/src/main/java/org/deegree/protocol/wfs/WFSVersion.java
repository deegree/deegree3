...
/**
 * Enum type for discriminating between the different versions of the <a
 * href="http://www.opengeospatial.org/standards/wfs">OpenGIS Web Feature Service (WFS) Implementation
 * Specification</a>.
 * 
...
public enum WFSVersion {
     ...
     * 
     * @param ogcVersion
     *            version, must not be <code>null</code>
     * @return corresponding constant, never <code>null</code>
     * @throws IllegalArgumentException
     *             if the version is not a known/supported WFS version
     */
     ...
     * 
     * @param ns
     *            XML namespace, must not be <code>null</code>
     * @return corresponding constants, never <code>null</code> and contains at least one entry
