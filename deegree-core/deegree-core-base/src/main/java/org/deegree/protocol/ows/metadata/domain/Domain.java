 ...
 * </p>
 * <p>
 * From OWS Common 2.0: <cite>Valid domain (or allowed set of values) of one quantity, with its name or
 * identifier.</cite>
 * </p>
 * 
...
public class Domain {
     ...
     *            possible values, may be <code>null</code>
     * @param defaultValue
     *            default value, may be <code>null</code>
     * @param meaning
     *            meaning, may be <code>null</code>
     * @param dataType
     *            data type, may be <code>null</code>
     * @param valuesUnitUom
     *            unit-of-measure identifier for the value, may be <code>null</code>
     * @param valuesUnitRefSys
     *            unit-of-measure reference system identifier, may be <code>null</code>
     * @param metadata
     *            additional metadata, may be <code>null</code>
     */
    public Domain( String name, PossibleValues possibleValues, String defaultValue, StringOrRef meaning,
                   StringOrRef dataType, StringOrRef valuesUnitUom, StringOrRef valuesUnitRefSys,
     ...
     * <p>
     * From OWS Common 2.0: <cite>The default value for a quantity for which multiple values are allowed.</cite>
     * </p>
     * 
     ...
     * Returns the meaning.
     * <p>
     * From OWS Common 2.0: <cite>Definition of the meaning or semantics of this set of values. This Meaning can provide
     * more specific, complete, precise, machine accessible, and machine understandable semantics about this quantity,
     * relative to other available semantic information. For example, other semantic information is often provided in
     * "documentation" elements in XML Schemas or "description" elements in GML objects.</cite>
     * </p>
     * 
     ...
     * <p>
     * From OWS Common 2.0: <cite>Definition of the data type of this set of values. In this case, the xlink:href
     * attribute can reference a URN for a well-known data type. For example, such a URN could be a data type
     * identification URN defined in the "ogc" URN namespace.</cite>
     * </p>
     * 
     ...
     * <p>
     * From OWS Common 2.0: <cite>Identifier of unit of measure of this set of values. Should be included then this set
     * of values has units (and not a more complete reference system).</cite>
     * </p>
     * 
     ...
     * <p>
     * From OWS Common 2.0: <cite>Identifier of reference system used by this set of values. Should be included then
     * this set of values has a reference system (not just units).</cite>
     * </p>
     * 
     ...
     * <p>
     * From OWS Common 2.0: <cite>Optional unordered list of other metadata about this quantity. A list of required and
     * optional other metadata elements for this quantity should be specified in the Implementation Specification for
     * this service.</cite>
     * </p>
     * <p>
