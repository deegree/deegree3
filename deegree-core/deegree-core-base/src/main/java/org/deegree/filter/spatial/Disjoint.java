...
/**
 * If a geometry spatially disjoins an other geometry.
 *
...
public class Disjoint extends SpatialOperator {
	 ...
	 */
	public Disjoint(Expression param1, Geometry param2) {
		super(param1, param2);
	}
	 ...
	 */
	public Disjoint(Expression param1, ValueReference param2) {
		super(param1, param2);
	}
