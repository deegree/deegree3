...
/**
 * If a geometry is spatially overlaps an other geometry.
 *
...
public class Overlaps extends SpatialOperator {
	 ...
	 */
	public Overlaps(Expression param1, Geometry param2) {
		super(param1, param2);
	}
	 ...
	 */
	public Overlaps(Expression param1, ValueReference param2) {
		super(param1, param2);
	}
