...
public class Filter200XMLEncoder {
    ...
    private static void export( IdFilter idFilter, XMLStreamWriter writer )
                            throws XMLStreamException {
    ...
    private static void export( Operator operator, XMLStreamWriter writer )
        ...
        case TEMPORAL:
            ...
            break;
        default:
            throw new IllegalArgumentException( "Encoding of operator type " + operator.getType()
    ...
    private static void export( LogicalOperator operator, XMLStreamWriter writer )
        ...
        case NOT:
            ...
            break;
        default:
            throw new IllegalArgumentException( "Encoding of logical operator subtype " + operator.getSubType()
                                                + " is not supported yet!" );
        }
    }
    ...
    private static void export( TemporalOperator operator, XMLStreamWriter writer )
        ...
        if ( elementName == null )
            throw new IllegalArgumentException( "Encoding of temporal operator subtype " + operator.getSubType()
                                                + " is not supported yet!" );
        writer.writeStartElement( elementName.getNamespaceURI(), elementName.getLocalPart() );
    ...
    private static void export( PropertyIsLessThanOrEqualTo operator, XMLStreamWriter writer )
                            throws XMLStreamException {
    ...
    private static void export( ValueReference propertyName, XMLStreamWriter writer )
                            throws XMLStreamException {
    ...
    private static void export( Literal<?> literal, XMLStreamWriter writer )
                            throws XMLStreamException {
    ...
    private static void export( Function function, XMLStreamWriter writer )
                            throws XMLStreamException {
