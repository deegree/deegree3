...
public class GeoJsonGeometryWriter {
     ...
     *
     * @param geometry
     *            geometry to export, never <code>null</code>
     * @throws IOException
    ...
    private void exportGeometry( Geometry geometryToExport )
                            throws IOException {
        ...
        case PRIMITIVE_GEOMETRY:
            GeometricPrimitive.PrimitiveType primitiveType = ( (GeometricPrimitive) geometryToExport ).getPrimitiveType();
            ...
            break;
        default:
            throw new IOException( "Could not export geometry " + geometryToExport.getGeometryType() + " as GeoJSON" );
        }
        jsonWriter.endObject();
    }

    private void exportCurve( Curve curve )
                            throws IOException {
    ...
    private void exportSurface( Surface surface )
                            throws IOException {
    ...
    private void exportMultiGeometry( MultiGeometry<? extends Geometry> multiGeometry )
                            throws IOException {
        ...
        case MULTI_SURFACE:
            ...
            break;
        default:
            throw new IOException( "Could not export multi geometry " + multiGeometry.getMultiGeometryType()
                                   + " as GeoJSON" );
        }
    }

    private void exportMultiPoint( MultiPoint multiPoint )
                            throws IOException {
    ...
    private void exportMultiLineString( MultiLineString multiLineString )
                            throws IOException {
    ...
    private void exportMultiPolygon( MultiPolygon multiPolygon )
                            throws IOException {
    ...
    private void exportMultiSurface( MultiSurface<Surface> multiSurface )
                            throws IOException {
    ...
    private void exportPoint( Point point )
                            throws IOException {
    ...
    private void exportLineString( LineString lineString )
                            throws IOException {
    ...
    private void exportPolygonRings( Polygon polygon )
                            throws IOException {
        jsonWriter.beginArray();
    ...
    private void exportPoints( Points points )
                            throws IOException {
        jsonWriter.beginArray();
    ...
    private void exportPointArray( Point point )
                            throws IOException {
        jsonWriter.beginArray();
