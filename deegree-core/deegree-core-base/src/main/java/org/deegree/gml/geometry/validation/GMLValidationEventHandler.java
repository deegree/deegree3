...
public interface GMLValidationEventHandler {
     ...
     * @param point
     *            duplicated point, never <code>null</code>
     ...
     *            list of affected GML elements (that the curve is a part of), never <code>null</code>
     ...
     *            invalid {@link Curve} geometry, never <code>null</code>
     * @param location
     *            the (approximative) location of the self-intersection, never <code>null</code>
     * @param affectedGeometryParticles
     *            list of affected geometry components (that the curve is a part of), never <code>null</code>
     * @param affectedElements
     *            list of affected GML elements (that the curve is a part of), never <code>null</code>
