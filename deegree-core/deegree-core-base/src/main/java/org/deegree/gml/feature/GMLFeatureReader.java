...
public class GMLFeatureReader extends AbstractGMLObjectReader {
    ...
    /**
     * Returns the object representation for the time slice element event that the cursor of the given
     * <code>XMLStreamReader</code> points at.
     *
     * @param xmlStream
     *            cursor must point at the <code>START_ELEMENT</code> event of the time slice element, afterwards points
     *            at the next event after the <code>END_ELEMENT</code> event of the time slice element
     * @param crs
     *            default CRS for all descendant geometry properties, can be <code>null</code>
    ...
    private Feature parseFeatureDynamic( XMLStreamReaderWrapper xmlStream, ICRS crs, DynamicAppSchema appSchema )
        ...
        Feature feature = ft.newFeature( fid, null, -1, props, null );
    ...
    private Feature parseFeatureStatic( XMLStreamReaderWrapper xmlStream, ICRS crs )
        ...
        feature = ft.newFeature( fid, null, -1, propertyList, extraProps );
