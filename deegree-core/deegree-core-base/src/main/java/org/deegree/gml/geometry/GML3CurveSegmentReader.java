...
/**
 * Handles the parsing of <code>gml:_CurveSegment</code> elements, i.e concrete element
 * declarations that are in the substitution group <code>gml:_CurveSegment</code>.
 * <p>
 * This class handles all 15 concrete substitutions for <code>gml:_CurveSegment</code>
...
class GML3CurveSegmentReader extends GML3GeometryBaseReader {
	...
	/**
	 * Returns the object representation for a <code>gml:_CurveSegment</code> element.
	 ...
	 * <code>END_ELEMENT</code> (&lt;/gml:_CurveSegment&gt;)</li>
	 * </ul>
	 * <p>
	 * This method handles all 15 concrete substitutions for
	 * <code>gml:_CurveSegment</code> that are defined in GML 3.1.1:
	 * <ul>
	 * <li><code>Arc</code></li>
	 * <li><code>ArcByBulge</code></li>
	 * <li><code>ArcByCenterPoint</code></li>
	 ...
	 * (&lt;gml:_CurveSegment&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_CurveSegment&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:_CurveSegment" has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Arc&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Arc&gt;)</li>
	 ...
	 * event (&lt;/gml:Arc&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CoordinateSystem for the geometry, this is propagated if
	 * no deeper <code>srsName</code> attribute is specified
	 * @return corresponding {@link Arc} object
	 * @throws XMLParsingException if a syntactical (or semantic) error is detected in the
	 * element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:ArcByBulge&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:ArcByBulge&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:ArcByBulge&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of an <code>&lt;gml:ArcByCenterPoint&gt;</code>
	 * element. Consumes all corresponding events from the associated
	 * <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:ArcByCenterPoint&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:ArcByCenterPoint&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of an <code>&lt;gml:ArcString&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:ArcString&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:ArcString&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of an <code>&lt;gml:ArcStringByBulge&gt;</code>
	 * element. Consumes all corresponding events from the associated
	 * <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 ...
	 * event (&lt;/gml:ArcString&gt;)</li>
	 * </ul>
	 * @param defaultCRS default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	private ArcStringByBulge parseArcStringByBulge(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		// The length of the bulge sequence is exactly 1 less than the length of the
		// control
		// point array, since a bulge is needed for each pair of adjacent points in the
		// control point array.
		...
		// The length of the normal sequence is exactly the same as for the bulge
		// sequence, 1 less than the control
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Bezier&gt;</code> element.
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:BSpline&gt;</code> element.
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:BSpline&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:BSpline&gt;)</li>
	 * </ul>
	 * @param defaultCRS default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Circle&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Circle&gt;)</li>
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:CircleByCenterPoint&gt;</code>
	 * element. Consumes all corresponding events from the associated
	 * <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 ...
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:CircleByCenterPoint&gt;)</li>
	 * </ul>
	 * @param defaultSrsName default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	 * @return corresponding {@link Circle} object
	 * @throws XMLParsingException if a syntactical (or semantic) error is detected in the
	 * element
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Clothoid&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Clothoid&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:Clothoid&gt;)</li>
	 * </ul>
	 * @param defaultSrsName default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of a (&lt;gml:AffinePlacement&gt;) element.
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:AffinePlacement&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:AffinePlacement&gt;)</li>
	 * </ul>
	...
	/**
	 * Returns the object representation of a (&lt;gml:CubicSpline&gt;) element. Consumes
	 * all corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:CubicSpline&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:CubicSpline&gt;)</li>
	 * </ul>
	 * @param defaultSrsName default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of a (&lt;gml:Geodesic&gt;) element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Geodesic&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:Geodesic&gt;)</li>
	 * </ul>
	 * @param defaultSrsName default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	private Geodesic parseGeodesic(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		// the #parseControlPoints(String) method is not used here, because the GML 3.1.1
		// schema defines a slightly
	...
	/**
	 * Returns the object representation of a (&lt;gml:GeodesicString&gt;) element.
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:GeodesicString&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:GeodesicString&gt;)</li>
	 * </ul>
	 * @param defaultSrsName default srs for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	 * @return corresponding {@link GeodesicString} object
	 ...
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:LineStringSegment&gt;)</li>
	 * </ul>
	 * @param xmlStream
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of an (&lt;gml:OffsetCurve&gt;) element. Consumes
	 * all corresponding events from the given <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:OffsetCurve&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:OffsetCurve&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	 ...
	 * </p>
	 * <p>
	 * Precondition: the current event must be the first <code>START_ELEMENT</code> of the
	 * choice. If this is not the case, an {@link XMLParsingException} is thrown.<br/>
	 * Postcondition: the current event is the first tag event after the last
	 * <code>END_ELEMENT</code> that belongs to the choice
	 * </p>
	 * @param xmlStream
	 * @param crs default CRS for the points, this is used if no <code>srsName</code>
