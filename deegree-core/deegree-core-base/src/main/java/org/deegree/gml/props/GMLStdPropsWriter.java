...
/**
 * Stream-based writer for the {@link GMLStdProps} that can occur at the beginning of
...
public class GMLStdPropsWriter {
	 ...
	 * @param props properties to be exported, must not be <code>null</code>
	 * @throws XMLStreamException
	 */
	public void write(GMLStdProps props) throws XMLStreamException {
		switch (version) {
			case GML_2:
				writeGML2(props);
				break;
