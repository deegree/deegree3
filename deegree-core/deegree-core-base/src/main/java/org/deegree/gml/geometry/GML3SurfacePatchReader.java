...
/**
 * Handles the parsing of <code>gml:_SurfacePatch</code> elements, i.e concrete element
 * declarations that are in the substitution group of <code>gml:_SurfacePatch</code>.
 * <p>
 * This class handles all 6 concrete substitutions for <code>gml:_SurfacePatch</code> that
 * are defined in GML 3.1.1:
 * <ul>
...
class GML3SurfacePatchReader extends GML3GeometryBaseReader {
	...
	/**
	 * Returns the object representation for a <code>gml:_SurfacePatch</code> element.
	 ...
	 * (&lt;gml:_SurfacePatch&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_SurfacePatch&gt;)</li>
	 * </ul>
	 * <p>
	 * This method handles all 6 concrete substitutions for <code>gml:_SurfacePatch</code>
	 ...
	 * "gml:_SurfacePatch" has no <code>srsName</code> attribute
	 ...
	 * the "gml:Cone" has no <code>srsName</code> attribute
	...
	private Cone parseCone(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		xmlStream.getElementTextAsPositiveInteger(); // redundant; one can determine it
														// from the grid
	 ...
	 * (&lt;gml:Cylidner&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:Cylinder&gt;)</li>
	 * </ul>
	 * <p>
	 * @param xmlStream
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:Cylinder" has no <code>srsName</code> attribute
	 ...
	 * @param xmlStream
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:Sphere" has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:PolygonPatch&gt;</code>
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Rectangle&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Rectangle&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:Rectangle&gt;)</li>
	 * </ul>
	 * @param defaultCRS default CRS for the geometry, this is propagated if no deeper
	 * <code>srsName</code> attribute is specified
	...
	/**
	 * Returns the object representation of a <code>&lt;gml:Triangle&gt;</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Triangle&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:Triangle&gt;)</li>
	 * </ul>
