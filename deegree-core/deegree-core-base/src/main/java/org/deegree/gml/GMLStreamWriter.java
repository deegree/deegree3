...
public class GMLStreamWriter {
	 ...
	 * @return CRS used for writing geometries, can be <code>null</code> (keeps the
	 * original CRS of the geometries)
	 */
	 ...
	 * @param crs crs to be used for the geometries, can be <code>null</code> (keeps the
	 * original CRS)
	 */
	...
	/**
	 * Controls the format (e.g. number of decimal places) for written geometry
	 * coordinates.
	 * @param formatter formatter to use, may be <code>null</code> (use default
	 * formatting)
	 */
	...
	/**
	 * Returns the namespace bindings that are used whenever a qualified element or
	 * attribute is written (and no namespace prefix has been bound for the namespace on
	 * the stream already).
	...
	/**
	 * Controls the namespace bindings that are used whenever a qualified element or
	 * attribute is written (and no namespace prefix has been bound for the namespace on
	 * the stream already).
	 * @param prefixToNs keys: prefix, value: namespace, may be <code>null</code>
	 */
	 ...
	 * @param projections projections, or <code>null</code> (include all feature
	 * properties)
	 */
	 ...
	 * @param strategy handler, must not be <code>null</code>
	 */
	...
	/**
	 * Controls whether {@link ExtraProps} associated with feature objects should be
	 * generated as property elements.
	 * @param exportExtraProps <code>true</code>, if extra props should be calculated,
	...
	/**
	 * Returns whether <code>gml:boundedBy</code> properties should be generated for
	 * written {@link Feature} instances.
	 * @return <code>true</code>, if <code>gml:boundedBy</code> shall be calculated,
	 * <code>false</code> otherwise
	 */
	...
	/**
	 * Controls whether <code>gml:boundedBy</code> properties should be generated for
	 * written {@link Feature} instances.
	 * @param exportBoundedBy <code>true</code>, if <code>gml:boundedBy</code> should be
	 ...
	 * <p>
	 * NOTE: Simplification is performed before coordinate transformation, so constraints
	 * have to be expressed in the native CRS of the geometries.
	 * </p>
	 * @param simplifier simplifier to use, can be <code>null</code> (no simplification
	 * performed)
	 */
	...
	/**
	 * Returns the {@link SFSProfiler} that is be applied to exported {@link Geometry}
	 * instances.
	 * <p>
	 * NOTE: Simplification is performed before coordinate transformation, so constraints
	 * have to be expressed in the native CRS of the geometries.
	 ...
	 * @param object object to be written, must not be <code>null</code>
	 * @throws XMLStreamException
	 ...
	 * @param feature feature to be written, must not be <code>null</code>
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws TransformationException
	 */
	 ...
	 * @param geometry geometry to be written, must not be <code>null</code>
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws TransformationException
	 */
	 ...
	 * @param definition object to be written, must not be <code>null</code>
	 * @throws XMLStreamException
	 */
