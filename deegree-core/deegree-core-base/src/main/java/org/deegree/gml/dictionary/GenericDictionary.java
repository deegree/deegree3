...
public class GenericDictionary extends GenericDefinition implements Dictionary {
	 ...
	 * @param id id of the dictionary, can be <code>null</code>
	 * @param gmlProps GML standard properties (which contain description and names), must
	 * not be <code>null</code>
	 * @param members dictionary entries, must not be <code>null</code>
	 * @param isDefinitionCollection true, if this is a defininition collection, false
	 * otherwise
	 */
	public GenericDictionary(String id, GMLStdProps gmlProps, List<Definition> members,
