...
public class GMLStdPropsImpl implements GMLStdProps {
	...
	static {
		...
		PT_DESCRIPTION_REFERENCE_GML32 = new StringOrRefPropertyType(new QName(GML3_2_NS, "descriptionReference"), 0, 1,
				null, null);
	...
	/**
	 * Creates a new {@link GMLStdPropsImpl} instance.
	 * @param metadata metadata values, may be <code>null</code>
	 * @param description description, may be <code>null</code>
	 * @param identifier identifier, may be <code>null</code>
	 * @param names names, may be <code>null</code>
	 */
	public GMLStdPropsImpl(TypedObjectNode[] metadata, StringOrRef description, CodeType identifier, CodeType[] names) {
		if (metadata == null) {
