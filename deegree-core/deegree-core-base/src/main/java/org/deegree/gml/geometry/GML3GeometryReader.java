...
/**
 * Parser for geometry and geometry-related constructs from the GML 3 specification series
 * (3.0/3.1/3.2).
 * <p>
 ...
 * </p>
 * <p>
 * Additionally, parsing of <code>Envelope</code> elements is supported,
 * {@link #parseEnvelope(XMLStreamReaderWrapper)} and
 * {@link #parseGeometryOrEnvelope(XMLStreamReaderWrapper)}.
 * </p>
 * <p>
 * TODO Currently unsupported are the elements from the <code>_ImplicitGeometry</code>
 * substitution group, i.e. <code>Grid</code> and <code>RectifiedGrid</code>).
 * </p>
 *
...
public class GML3GeometryReader extends GML3GeometryBaseReader implements GMLGeometryReader {
	...
	/**
	 * Returns whether the given element name denotes a GML 3.1.1 geometry element (a
	...
	/**
	 * Returns whether the given element name denotes a GML 3.1.1 geometry (a concrete
	 * element substitutable for "gml:_Geometry") or envelope element.
	 * @param elName qualified element name to check
	 * @return true, if the element is a GML 3.1.1 geometry or a GML 3.1.1 envelope
	...
	/**
	 * Returns the object representation for the given <code>gml:_Geometry</code> element
	 ...
	 * (&lt;gml:_Geometry&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Geometry&gt;) afterwards
	 * @return corresponding {@link Geometry} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Geometry" element
	 ...
	 * <li><code>_ImplicitGeometry</code></li>
	 * </ul>
	 * @param xmlStream cursor must point at the <code>jec</code> event
	 * (&lt;gml:_Geometry&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Geometry&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Geometry} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Geometry" element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 ...
	 * <code>gml:_Geometry/gml:Envelope</code> element event that the cursor of the
	 * associated <code>XMLStreamReader</code> points at.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Geometry&gt; or &lt;gml:Envelope&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_Geometry&gt; or &lt;gml:Envelope&gt;)</li>
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Geometry&gt; or &lt;gml:Envelope&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:_Geometry&gt; or &lt;gml:Envelope&gt;)
	 * afterwards
	 * @return corresponding {@link Geometry} object
	 * @throws XMLParsingException if the element is not a valid
	 * <code>gml:_Geometry</code> or <code>gml:Envelope</code> element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation for the given
	 * <code>gml:_GeometricPrimitive</code> element event that the cursor of the
	 * associated <code>XMLStreamReader</code> points at.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_GeometricPrimitive&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_GeometricPrimitive&gt;)</li>
	 * </ul>
	 * <p>
	 * GML 3.1.1 specifies the following elements to be <b>directly</b> substitutable for
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_GeometricPrimitive&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:_GeometricPrimitive&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link GeometricPrimitive} object
	 * @throws XMLParsingException if the element is not a valid
	 * <code>gml:_GeometricPrimitive</code> element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation for the given
	 * <code>gml:_GeometricAggregate</code> element event that the cursor of the given
	 * <code>XMLStreamReader</code> points at.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_GeometricAggregate&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_GeometricAggregate&gt;)</li>
	 * </ul>
	 * <p>
	 * GML 3.1.1 specifies the following concrete elements to be substitutable for
	 * <code>gml:_GeometricAggregate</code>:
	 * <ul>
	 * <li><code>MultiCurve</code></li>
	 * <li><code>MultiGeometry</code></li>
	 * <li><code>MultiLineString</code></li>
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_GeometricAggregate&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:_GeometricAggregate&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link MultiGeometry} object
	 * @throws XMLParsingException if the element is not a valid "gml:_GeometricAggregate"
	 * element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation for the given <code>gml:_Geometry</code> event
	 * that represents a geometric complex (either <code>gml:CompositeCurve</code>,
	 * <code>gml:CompositeSolid</code>, <code>gml:CompositeSurface</code> or
	 * <code>gml:GeometricComplex</code>), that the cursor of the given
	 * <code>XMLStreamReader</code> points at.
	 * <p>
	 * <ul>
	 ...
	 * </ul>
	 * <p>
	 * GML 3.1.1 specifies the following four concrete geometry elements with an geometry
	 * complex semantic</code>:
	 * <ul>
	 * <li><code>CompositeCurve</code></li>
	 * <li><code>CompositeSolid</code></li>
	 * <li><code>CompositeSurface</code></li>
	 ...
	 * </ul>
	 * <p>
	 * NOTE: For technical reasons (XML Schema does not support multiple inheritance),
	 * there is no substitution group <code>gml:_GeometricComplex</code> defined in the
	 * GML schemas. However, it is described in the comments.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default crs for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Geometry} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Geometry" element
	 * with geometric complex semantic
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation for the given <code>gml:_ImplicitGeometry</code>
	 * element event that the cursor of the associated <code>XMLStreamReader</code> points
	 * at.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_ImplicitGeometry&gt;)</li>
	 * <li>Postcondition: cursor points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:_GeometricAggregate&gt;)</li>
	 * </ul>
	 * <p>
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_ImplicitGeometry&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:_ImplicitGeometry&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Geometry} object
	 * @throws XMLParsingException if the element is not a valid "gml:_ImplicitGeometry"
	 * element
	 * @throws XMLStreamException
	 */
	...
	/**
	 * Returns the object representation for the given <code>gml:_Curve</code> element
	 * event that the cursor of the associated <code>XMLStreamReader</code> points at.
	 * <p>
	 * GML 3.1.1 specifies the following elements to be substitutable for
	 * <code>gml:_Curve</code>:
	 * <ul>
	 * <li><code>CompositeCurve</code></li>
	 * <li><code>Curve</code></li>
	 * <li><code>LineString</code></li>
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Curve&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Curve&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Curve} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Curve" element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a (&lt;gml:_Ring&gt;) element. Consumes all
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Ring&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Ring&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Ring} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Ring" element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a (&lt;gml:_Surface&gt;) element. Consumes all
	 * corresponding events from the associated <code>XMLStream</code>.
	 * <p>
	 * GML 3.1.1 specifies the following seven elements to be substitutable for
	 * <code>gml:_Surface</code>:
	 * <ul>
	 * <li><code>Polygon</code></li>
	 * <li><code>CompositeSurface</code></li>
	 * <li><code>OrientableSurface</code></li>
	 ...
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Surface&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Surface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only use CoordinateSystem
	 * the geometry element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Surface} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Surface" element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a <code>gml:_Solid</code> element. Consumes
	 * all corresponding events from the associated <code>XMLStream</code>.
	 * <p>
	 * GML 3.1.1 specifies the following two elements to be substitutable for
	 * <code>gml:_Solid</code> elements:
	 * <ul>
	 * <li><code>CompositeSolid</code></li>
	 * <li><code>Solid</code></li>
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:_Solid&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:_Solid&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the geometry
	 * element has no own <code>srsName</code> attribute
	 * @return corresponding {@link Solid} object
	 * @throws XMLParsingException if the element is not a valid "gml:_Solid" element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a (&lt;gml:Point&gt;) element. Consumes all
	 * corresponding events from the associated <code>XMLStream</code>.
	 * <ul>
	 * <li>Precondition: cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Point&gt;)</li>
	 * <li>Postcondition: cursor points at the next event after the
	 * <code>END_ELEMENT</code> (&lt;/gml:Point&gt;)</li>
	 * </ul>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Point&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Point&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the "gml:Point" has
	 * no <code>srsName</code> attribute
	 * @return corresponding {@link Point} object
	 * @throws XMLParsingException if the element is not a valid <code>gml:Point</code>
	 * element
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 */
	...
	/**
	 * Returns the object representation of a <code>gml:LineString</code> element.
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:LineString&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:LineString&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:LineString</code> has no <code>srsName</code> attribute
			...
			if ("posList".equals(name)) {
				...
				do {
					if ("pos".equals(name)) {
						...
						// pointRep has been deprecated since GML 3.1.0, only included for
						// backward compatibility
						points.add(parsePointProperty(xmlStream, crs));
					}
					else if ("coord".equals(name)) {
						// deprecated since GML 3.0, only included for backward
						// compatibility
						double[] coords = parseCoordType(xmlStream);
						// anonymous point (no registering necessary)
						points.add(geomFac.createPoint(null, coords, crs));
	...
	/**
	 * Returns the object representation of a <code>gml:Curve</code> element. Consumes all
	 * corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Curve&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Curve&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:Curve</code> has no <code>srsName</code> attribute
	 * @return corresponding {@link Curve} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of a <code>gml:OrientableCurve</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:OrientableCurve&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:OrientableCurve&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:OrientableCurve</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:LinearRing</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:LinearRing&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:LinearRing&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:LinearRing</code> element has no <code>srsName</code> attribute
	 * @return corresponding {@link Ring} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of a <code>gml:Ring</code> element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Ring&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Ring&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:Ring</code> element has no <code>srsName</code> attribute
	 * @return corresponding {@link Ring} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of a (&lt;gml:Polygon&gt;) element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Polygon&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Polygon&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:Polygon" has no <code>srsName</code> attribute
	...
	public Polygon parsePolygon(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		// NOTE: No need to check for xlink:href in the properties
		// (AbstractRingPropertyType does not allow this).
		// 0 or 1 exterior/outerBoundaryIs element (yes, 0 is possible -- see section
		// 9.2.2.5 of GML spec)
		if (xmlStream.getEventType() == START_ELEMENT) {
	...
	/**
	 * Returns the object representation of a (&lt;gml:Surface&gt;) element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Surface&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Surface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:Surface" has no <code>srsName</code> attribute
	 * @return corresponding {@link Surface} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	 ...
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:PolyhedralSurface&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:PolyhedralSurface&gt;) afterwards
	 * @param defaultCRS default CoordinateSystem for the geometry, this is only used if
	 * the "gml:PolyhedralSurface" has no <code>srsName</code> attribute
	 ...
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:TriangulatedSurface&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:TriangulatedSurface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:TriangulatedSurface" has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a (&lt;gml:Tin&gt;) element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * Note: GML 3.1.1 specifies both "gml:trianglePatches" and "gml:controlPoint"
	 * properties for "gml:Tin". This is apparently redundant, and consequently (?) GML
	 * 3.2.1 only allows the controlPoint property here. This method copes with this by
	 * only using the controlPoints for building the {@link Tin} object.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Tin&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Tin&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the "gml:Tin"
	 * has no <code>srsName</code> attribute
	...
	public Tin parseTin(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		xmlStream.require(START_ELEMENT, gmlNs, "trianglePatches");
		while (xmlStream.nextTag() == START_ELEMENT) {
			// validate syntactically, but ignore the content for instantiating the
			// geometry
			memberPatches.add(surfacePatchParser.parseTriangle(xmlStream, crs));
		}
		xmlStream.require(END_ELEMENT, gmlNs, "trianglePatches");
	...
	/**
	 * Returns the object representation of a <code>gml:OrientableSurface</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:OrientableSurface&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:OrientableSurface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:OrientableSurface</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a (&lt;gml:Solid&gt;) element. Consumes all
	 * corresponding events from the given <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Solid&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Solid&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * "gml:Solid" has no <code>srsName</code> attribute
	 * @return corresponding {@link Solid} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of a <code>gml:CompositeCurve</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:CompositeCurve&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:CompositeCurve&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:CompositeCurve</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:CompositeSurface</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:CompositeSurface&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:CompositeSurface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:CompositeSurface</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:CompositeSolid</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:CompositeSolid&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:CompositeSolid&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:CompositeSolid</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:GeometricComplex</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:GeometricComplex&gt;), points at the corresponding
	 * <code>END_ELEMENT</code> event (&lt;/gml:GeometricComplex&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:GeometricComplex</code> has no <code>srsName</code> attribute
	...
	public CompositeGeometry<GeometricPrimitive> parseGeometricComplex(XMLStreamReaderWrapper xmlStream,
			ICRS defaultCRS) throws XMLStreamException, XMLParsingException, UnknownCRSException {
	...
	/**
	 * Returns the object representation of a <code>gml:MultiPoint</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiPoint&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiPoint&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiPoint</code> has no <code>srsName</code> attribute
		...
		if (xmlStream.isStartElement()) {
			do {
				...
				if (localName.equals("pointMember")) {
					...
					// pointMembers may only occur once (and behind all pointMember)
					// elements
					xmlStream.nextTag();
					break;
				}
	...
	/**
	 * Returns the object representation of a <code>gml:MultiCurve</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiCurve&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiCurve&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiCurve</code> has no <code>srsName</code> attribute
		...
		if (xmlStream.isStartElement()) {
			do {
				...
				if (localName.equals("curveMember")) {
					...
					// curveMembers may only occur once (and behind all curveMember)
					// elements
					xmlStream.nextTag();
					break;
				}
	...
	/**
	 * Returns the object representation of a <code>gml:MultiLineString</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiLineString&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiLineString&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiLineString</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:MultiSurface</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiSurface&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiSurface&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiSurface</code> has no <code>srsName</code> attribute
		...
		if (xmlStream.isStartElement()) {
			do {
				...
				if (localName.equals("surfaceMember")) {
					...
					// surfaceMembers may only occur once (and behind all surfaceMember)
					// elements
					xmlStream.nextTag();
					break;
				}
	...
	/**
	 * Returns the object representation of a <code>gml:MultiPolygon</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiPolygon&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiPolygon&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiPolygon</code> has no <code>srsName</code> attribute
	...
	/**
	 * Returns the object representation of a <code>gml:MultiSolid</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiSolid&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiSolid&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiSolid</code> has no <code>srsName</code> attribute
		...
		if (xmlStream.isStartElement()) {
			do {
				...
				if (localName.equals("solidMember")) {
					...
					// solidMembers may only occur once (and behind all surfaceMember)
					// elements
					xmlStream.nextTag();
					break;
				}
	...
	/**
	 * Returns the object representation of a <code>gml:MultiGeometry</code> element.
	 * Consumes all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:MultiGeometry&gt;), points at the corresponding <code>END_ELEMENT</code>
	 * event (&lt;/gml:MultiGeometry&gt;) afterwards
	 * @param defaultCRS default CRS for the geometry, this is only used if the
	 * <code>gml:MultiGeometry</code> has no <code>srsName</code> attribute
	 * @return corresponding {@link MultiGeometry} object
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
		...
		if (xmlStream.isStartElement()) {
			do {
				...
				if (localName.equals("geometryMember")) {
					...
					// geometryMembers may only occur once (and behind all surfaceMember)
					// elements
					xmlStream.nextTag();
					break;
				}
	...
	/**
	 * Returns the object representation of a <code>gml:Envelope</code> element. Consumes
	 * all corresponding events from the associated <code>XMLStream</code>.
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event
	 * (&lt;gml:Envelope&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Envelope&gt;) afterwards
	 * @return corresponding {@link Envelope} object
	 * @throws XMLStreamException
	 * @throws XMLParsingException
	 */
	public Envelope parseEnvelope(XMLStreamReaderWrapper xmlStream) throws XMLParsingException, XMLStreamException {
	 ...
	 * (&lt;gml:Envelope&gt;), points at the corresponding <code>END_ELEMENT</code> event
	 * (&lt;/gml:Envelope&gt;) afterwards
	 * @param defaultCRS default CRS for the envelope, this is only used if the
	 * <code>gml:Envelope</code> has no <code>srsName</code> attribute itself
	 * @return corresponding {@link Envelope} object
	 * @throws XMLStreamException
	 * @throws XMLParsingException
	 */
	...
	public Envelope parseEnvelope(XMLStreamReaderWrapper xmlStream, ICRS defaultCRS)
		...
		// must contain exactly one of the following child elements: "gml:lowerCorner",
		// "gml:coord", "gml:pos" or
		// "gml:coordinates"
		if (xmlStream.nextTag() == XMLStreamConstants.START_ELEMENT) {
			String name = xmlStream.getLocalName();
			if ("lowerCorner".equals(name)) {
				...
				// NOTE PLEASE: some envelopes only have the srsName on the pos, not on
				// the envelope
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:PointPropertyType</code> (such as <code>gml:pointProperty</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The point value may be specified using an inline <code>gml:Point</code> element or
	 * using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link PointReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:Point" has no <code>srsName</code> attribute
	 * @return corresponding {@link Point} object, this is a {@link PointReference} if the
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:LineStringPropertyType</code> (such as
	 * <code>gml:lineStringProperty</code>). Consumes all corresponding events from the
	 * given <code>XMLStream</code>.
	 * <p>
	 * The LineString value may be specified using an inline <code>gml:LineString</code>
	 * element or using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link LineStringReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:LineString" has no <code>srsName</code> attribute
	 * @return corresponding {@link LineString} object, this is a
	 * {@link LineStringReference} if the content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	 */
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:CurvePropertyType</code> (such as <code>gml:curveProperty</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The curve value may be specified using an inline <code>gml:_Curve</code> element or
	 * using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link CurveReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:_Curve" has no <code>srsName</code> attribute
	 * @return corresponding {@link Curve} object, this is a {@link CurveReference} if the
	 * content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:PolygonPropertyType</code> (such as <code>gml:polygonProperty</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The polygon value may be specified using an inline <code>gml:Polygon</code> element
	 * or using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link PolygonReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:Polygon" has no <code>srsName</code> attribute
	 * @return corresponding {@link Polygon} object, this is a {@link PolygonReference} if
	 * the content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	 */
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:SurfacePropertyType</code> (such as <code>gml:surfaceProperty</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The curve value may be specified using an inline <code>gml:_Surface</code> element
	 * or using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link SurfaceReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:_Surface" has no <code>srsName</code> attribute
	 * @return corresponding {@link Surface} object, this is a {@link SurfaceReference} if
	 * the content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:SolidPropertyType</code> (such as <code>gml:solidProperty</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The solid value may be specified using an inline <code>gml:Solid</code> element or
	 * using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link SolidReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:Solid" has no <code>srsName</code> attribute
	 * @return corresponding {@link Solid} object, this is a {@link SolidReference} if the
	 * content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:GeometricPrimitivePropertyType</code> (such as <code>gml:element</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The solid value may be specified using an inline
	 * <code>gml:_GeometricPrimitive</code> element or using an <code>xlink:href</code>
	 * attribute. In the latter case, a {@link GeometricPrimitiveReference} object is
	 * returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:_GeometricPrimitive" has no <code>srsName</code> attribute
	 * @return corresponding {@link GeometricPrimitive} object, this is a
	 * {@link GeometricPrimitiveReference} if the content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	 */
	...
	/**
	 * Returns the object representation of an element with type
	 * <code>gml:GeometryPropertyType</code> (such as <code>gml:geometryMember</code>).
	 * Consumes all corresponding events from the given <code>XMLStream</code>.
	 * <p>
	 * The geometry value may be specified using an inline <code>gml:_Geometry</code>
	 * element or using an <code>xlink:href</code> attribute. In the latter case, a
	 * {@link GeometryReference} object is returned.
	 * </p>
	 * @param xmlStream cursor must point at the <code>START_ELEMENT</code> event, points
	 * at the corresponding <code>END_ELEMENT</code> event afterwards
	 * @param defaultCRS default CRS for the geometry, this is used if the contained
	 * "gml:_Geometry" has no <code>srsName</code> attribute
	 * @return corresponding {@link Geometry} object, this is a {@link GeometryReference}
	 * if the content is specified using xlink
	 * @throws XMLStreamException
	 * @throws UnknownCRSException
	 * @throws XMLParsingException
	 */
	...
	/**
	 * Parses the geometry id attribute from the geometry <code>START_ELEMENT</code> event
	 * that the given <code>XMLStreamReader</code> points to.
	 * <p>
	 * Looks after 'gml:id' (GML 3) first, if no such attribute is present, the 'gid' (GML
	 * 2) attribute is used.
	 * @return the geometry id, or "" (empty string) if neither a 'gml:id' nor a 'gid'
	...
	private String parseGeometryId(XMLStreamReaderWrapper xmlStream) {
		...
		// contain
		// a separating colon (onGMLly at the first position a colon is allowed) and must
		// not
		// start with a digit.
