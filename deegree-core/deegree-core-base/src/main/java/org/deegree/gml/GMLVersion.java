...
public enum GMLVersion {
	...
	/**
	 * This method creates a {@link GMLVersion} from the given mimetype. Expected is
	 * following format: <b>'some/type'; subtype=gml/x.y.z</b>. If the mime does not
	 * comply the defaultversion is returned. This method uses version negotiation, e.g.
	 * if the given version equals or is larger then a version the next possible gml
	 * version will be used, e.g. gml/3.2.0 will match to {@link GMLVersion#GML_32}
	 * (gml/3.2.1), gml/3.0.9 (none existing) will match to {@link GMLVersion#GML_31}.
	 * @param mimeType to be parsed
	 * @param defaultVersion to be used if the mime type is not compliant with above
	 * rules, may be <code>null</code>
