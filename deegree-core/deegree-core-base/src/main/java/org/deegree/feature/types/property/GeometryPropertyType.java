...
public class GeometryPropertyType extends ObjectPropertyType {
	...
	public enum GeometryType {
		...
		/**
		 * Get the geometry type from the given string, if the type could not be mapped, a
		 * {@link #GEOMETRY} will be returned.
		 * @param geomString to get the type for
	...
	/**
	 * @param name of the geometry property
	 * @param minOccurs
	 * @param maxOccurs
	 * @param isAbstract
	 * @param substitutions
	 * @param geomTypes allowed types for this geometry property (a choice declaration in
	 * the schema).
	 * @param dim
	 * @param representation
	 */
	public GeometryPropertyType(QName name, int minOccurs, int maxOccurs, XSElementDeclaration elDecl,
			List<PropertyType> substitutions, Set<GeometryType> geomTypes, CoordinateDimension dim,
			ValueRepresentation representation) {
		super(name, minOccurs, maxOccurs, elDecl, substitutions, representation, GEOMETRY);
	...
	/**
	 * @return the allowed geometries of this geometry property. If the property was
	 * defined as a 'choice' multiple types will be available.
	 */
	...
	/**
	 * @return true if this geometry property has multiple geometry declarations (was
	 * defined as a choice).
	 */
