 ...
 * Some notes:
 * <ul>
 * <li>Can be based on a {@link GMLSchemaInfoSet} or without it. If it is build from a GML schema, use
 * {@link #getGMLSchema()} to get access to the full XML schema infoset.</li>
