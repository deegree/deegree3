...
/**
 * Provides utility methods for common tasks that involve {@link Feature} and
 * {@link FeatureCollection} objects.
 *
...
public class Features {
	...
	/**
	 * Returns all members of the given {@link FeatureInputStream} as a
	 * {@link FeatureCollection}.
	 * <p>
	 * NOTE: This method should not be called for very large result sets, as it introduces
	 * the overhead of keeping all created feature instances in memory. The returned
	 * collection will contain all {@link Feature}s instances from the current position in
	 ...
	 * @param fc feature collection to be sorted, must not be <code>null</code>
	 * @param sortCrits sort criteria
								...
								if (value1 != null) {
									for (TypedObjectNode value2 : values2) {
										if (value2 != null) {
											...
											order = ((Comparable<Object>) comparablePair.first)
												.compareTo(comparablePair.second);
	 ...
	 * {@link TypedObjectNode} while trying to preserve primitive type information.
	 * @param value1
	 * @param value2
	 * @throws FilterEvaluationException
	 */
	private static Pair<Object, Object> getPrimitives(Object value1, Object value2) throws FilterEvaluationException {
	...
	/**
	 * Determines all {@link Feature} and {@link Geometry} objects contained in the given
	 * {@link TypedObjectNode} and their ids. Does <code>not</code> include internal
	 * referenced {@link Feature}s.
	 * @param node typed object node to be scanned, can be <code>null</code>
	 * @param geometries found geometry objects (not {@link Reference}s), must not be
	 * <code>null</code>
	 * @param features found feature objects (not {@link Reference}s), must not be
	 * <code>null</code>
	 * @param fids found feature ids, must not be <code>null</code>
	 * @param gids found geometry ids, must not be <code>null</code>
	 */
