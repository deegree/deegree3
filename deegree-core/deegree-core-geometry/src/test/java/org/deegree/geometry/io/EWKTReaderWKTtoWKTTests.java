...
public class EWKTReaderWKTtoWKTTests {
    ...
    public static Iterable<Object[]> data() {
        ...
        // CURVEPOLYGON ((144.84399355252685 -31.26123924022086,144.20551952601693 -32.27215644886158,145.55230712890625
        ...
        //
        // Multipoint with inner brackets cannot be distinguished by their syntax, since the brackets are not mapped in
        // the data model.
        ...
        tests.add( of( 14,
                       "CURVEPOLYGON (" + "CIRCULARSTRING (143.62025166838282 -30.03749735607682,142.92857147299705 -32.75101196874403,145.96132309891922 -34.98567106152878,149.57565307617188 -33.41153335571289,149.41972407584802 -29.82467268057351,146.12094160554670 -30.19711586270431,143.62025166838282 -30.03749735607682)," + "(144.84399355252685 -31.26123924022086,144.20551952601693 -32.27215644886158,145.55230712890625 -33.49203872680664,147.97080993652344 -32.03618621826172,146.38697244992585 -31.47406391572417,144.84399355252685 -31.26123924022086))" ) );
        tests.add( of( 1,
    ...
    @Test
    public void verifyWKT()
                            throws
                            Exception {
        Geometry geom = reader.read( wkt );
        assertNotNull( geom );
        StringWriter sw = new StringWriter();
        WKTWriter writer = new WKTWriter( EnumSet.of( WKTFlag.USE_SQL_MM ),
                                          new DecimalCoordinateFormatter( decimalPlaces ) );
