...
public class CurveLinearizerTest {
	...
	/**
	 * Tests if {@link CurveLinearizer#isClockwise(Point, Point, Point)} determines the
	 * correct point order.
	 */
	@Test
	...
	/**
	 * Tests if {@link CurveLinearizer#calcCircleCenter(Point, Point, Point)} finds the
	 * correct midpoint.
	 */
	@Test
	...
	/**
	 * Tests if interpolate(Point, Point, Point, int, boolean) produces sequences of
	...
	public void testLinearizeCircle() {
		...
		testLinearizationWithErrorCriterion(geomFac.createPoint(null, new double[] { 8, -1 }, null),
				geomFac.createPoint(null, new double[] { 3, 1.6 }, null),
				geomFac.createPoint(null, new double[] { -110, 16.77777 }, null), 0.0001, 1000);
	}

	/**
	 * Tests if
	 * {@link CurveLinearizer#linearizeCubicSpline(CubicSpline, LinearizationCriterion)}
	 * produces positions that coincide with the real values.
	 */
	@Test
	...
	/**
	 * Test the delta (distance between two adjacent points) the number of linearization
	 * points and the end and begin points
	 */
	@Test
	...
	private void testPoints(Points actual, String expected) throws ParseException {
	 ...
	 */
	@Test
	public void testVisualLinArcQDs34() throws ParseException {
	 ...
	 */
	@Test
	public void testVisualLinArcQDs12() throws ParseException {
		double[] p0 = new double[] { 1.7, 2.5 };
		double[] p1 = new double[] { 3, 0.5 };
		double[] p2 = new double[] { 2.3, -2.5 };
		Points positions = createLinearArc(p0, p1, p2, false);
	 ...
	 */
	@Test
	public void testVisualLinArcQDs14() throws ParseException {
		double[] p0 = new double[] { 1.7, 2.5 };
	 ...
	 */
	@Test
	public void testVisualLinArcQDs23() throws ParseException {
	 ...
	 */
	@Test
	public void testLinearizeArcFourQDs14() throws ParseException {
		double[] p0 = new double[] { 1.7, 2.5 };
		double[] p1 = new double[] { 3, 0.5 };
		double[] p2 = new double[] { -2.3, 2.5 };
		Points positions = createLinearArc(p0, p1, p2, false);
	 ...
	 */
	@Test
	public void visualizeCircle() throws ParseException {
		double[] p0 = new double[] { -1.7, 2.5 };
		double[] p1 = new double[] { -3, 0.5 };
		double[] p2 = new double[] { -2.3, -2.5 };
		Points positions = createLinearArc(p0, p1, p2, true);
