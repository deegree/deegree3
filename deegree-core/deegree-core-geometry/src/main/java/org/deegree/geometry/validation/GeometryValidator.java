 ...
 * </p>
 * <p>
 * <h2>Points</h2> No constraints, {@link Point} geometries are always topologically
 * valid.
 * </p>
 * <p>
 * <h2>Curves</h2>
 * <ul>
 * <li><code>CURVE_DISCONTINUITY</code>: The end point of a segment <code>n</code> does
 * not coincide with the start point of segment <code>n+1</code>.</li>
 * <li><code>CURVE_SELF_INTERSECTION</code>: Curve intersects itself.</li>
 * </ul>
 * </p>
 * <p>
 * <h2>Rings</h2> The above events are also generated for {@link Ring} geometries (as they
 * are a generally just closed {@link Curve} s). Additionally, the following events may
 * occur:
 * <ul>
 * <li><code>RING_NOT_CLOSED</code>: The end point does not coincide with the start
 * point.</li>
 ...
 * <ul>
 * <li><code>EXTERIOR_RING_CCW</code>: The control points of an exterior ring (i.e. the
 * shell) does not follow counter-clockwise order.</li>
 * <li><code>INTERIOR_RING_CW</code>: The control points of an interior ring (i.e. a hole)
 * of a {@link PolygonPatch} does not follow clockwise order.</li>
 ...
 * <li><code>EXTERIOR_RING_TOUCHES_INTERIOR</code>: An interior ring touches the
 * shell.</li>
 * <li><code>EXTERIOR_RING_INTERSECTS_INTERIOR</code>: An interior ring intersects the
 * shell.</li>
 * <li><code>EXTERIOR_RING_WITHIN_INTERIOR</code>: The exterior ring lies inside an
 * interior ring.</li>
 * </ul>
 * </p>
 * <p>
 * <h2>MultiGeometries</h2> Members are tested individually for the above events.
 * </p>
 *
...
public class GeometryValidator {
	 ...
	 * @param eventHandler callback handler for errors, must not be <code>null</code>
	 */
	 ...
	 * <p>
	 * Contained geometry objects and geometry particles are recursively checked (e.g. the
	 * members of a {@link MultiGeometry}) and callbacks to the associated
	 * {@link GeometryValidationEventHandler} are performed for each detected issue.
	 * @param geom geometry to be validated
