...
public interface Point extends GeometricPrimitive {
	 ...
	 * @return value of the second ordinate, or <code>Double.NAN</code> if the point only
	 * has one dimension
	 */
	public double get1();
	 ...
	 * @return value of the third ordinate, or <code>Double.NAN</code> if the point only
	 ...
	 * @param dimension ordinate to be returned (first dimension=0)
	 * @return ordinate value of the passed dimension, or <code>Double.NAN</code> if
	 * <code>dimension</code> is greater than the number of actual dimensions
	 */
