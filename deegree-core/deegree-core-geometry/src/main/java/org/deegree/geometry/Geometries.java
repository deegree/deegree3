...
public class Geometries {
	...
	/**
	 * Homogenizes the given generic {@link org.deegree.geometry.multi.MultiGeometry},
	 * i.e. returns a {@link org.deegree.geometry.multi.MultiPoint},
	 * {@link org.deegree.geometry.multi.MultiCurve},
	 * {@link org.deegree.geometry.multi.MultiLineString},
	 * {@link org.deegree.geometry.multi.MultiSurface},
	 * {@link org.deegree.geometry.multi.MultiPolygon} or
	 * {@link org.deegree.geometry.multi.MultiSolid} (depending on the members).
	 * @param geometry generic multi geometry to be homogenized, must not be
	 * <code>null</code>
		...
		switch (dim) {
			...
			case 1: {
				homogenized = new GeometryFactory().createMultiLineString(geometry.getId(),
						geometry.getCoordinateSystem(), (List<LineString>) deepMembers);
				break;
			}
			case 2: {
	...
	/**
	 * Returns a corresponding {@link GeometricPrimitive} object for the given
	 * {@link Envelope}.
	 * <p>
	 ...
	 * </ul>
	 * </p>
	 * @param env envelope, must not be <code>null</code>
