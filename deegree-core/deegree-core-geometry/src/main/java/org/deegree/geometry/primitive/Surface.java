...
/**
 * <code>Surface</code> instances are 2D-geometries that consist of an arbitrary number of
...
public interface Surface extends GeometricPrimitive {
	...
	public enum SurfaceType {
		...
		/**
		 * Generic surface that consists of an arbitrary number of surface patches which
		...
		TriangulatedSurface,
		/**
		 * Surface that consists of {@link Triangle}s only (which meet the Delaunay
		 * criterion).
		 */
		Tin,
	...
	/**
	 * Convenience method for accessing the control points of the exterior ring of a
	 * simple polygon surface.
	 * <p>
	 * NOTE: This method is only safe to use when the surface consists of a single planar
	 * patch that has a linear interpolated exterior ring.
	 * </p>
	 * @return the control points
	 * @throws IllegalArgumentException if the surface has more than one patch, the patch
	 * is not planar or the exterior boundary is not completely described by linear
	 * interpolated segments
	 */
	public Points getExteriorRingCoordinates();

	/**
	 * Convenience method for accessing the control points of the interior rings of a
	 * simple polygon surface.
	 * <p>
	 * NOTE: This method is only safe to use when the surface consists of a single planar
	 * patch that has linear interpolated interior rings.
	 * </p>
	 * @return the control points
	 * @throws IllegalArgumentException if the surface has more than one patch, the patch
	 * is not planar or the interior boundaries are not completely described by linear
	 * interpolated segments
	 */
