...
public interface Envelope extends Geometry {
	...
	/**
	 * Returns the envelope's span of the first dimension (in units of the associated
	 * coordinate system).
	...
	/**
	 * Returns the envelope's span of the second dimension (in units of the associated
	 * coordinate system).
	...
	/**
	 * Returns the envelope's span of the specified dimension (in units of the associated
	 * coordinate system).
	 * @param dim index of the span to be returned
