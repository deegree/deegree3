...
/**
 * Provides methods for the linearization of planar surfaces, i.e. {@link PolygonPatch}es
 * and {@link Polygon}s.
 *
...
public class SurfaceLinearizer {
	...
	/**
	 * Returns a linearized version of the given {@link Surface} geometry, i.e. the
	 * patches only use linear interpolated curves as boundaries.
	 * <p>
	 * NOTE: This method respects the semantic difference between {@link Surface} and
	 * {@link Polygon} geometries: if the input is a {@link Polygon}, a polygon geometry
	 * will be returned.
	 * @param <T> subtype of Surface
	 * @param surface
	 * @param crit
	...
	/**
	 * Returns a linearized version (i.e. a {@link PolygonPatch} that only uses
	 * {@link LinearRing}s as boundaries) of the given {@link PolygonPatch}.
	 * @param patch
