...
public class DefaultEnvelope extends AbstractDefaultGeometry implements Envelope {
	...
	/**
	 * Creates a new <code>DefaultEnvelope</code> instance with no id, crs and
	 * precisionmodel.
	 * @param min
	 * @param max
	 */
	...
	protected org.locationtech.jts.geom.Polygon buildJTSGeometry() {
		Points points = new PackedPoints(crs, new double[] { min.get0(), min.get1(), max.get0(), min.get1(), max.get0(),
	...
	public boolean intersects(Geometry other) {
		...
		return pointInside(minX1, minY1, e) || pointInside(minX1, maxY1, e) || pointInside(maxX1, minY1, e)
				|| pointInside(maxX1, maxY1, e) || pointInside(minX2, minY2, this) || pointInside(minX2, maxY2, this)
				|| pointInside(maxX2, minY2, this) || pointInside(maxX2, maxY2, this) || noEdgeOverlap(e, this)
