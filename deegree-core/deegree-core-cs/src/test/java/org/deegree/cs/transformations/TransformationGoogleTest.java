...
public class TransformationGoogleTest extends TransformationAccuracy {
    ...
    @Ignore
    @Test
    public void test31466To900913ForwardAndInverse()
    ...
    @Test
    public void test4326ToGoogleGeographic()
                            throws TransformationException, UnknownCRSException {
        ICRS srcCrs = CRSManager.lookup( "epsg:4326" );
    ...
    @Test
    public void testGoogleGeographicTo900913()
                            throws TransformationException, UnknownCRSException {
