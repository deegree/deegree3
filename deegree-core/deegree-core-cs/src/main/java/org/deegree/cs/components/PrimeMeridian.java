...
public class PrimeMeridian extends CRSIdentifiable implements IPrimeMeridian {
	 ...
	 */
	public static final PrimeMeridian GREENWICH = new PrimeMeridian(Unit.DEGREE, 0,
			new CRSCodeType[] { new CRSCodeType("8901", "epsg"),
					new CRSCodeType("http://www.opengis.net/gml/srs/epsg.xml#8901"),
					new CRSCodeType("urn:opengis:def:crs:epsg::8901"), new CRSCodeType("urn:ogc:def:crs:epsg::8901") },
			new String[] { "Greenwich" }, new String[] { "1995-06-02" }, null, null);

	/**
	 * @param units Angular units of longitude, normally radians.
	 * @param longitude (in given units) normally radians.
	 * @param id to be cloned
	 */
	...
	/**
	 * @param units Angular units of longitude.
	 * @param longitude
	 * @param code
	 * @param name
	 * @param version
