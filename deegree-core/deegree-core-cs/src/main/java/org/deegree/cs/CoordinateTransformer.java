...
public class CoordinateTransformer extends Transformer {
	...
	private static Logger LOG_TRANSFORM = LoggerFactory
		.getLogger(CoordinateTransformer.class.getCanonicalName() + ".TransformLogger");
	...
	/**
	 * Creates a new CoordinateTransformer object, with the given id as the target CRS.
	 * @param transformation to be used.
	 * @throws IllegalArgumentException if the given parameter is null.
	 */
	 ...
	 * @param sourceCRS in which the given points are referenced.
	 * @param points to transform.
	 * @return a list of transformed point3d's or an empty list if something went wrong,
	 * never <code>null</code>
	 * @throws TransformationException if no transformation could be created for the given
	 * source and target crs.
	 * @throws IllegalArgumentException if the sourceCRS is <code>null</code>
	 */
	 ...
	 * @param sourceCRS crs of the input coordinate, must not be <code>null</code>
	 * @param input input coordinate, must not be <code>null</code> and array length must
	 * match the number of dimensions of <code>sourceCRS</code>
	 * @param out output coordinate, used to store the transformed ordinates, must not be
	 * <code>null</code> and array length must match the number of dimensions of the
	 * target crs
