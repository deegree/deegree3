...
/**
 * A <code>CompoundCRS</code> is a {@link GeographicCRS} with a third axis (the height
 * axis) attached. This axis denotes a vertical axis, which defines a unit for a given
...
public class CompoundCRS extends CRS implements ICompoundCRS {
	 ...
	 * @param underlyingCRS the crs to which the height axis is added, only geographic,
	 * geocentric or projected crs are valid.
	 ...
	 * @throws IllegalArgumentException if the underlying crs is not of type geographic,
	 * geocentric or projected or one of the other values is <code>null</code>.
	 */
