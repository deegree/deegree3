...
/**
 * The <code>EPSGCode</code> class formalizes the CRSIdentifiables object codes that were
 * issued by EPSG. An instance of this class will represent all the EPSG codes variants
...
public class EPSGCode extends CRSCodeType {
	 ...
	 * <b>Note:</b> Use this constructor when you know the code created is not a condensed
	 * form, but it actually exists, i.e. you mean "EPSG:4326" not
	 * "URN:OGC:DEF:CRS:EPSG:4326". It will matter when comparing them or the
