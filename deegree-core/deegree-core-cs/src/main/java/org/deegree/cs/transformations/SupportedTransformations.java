...
/**
 * The <code>SupportedTransformations</code> enumeration defines currently supported
 * transformations
 *
...
public enum SupportedTransformations {
	...
	LONGITUDE_ROTATION,
	/**
	 * The {@link PolynomialTransformation} defining the general 2, 3, ... degree
			...
			if (code != null) {
				...
				if ("Longitude rotation".equalsIgnoreCase(compare) || matchEPSGString(compare, "method", "9601")) {
					...
					return HELMERT_3;
						...
						|| matchEPSGString(compare, "method", "9606") || matchEPSGString(compare, "method", "9607")) {
					return HELMERT_7;
				}
					...
					return NTV2;
						...
						|| matchEPSGString(compare, "method", "9647") || matchEPSGString(compare, "method", "9648")) {
