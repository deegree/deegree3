...
public class LambertAzimuthalEqualAreaRef extends ProjectionRef implements Serializable, ILambertAzimuthalEqualArea {
	...
	/**
	 * Creates a reference to a {@link LambertAzimuthalEqualArea}
	 ...
	 */
	public LambertAzimuthalEqualAreaRef(ReferenceResolver resolver, String uri, String baseURL) {
	...
	@Override
	public ILambertAzimuthalEqualArea getReferencedObject() throws ReferenceResolvingException {
		return (ILambertAzimuthalEqualArea) super.getReferencedObject();
	}
