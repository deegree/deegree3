...
public class Axis extends CRSIdentifiable implements IAxis {
	...
	/**
	 * Axis is pointing EAST( == -WEST) the intersection of the equator with longitude
	 * 90°E.
	 */
	...
	/**
	 * Axis is pointing FRONT( == -BACK), e.g. the Axis through the intersection of the
	 * Greenwich meridian and equator.
	 */
	public static final int AO_FRONT = 4;

	/**
	 * Axis is pointing BACK ( == -FRONT) e.g. the Axis through the intersection of the
	 * opposite of the Greenwich meridian and equator.
	 */
	public static final int AO_BACK = -AO_FRONT;

	/**
	 * Axis is pointing PERPENDICULAR to the earth's surface, which is used for a vertical
	 * axis.
	 */
	...
	/**
	 * @param units of this axis
	 * @param axisName of this axis (e.g. longitude...)
	 * @param orientation of the positive scale direction, one of Axis.AO*. If an unknown
	 * value is supplied AO_OTHER is assumed.
	 */
	...
	/**
	 * Parses the given orientation and creates a valid orientation of it's
	 * non-case-sensitive version. If no conversion was found, {@link #AO_OTHER} will be
	 * used.
	 * @param units of the axis.
	 * @param axisName of the axis.
	 * @param orientation of the axis as a string for example north
	 */
	 ...
	 * @param name of this axis (e.g. longitude...)
	 * @param orientation of the positive scale direction, one of Axis.AO*. If an unknown
	 * value is supplied AO_OTHER is assumed.
	 */
	 ...
	 * Parses the given orientation and creates a valid orientation of it's
	 * non-case-sensitive version. If no conversion was found, {@link #AO_OTHER} will be
	 * used. This axis will have metres as it's unit.
	...
	public String toString() {
		return "name: " + axisName + " orientation: " + getOrientationAsString() + " units: " + units;
	}
