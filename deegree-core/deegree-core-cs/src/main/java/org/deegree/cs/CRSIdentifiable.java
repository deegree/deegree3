...
/**
 * The <code>CRSIdentifiable</code> class can be used to identify Coordinate system
 * components.
 *
...
public class CRSIdentifiable implements CRSResource {
	...
	/**
	 * Takes the references of the other object and stores them in this CRSIdentifiable
	 * Object.
	 * @param other identifiable object.
	 */
	...
	/**
	 * @param codes
	 * @param names the human readable names of the object.
	 * @param versions
	 * @param descriptions
	 * @param areasOfUse
	 * @throws IllegalArgumentException if no identifier(s) was/were given.
	 */
	 ...
	 * @param toBeChecked for <code>null</code>
	 * @param message to put into the exception. If absent, the default message
	 * (CRS_INVALID_NULL_PARAMETER) will be inserted.
	 ...
	 * throws an InvalidParameterException if the given object is null
	 * @param toBeChecked for <code>null</code>
	 * @param functionName of the caller
	 * @param paramName of the parameter to be checked.
	 * @throws IllegalArgumentException if the given object is <code>null</code>.
	 */
	 ...
	 * @param toBeChecked for <code>null</code> or empty
	 * @param message to put into the exception. If absent, the default message
	 * (CRS_INVALID_NULL_PARAMETER) will be inserted.
	 * @throws IllegalArgumentException if the given object array is <code>null</code> or
	 * empty.
	 */
	...
	private double[] parseAreaBBox(String s) throws IllegalArgumentException, NumberFormatException {
