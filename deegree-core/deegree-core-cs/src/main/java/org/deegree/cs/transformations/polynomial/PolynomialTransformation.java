...
/**
 * <code>PolynomialTransformation</code> is the base class for all polynomial
 * transformations.
 *
...
public abstract class PolynomialTransformation extends Transformation {
	...
	/**
	 * @param firstParameters the parameters for the
	...
	/**
	 * @param originalPoints of the projection
	 * @param projectedPoints the 'function' values
	 * @param polynomalOrder the order of the polynomial function to use.
	...
	/**
	 * The central method, which actually transforms the points by applying the
	 * implemented polynomial.
	 * @param srcPoints to transform
	 * @return the transformed points.
	 * @throws TransformationException if for some reason one of the incoming points could
	 * not be transformed.
	 */
	...
	@Override
	public final List<Point3d> doTransform(List<Point3d> srcPts) throws TransformationException {
