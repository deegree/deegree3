...
/**
 * The <code>Unit</code> class defines a mechanism to convert between different
...
public final class Unit extends CRSIdentifiable implements IUnit {
	 ...
	 * Unit constructor.
	 * @param symbol
	 * @param name of the unit, e.g. metre
	 ...
	 * @param symbol of the units, e.g. 'm'
	 * @param name human readable name, e.g. metre
	 * @param scale to convert to the base type.
	...
	/**
	 * Will create a unit from the given String. If no appropriate unit was found
	...
	/**
	 * Compare this unit symbol with the specified object for equality. Only symbols are
	 * compared; other parameters are ignored.
	 */
	@Override
