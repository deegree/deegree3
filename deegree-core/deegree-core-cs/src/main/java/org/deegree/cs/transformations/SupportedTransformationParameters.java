...
/**
 * The <code>SupportedTransformationParameters</code> enumeration defines currently
...
public enum SupportedTransformationParameters {
	 ...
	 * @return a mapped transformation or {@link SupportedTransformations#NOT_SUPPORTED},
	...
	public static SupportedTransformationParameters fromCodes(CRSCodeType[] codes) {
		...
		for (CRSCodeType code : codes) {
			if (code != null) {
				...
				else if ("X-axis rotation".equalsIgnoreCase(compare) || matchEPSGString(compare, "parameter", "8608")) {
					return X_AXIS_ROTATION;
				}
				else if ("Y-axis rotation".equalsIgnoreCase(compare) || matchEPSGString(compare, "parameter", "8609")) {
					return Y_AXIS_ROTATION;
				}
				else if ("Z-axis rotation".equalsIgnoreCase(compare) || matchEPSGString(compare, "parameter", "8610")) {
