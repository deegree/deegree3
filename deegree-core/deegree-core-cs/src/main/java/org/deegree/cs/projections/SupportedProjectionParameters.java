...
/**
 * The <code>SupportedProjectionParameters</code> enumeration defines currently supported
...
public enum SupportedProjectionParameters {
	...
	/**
	 * The latitude of natural origin of a given projection, aka. projectionLatitude,
	 * central-latitude or latitude-of-origin, in Snyder referenced as phi_1 for
	 * azimuthal, phi_0 for other projections.
	 */
	LATITUDE_OF_NATURAL_ORIGIN,
	/**
	 * The longitude of natural origin of a given projection, aka. projectionLongitude,
	 * projection-meridian, central-meridian, in Snyder referenced as lambda_0
	 */
	 ...
	 * @return a mapped projections parameters or
	 * {@link SupportedProjectionParameters#NOT_SUPPORTED}, never <code>null</code>
	 */
			...
			if (name != null) {
				...
				if ((compare.contains("latitude") && (compare.contains("origin") || compare.contains("central")))
					...
					return SupportedProjectionParameters.LATITUDE_OF_NATURAL_ORIGIN;
						...
						|| "Central Meridian".equalsIgnoreCase(compare) || "centralmeridian".equalsIgnoreCase(compare)
						|| "CM".equalsIgnoreCase(compare) || matchEPSGString(compare, "parameter", "8802")
