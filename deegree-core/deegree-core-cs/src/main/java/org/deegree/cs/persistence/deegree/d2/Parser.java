...
public class Parser extends XMLFileResource implements CRSParser<OMElement> {
     ...
     */
    public Parser( DeegreeCRSStore<OMElement> provider, OMElement rootElement ) {
    ...
    protected CRSIdentifiable parseIdentifiable( OMElement element )
        ...
        try {
            ...
            if ( identifiers == null || identifiers.length == 0 ) {
                String msg = Messages.getMessage( "CRS_CONFIG_NO_ID",
                                                  ( ( element == null ) ? "null" : element.getLocalName() ) );
