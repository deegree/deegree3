...
public class QGisShapeLoader implements WellKnownNameLoader {
    ...
    private static synchronized void lazyLoad() {
        if ( SHAPES == null ) {
            ...
            at.translate( 0, 0.25 );
            at.scale( 0.5, 0.5 );
            SHAPES.put( "equilateral_triangle",
                        BoundedShape.inv( at, gp, new Rectangle2D.Double( -0.5, 0.5, 1.0, 1.0 ) ) );
            ...
            SHAPES.put( "quartercircle",
                        BoundedShape.inv( new Arc2D.Double( new Rectangle2D.Double( -0.5, -0.5, 1.0, 1.0 ), 180, 90,
                                                            Arc2D.PIE ),
                                          new Rectangle2D.Double( -0.5, 0.5, 1.0, 1.0 ) ) );

            SHAPES.put( "semicircle",
                        BoundedShape.inv( new Arc2D.Double( new Rectangle2D.Double( -0.5, -0.5, 1.0, 1.0 ), 180, 180,
                                                            Arc2D.PIE ),
                                          new Rectangle2D.Double( -0.5, 0.5, 1.0, 1.0 ) ) );

            SHAPES.put( "thirdcircle",
                        BoundedShape.inv( new Arc2D.Double( new Rectangle2D.Double( -0.5, -0.5, 1.0, 1.0 ), 150, 120,
                                                            Arc2D.PIE ),
                                          new Rectangle2D.Double( -0.5, 0.5, 1.0, 1.0 ) ) );
    ...
    public static void main( String[] args ) {
        lazyLoad();
        String list = SHAPES.entrySet().stream()//
