...
public class BoundedShape implements Shape {
     ...
     * 
     * @param at
     *            AffineTransform which is altered by a y-scale of -1
     * @param shp
     *            Source Shape
     * @param bounds
     *            Explicit Bounds of Shape
    ...
    public static BoundedShape inv( Shape shp, Rectangle2D bounds ) {
        ...
        BoundedShape s = new BoundedShape( at.createTransformedShape( shp ) );
        s.setBounds( new Rectangle2D.Double( bounds.getX(), bounds.getY() * -1, bounds.getWidth(),
                                             bounds.getHeight() ) );
     ...
     * 
     * <p>
     * <b>NOTE: The transformation creates new bounds, which could create an undesired effect when rotated.</b>
     * </p>
     * 
