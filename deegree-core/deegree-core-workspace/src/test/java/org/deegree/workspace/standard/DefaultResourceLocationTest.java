...
public class DefaultResourceLocationTest {
    ...
    public void testActivate() {
        DefaultResourceLocation<Resource> resourceDefaultResourceLocation = new DefaultResourceLocation<>(resourceFileInSubfolder, createIdentifier("test"));
    ...
    public void testActivate_InSubDirectory() {
        DefaultResourceLocation<Resource> resourceDefaultResourceLocation = new DefaultResourceLocation<>(resourceFileInSubfolder, createIdentifier("test/test"));
    ...
    private DefaultResourceIdentifier<Resource> createIdentifier(String identifier) {
        return new DefaultResourceIdentifier<>((Class<? extends ResourceProvider<Resource>>) providerClass().getClass(), identifier);
    }
