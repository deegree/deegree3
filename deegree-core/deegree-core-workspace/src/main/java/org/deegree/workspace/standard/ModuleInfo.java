...
public final class ModuleInfo implements Comparable<ModuleInfo> {
	 ...
	 * @param classpathURLs classpath urls, must not be <code>null</code>
	 * @return module infos, never <code>null</code>, but can be empty (if no deegree
	 * module information is present on the given classpathes)
	 */
	...
	private static String retrieveVersion(Properties props, Reflections r, URLClassLoader classLoader,
			String buildArtifactId, URL classpathURL) throws IOException {
