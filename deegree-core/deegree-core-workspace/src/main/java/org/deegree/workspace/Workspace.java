...
public interface Workspace {
	...
	/**
	 * Call this method (or #initAll) before anything else. Prepares the workspace so it
	 * can start initializing resources.
	 */
	void startup();
	...
	/**
	 * Destroys the resource with the given id and shuts down all resources that depend on
	 * it, putting them into error state.
	 * @param id never <code>null</code>
	 */
	 ...
	 * @param providerClass never <code>null</code>
	 * @param id never <code>null</code>
	 ...
	 * @param id never <code>null</code>
	 * @param prepared can be <code>null</code>
	 ...
	 * @param managerClass never <code>null</code>
	...
	/**
	 * Returns an error handler that contains information about errors when starting up
	 * resources.
	 * @return never <code>null</code>
	 */
	...
	/**
	 * Can be used to obtain an Initializable object which has been loaded and started up
	 * during #startup.
