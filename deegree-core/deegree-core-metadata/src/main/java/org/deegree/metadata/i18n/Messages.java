/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package org.deegree.metadata.i18n;
...
public class Messages {
	...
	private static final String BUNDLE_NAME = "org.deegree.metadata.i18n.messages_en";
	...
	static {
		...
		try {
			...
			// ("org/deegree/model/i18n/message_en.properties")
	...
	private static void overrideMessages(String propertiesFile, Properties props) throws IOException {
		InputStream is = null;
		try {
	 ...
	 * @param key to get
	 * @param arguments to fill in the message
