...
public class DCRecord implements MetadataRecord {
	...
	private void toDCFull(XMLStreamWriter writer) throws XMLStreamException {
	...
	private void writeFullElements(XMLStreamWriter writer) throws XMLStreamException {
		if (getCreator() != null) {
	...
	private void toDCSummary(XMLStreamWriter writer) throws XMLStreamException {
	...
	private void write(XMLStreamWriter writer, String elementName, String value, QName ns) throws XMLStreamException {
		if (value != null) {
	...
	private void toDCBrief(XMLStreamWriter writer) throws XMLStreamException {
	...
	private void writeBriefElements(XMLStreamWriter writer) throws XMLStreamException {
	...
	private void writeBoundingBox(XMLStreamWriter writer) throws XMLStreamException {
