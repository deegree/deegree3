...
public class ISORecordAnyTextTest extends AbstractISOTest {
    ...
    public void testAnyTextElement_ALL()
        ...
        String anyText = rec.getAnyText( getConfig( TstConstants.configURL_ANYTEXT_ALL ).getAnyText() );
    ...
    public void testAnyTextElement_CORE()
        ...
        ISORecord rec = (ISORecord) MetadataRecordFactory.create( ( new XMLAdapter( TstConstants.tst_10 ) ).getRootElement() );
        String anyText = rec.getAnyText( getConfig( TstConstants.configURL_ANYTEXT_CORE ).getAnyText() );
    ...
    public void testAnyTextElement_CUSTOM()
        ...
        ISORecord rec = (ISORecord) MetadataRecordFactory.create( ( new XMLAdapter( TstConstants.tst_10 ) ).getRootElement() );
        String anyText = rec.getAnyText( getConfig( TstConstants.configURL_ANYTEXT_CUSTOM ).getAnyText() );
    ...
    private ISOMetadataStoreConfig getConfig( URL url )
                            throws JAXBException {
