...
/**
 * Wraps the execution of the CITE WCS 1.0.0 TestSuite as a JUnit-test suite.
 *
 * @author <a href="mailto:schneider@lat-lon.de">Markus Schneider</a>
 */
@RunWith(Parameterized.class)
public class CiteWCS100TestSuite {
	...
	public CiteWCS100TestSuite(String testLabel, String resultSnippet) {
