...
public abstract class AbstractWmtsSimilarityIT {
	...
	public AbstractWmtsSimilarityIT(String resourceName, String baseDir) throws IOException {
		this.resourceName = resourceName;
		this.request = IOUtils
			.toString(WmtsGetFeatureInfoSimilarityIT.class.getResourceAsStream(baseDir + "/" + resourceName + ".kvp"));
	}
