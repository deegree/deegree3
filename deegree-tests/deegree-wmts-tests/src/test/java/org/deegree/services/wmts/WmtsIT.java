...
public class WmtsIT {
	...
	private static final String ENDPOINT_URL = ENDPOINT_BASE_URL + "service=WMTS&request=GetCapabilities&version=1.0.0";
	...
	@Test
	public void testCapabilitiesPyramidLayerNoFeatureInfoFormats() throws XMLStreamException {
		WMTSClient client = initClient();
	...
	@Test
	public void testCapabilitiesRemoteWmsLayerHasFeatureInfoFormats() throws XMLStreamException {
		WMTSClient client = initClient();
	...
	@Test
	public void testGetFeatureInfoNonGfiLayer() throws IOException, XMLStreamException, FactoryConfigurationError {
	...
	@Test
	public void testGetFeatureInfoRemoteWmsGmlOutputValid() throws IOException {
	...
	@Test
	public void testGetFeatureInfoRemoteWmsCachedGmlOutputValid() throws IOException {
	...
	@Test
	public void testGetTileFaultyLayer() throws IOException, XMLStreamException {
	...
	@Test
	public void testGetFeatureInfoFaultyLayer() throws IOException, XMLStreamException {
	...
	private void checkException(String req) throws IOException, XMLStreamException {
	...
	private InputStream performGetRequest(String request) throws IOException {
