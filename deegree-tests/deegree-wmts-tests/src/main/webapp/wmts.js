...
OpenLayers.DOTS_PER_INCH = 90.72;
    ...
    map.addLayer(new OpenLayers.Format.WMTSCapabilities().createLayer(caps, {name: 'remotewms_jpeg', layer: 'remotewms_jpeg', matrixSet: 'remotewms_jpeg', format: 'image/jpeg'}));
