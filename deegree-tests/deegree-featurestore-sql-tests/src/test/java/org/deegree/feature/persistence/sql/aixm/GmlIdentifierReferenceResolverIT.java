...
/**
 * Tests the behavior when resolving AIXM-style references using an {@link SQLFeatureStore} (BLOB mode).
 *
 * @author <a href="mailto:schneider@occamlabs.de">Markus Schneider</a>
 *
 * @since 3.4
 */
public class GmlIdentifierReferenceResolverIT extends SQLFeatureStoreTestCase {
