...
public final class GrammarUtil {
	...
	public static Grammar parseGrammar(URL grammarUrl, XMLGrammarPool grammarPool) throws IOException {
	...
	public static Grammar parseGrammar(URL grammarUrl, XMLGrammarPool grammarPool, XMLErrorHandler errorHandler)
			throws IOException {
		return parseGrammar(grammarUrl.toExternalForm(), new InputStreamReader(grammarUrl.openStream()), grammarPool,
				errorHandler);
	}
	...
	public static Grammar parseGrammar(File grammarFile, XMLGrammarPool grammarPool) throws IOException {
	...
	public static Grammar parseGrammar(String baseUri, String grammarText) throws IOException {
	...
	public static Grammar parseGrammar(String baseUri, Reader in, XMLGrammarPool grammarPool,
		...
		return grammerParser.preparseGrammar("http://www.w3.org/2001/XMLSchema",
				new XMLInputSource(baseUri, baseUri, baseUri, in, encoding));
	}
