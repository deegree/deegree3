  ...
  <!-- Sample usage:
       <ctl:call-test name="ctl:XMLValidatingParser">
         ...
         <ctl:with-param name="instruction">
           <parsers:schemas>
             <parsers:schema type="resource">csw/2.0.2/ogc/csw/2.0.1/csw-2.0.1.xsd</parsers:schema>
           </parsers:schemas>
         </ctl:with-param>
       </ctl:call-test>
       -->
...
<!--       <ctl:with-param name="schemas_links"> -->
<!--         <parsers:schemas> -->
<!--           <parsers:schema type="resource">csw/2.0.2/ogc/ows/1.0.0/ows-1.0.0.xsd</parsers:schema> -->
<!--         </parsers:schemas> -->
<!--       </ctl:with-param> -->
<!--     </ctl:java> -->
<!--   </ctl:parser> -->
...
<!--       <ctl:with-param name="schemas_links"> -->
<!--         <parsers:schemas> -->
<!--           <parsers:schema type="resource">csw/2.0.2/w3c/xmlschema/1.0/XMLSchema.xsd</parsers:schema> -->
<!--         </parsers:schemas> -->
<!--       </ctl:with-param> -->
<!--     </ctl:java> -->
<!--   </ctl:parser> -->
