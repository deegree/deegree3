...
public class GML311GeometryDecoder extends GML311BaseDecoder {
     ...
     * @param idContext
     */
    public GML311GeometryDecoder( GeometryFactory geomFac, GMLIdContext idContext ) {
        super( geomFac );
    ...
    public Point parsePoint( XMLStreamReaderWrapper xmlStream, CRS defaultCRS )
        ...
        StandardObjectProps standardProps = parse311( xmlStream );
    ...
    public Curve parseCurveProperty( XMLStreamReaderWrapper xmlStream, CRS defaultCRS )
        ...
        if ( href != null && href.length() > 0 ) {
            LOG.debug( "Found geometry reference (xlink): '" + href + "'" );
            curve = new CurveReference<Curve>( href, xmlStream.getSystemId() );
    ...
    public Surface parseSurfaceProperty( XMLStreamReaderWrapper xmlStream, CRS defaultCRS )
        ...
        if ( href != null && href.length() > 0 ) {
            LOG.debug( "Found geometry reference (xlink): '" + href + "'" );
            surface = new SurfaceReference<Surface>( href, xmlStream.getSystemId() );
    ...
    public Solid parseSolidProperty( XMLStreamReaderWrapper xmlStream, CRS defaultCRS )
        ...
        if ( href != null && href.length() > 0 ) {
            LOG.debug( "Found geometry reference (xlink): '" + href + "'" );
            solid = new SolidReference<Solid>( href, xmlStream.getSystemId() );
    ...
    public GeometricPrimitive parseGeometricPrimitiveProperty( XMLStreamReaderWrapper xmlStream, CRS defaultCRS )
        ...
        if ( href != null && href.length() > 0 ) {
            LOG.debug( "Found geometry reference (xlink): '" + href + "'" );
            primitive = new GeometricPrimitiveReference<GeometricPrimitive>( href, xmlStream.getSystemId() );
