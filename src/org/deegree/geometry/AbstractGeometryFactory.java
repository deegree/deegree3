...
public abstract class AbstractGeometryFactory implements GeometryFactory {
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.GeometryFactory#getDescription()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.GeometryFactory#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.GeometryFactory#getSupportedCurveInterpolations()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.GeometryFactory#getSupportedGeometries()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.GeometryFactory#getSupportedSurfaceInterpolations()
     */
    ...
    /* (non-Javadoc)
     * @see org.deegree.geometry.GeometryFactory#setDescription(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.deegree.geometry.GeometryFactory#setName(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.deegree.geometry.GeometryFactory#setSupportedCurveInterpolations(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see org.deegree.geometry.GeometryFactory#setSupportedGeometries(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see org.deegree.geometry.GeometryFactory#setSupportedSurfaceInterpolations(java.util.List)
     */
