...
//        geometry = jtsFactory.createPolygon( shell, holes );
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Surface#getArea()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Surface#getBoundary()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Surface#getCentroid()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Surface#getPatches()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Surface#getPerimeter()
     */
