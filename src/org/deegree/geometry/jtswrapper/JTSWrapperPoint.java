...
public class JTSWrapperPoint extends JTSWrapperGeometry implements Point {
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Point#get(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Point#getAsArray()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Point#getX()
     */
    public double getX() {
        return this.pos[0];
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Point#getY()
     */
    public double getY() {
        return this.pos[1];
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.geometry.primitive.Point#getZ()
     */
    public double getZ() {
