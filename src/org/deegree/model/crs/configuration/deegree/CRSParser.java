...
public class CRSParser extends XMLFileResource {
    ...
    private static Logger LOG = LoggerFactory.getLogger( CRSParser.class );
     ...
     * @throws CRSConfigurationException
     */
    protected CRSIdentifiable parseIdentifiable( Element element )
                            throws CRSConfigurationException {
        try {
    ...
    protected Ellipsoid getEllipsoidFromID( String ellipsoidID )
        ...
        if ( result == null ) {
            ...
            try {
                ...
                inverseFlattening = XMLTools.getNodeAsDouble( ellipsoidElement, PRE + "inverseFlatting", nsContext,
                                                              Double.NaN );
