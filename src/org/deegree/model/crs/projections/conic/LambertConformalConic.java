...
package org.deegree.model.crs.projections.conic;

import static org.deegree.model.crs.projections.ProjectionUtils.EPS10;
import static org.deegree.model.crs.projections.ProjectionUtils.EPS11;
import static org.deegree.model.crs.projections.ProjectionUtils.HALFPI;
import static org.deegree.model.crs.projections.ProjectionUtils.QUARTERPI;
import static org.deegree.model.crs.projections.ProjectionUtils.calcMFromSnyder;
import static org.deegree.model.crs.projections.ProjectionUtils.calcPhiFromConformalLatitude;
import static org.deegree.model.crs.projections.ProjectionUtils.length;
import static org.deegree.model.crs.projections.ProjectionUtils.preCalcedThetaSeries;
import static org.deegree.model.crs.projections.ProjectionUtils.tanHalfCoLatitude;
...
public class LambertConformalConic extends ConicProjection {
    ...
    /**
     * 
     * @see org.deegree.model.crs.projections.Projection#doInverseProjection(double, double)
     */
    @Override
    ...
    /**
     * 
     * @see org.deegree.model.crs.projections.Projection#doProjection(double, double)
     */
    @Override
