...
public class GeoTransformer {
    ...
    private static Log LOG_TRANSORM = LogFactory.getLog( GeoTransformer.class.getCanonicalName() + ".TransformLogger" );

    private static Log LOG = LogFactory.getLog( GeoTransformer.class );
    ...
    /**
     * Private constructor will get an instance of the CRSConfiguration, and from it the CRSProvider.
     */
    private GeoTransformer() {
        CRSConfiguration crsConfig = CRSConfiguration.getCRSConfiguration();
        crsProvider = crsConfig.getProvider();
    }
     ...
     */
    public GeoTransformer( CoordinateSystem targetCRS ) throws InvalidParameterException {
        this();
        if ( targetCRS == null ) {
    ...
    public List<Point3d> transform( CoordinateSystem sourceCRS, List<Point3d> points )
        ...
        CRSTransformation trans = null;
        try {
            trans = factory.createFromCoordinateSystems( sourceCRS, targetCRS );
        ...
        if ( LOG_TRANSORM.isDebugEnabled() || LOG.isDebugEnabled() ) {
            ...
            for ( int i = 0; i < points.size(); ++i ) {
                ...
                LOG_TRANSORM.debug( sb.toString() );
    ...
    public Geometry transform( Geometry geo )
        ...
        // }
        // CoordinateSystem sourceCRS = geo.getCoordinateSystem().getCRS();
        //
        // TransformationFactory factory = TransformationFactory.getInstance();
        // CRSTransformation trans = null;
        //
     ...
     */
    private Geometry transform( Curve geo, CRSTransformation trans )
                            throws GeometryException {
        throw new UnsupportedOperationException( "Currently not adapted to deegree 3" );
     ...
     * @throws GeometryException
     */
    private Geometry transform( MultiCurve geo, CRSTransformation trans )
                            throws GeometryException {
        throw new UnsupportedOperationException( "Currently not adapted to deegree 3" );
     ...
     */
    private Geometry transform( MultiPoint geo, CRSTransformation trans ) {
        throw new UnsupportedOperationException( "Currently not adapted to deegree 3" );
     ...
     * @throws GeometryException
     */
    private Geometry transform( MultiSurface geo, CRSTransformation trans )
                            throws GeometryException {
        throw new UnsupportedOperationException( "Currently not adapted to deegree 3" );
     ...
     */
    private Geometry transform( Point geo, CRSTransformation trans ) {
        throw new UnsupportedOperationException( "Currently not adapted to deegree 3" );
