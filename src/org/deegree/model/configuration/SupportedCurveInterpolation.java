...
/**
 * Class SupportedCurveInterpolation.
 * 
 * @version $Revision$ $Date$
 */
public class SupportedCurveInterpolation extends SupportedCurveInterpolationType implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 3007519517335835792L;

    public SupportedCurveInterpolation() {
        super();
    }
    ...
    public static org.deegree.model.configuration.SupportedCurveInterpolationType unmarshal( final java.io.Reader reader )
        ...
        return (org.deegree.model.configuration.SupportedCurveInterpolationType) Unmarshaller.unmarshal(
                                                                                                         org.deegree.model.configuration.SupportedCurveInterpolation.class,
                                                                                                         reader );
    }
