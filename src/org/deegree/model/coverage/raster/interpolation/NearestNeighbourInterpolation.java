...
/**
 * This class implements a simple nearest neighbour interpolation. It works with all {@link DataType}s.
 * 
...
public class NearestNeighbourInterpolation implements Interpolation {
    ...
    /**
     * Create a new nearest neighbour interpolation for given {@link RasterData}.
     * 
     * @param rasterData
     */
    public NearestNeighbourInterpolation( RasterData rasterData ) {
        raster = rasterData;
    }
