//$HeadURL: svn+ssh://otonnhofer@svn.wald.intevation.org/deegree/deegree3/model/trunk/src/org/deegree/model/coverage/raster/RasterDatastore.java $
/*----------------    FILE HEADER  ------------------------------------------
...
import org.deegree.model.coverage.raster.TileContainer;
...
/**
 * This is a first version of a {@link DataStore}-based TileContainer implementation.
 * 
 * @version $Revision: $
 * 
    ...
    public Envelope getEnvelope() {
        if ( envelope != null ) {
            ...
            try {
                ...
                result = GeometryFactoryCreator.getInstance().getGeometryFactory().createEnvelope( 0.0001, null );
            }
            return result;
        }
    }
