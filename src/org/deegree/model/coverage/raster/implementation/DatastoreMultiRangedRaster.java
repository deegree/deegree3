//$HeadURL: svn+ssh://otonnhofer@svn.wald.intevation.org/deegree/deegree3/model/trunk/src/org/deegree/model/coverage/raster/DatastoreMultiRangedRaster.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This class represents an AbstractRaster with multiple ranges. The ranges are stored in a RasterDatastore.
 * 
...
public class DatastoreMultiRangedRaster extends AbstractRaster {
    ...
    /**
     * Create a new DatastoreMultiRangedRaster with given RasterDatastore as data backend.
     * 
     * @param container The data backend.
     */
