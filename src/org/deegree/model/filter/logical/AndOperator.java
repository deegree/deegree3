...
public class AndOperator implements BooleanOperator {
    ...
    private BooleanOperator param1;
    
    private BooleanOperator param2;

    public AndOperator( BooleanOperator param1, BooleanOperator param2 ) {
        this.param1 = param1;
        this.param2 = param2;
    }
    
    public BooleanOperator getParameter1 () {
        return param1;
    }

    public BooleanOperator getParameter2 () {
        return param2;
    }    
