 ...
 */
public class PropertyIsLessThanOrEqualToOperator extends BinaryComparisonOperator {

    public PropertyIsLessThanOrEqualToOperator( Expression parameter1, Expression parameter2, boolean matchCase ) {
