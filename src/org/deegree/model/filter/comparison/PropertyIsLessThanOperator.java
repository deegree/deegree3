 ...
 */
public class PropertyIsLessThanOperator extends BinaryComparisonOperator {

    public PropertyIsLessThanOperator( Expression parameter1, Expression parameter2, boolean matchCase ) {
