 ...
 */
public class PropertyIsGreaterThanOperator extends BinaryComparisonOperator {

    public PropertyIsGreaterThanOperator( Expression parameter1, Expression parameter2, boolean matchCase ) {
