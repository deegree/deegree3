 ...
 */
public class PropertyIsNotEqualToOperator extends BinaryComparisonOperator {

    public PropertyIsNotEqualToOperator( Expression param1, Expression param2, boolean matchCase ) {
