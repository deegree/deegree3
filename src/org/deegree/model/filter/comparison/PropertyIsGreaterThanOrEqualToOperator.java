 ...
 */
public class PropertyIsGreaterThanOrEqualToOperator extends BinaryComparisonOperator {

    public PropertyIsGreaterThanOrEqualToOperator( Expression parameter1, Expression parameter2, boolean matchCase ) {
