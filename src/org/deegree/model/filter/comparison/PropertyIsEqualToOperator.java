 ...
 */
public class PropertyIsEqualToOperator extends BinaryComparisonOperator {

    public PropertyIsEqualToOperator( Expression param1, Expression param2, boolean matchCase ) {
