...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jan 13 09:57:11 CET 2010
  */
public class TemplatingParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\002\004\005\000\002\004\004\000\002\004\003" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\033\000\006\005\006\006\005\001\002\000\004\002" +
    "\035\001\002\000\006\015\027\020\031\001\002\000\032" +
    "\004\011\007\016\010\017\011\020\012\012\013\022\014" +
    "\014\017\023\020\010\021\024\022\013\023\015\001\002" +
    "\000\040\002\ufffb\004\011\005\ufffb\006\ufffb\007\016\010" +
    "\017\011\020\012\012\013\022\014\014\017\023\020\010" +
    "\021\024\022\013\023\015\001\002\000\010\002\ufffa\005" +
    ...
    "\004\002\uffff\001\002\000\010\002\ufffc\005\ufffc\006\ufffc" +
    "\001\002\000\004\016\033\001\002\000\010\002\ufffe\005" +
    "\006\006\005\001\002\000\010\002\uffec\005\uffec\006\uffec" +
    "\001\002\000\004\002\ufffd\001\002\000\014\002\uffed\005" +
    "\uffed\006\uffed\015\027\020\031\001\002\000\010\002\uffee" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\004\004\027\001\001\000\006\003\020\005\006\001\001" +
    "\000\006\003\025\005\006\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\004\002\024\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\004\002\031" +
  ...
  public final java_cup.runtime.Symbol CUP$TemplatingParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$TemplatingParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 21: // map ::= END_DEFINITION_TOKEN 
            {
		 ...
		 RESULT = new MapDefinition(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // map ::= MAP_KEY_TOKEN MAP_VALUE_TOKEN 
            {
              MapDefinition RESULT =null;
		...
		String val = (String)((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 RESULT = new MapDefinition();
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 19: // map ::= MAP_KEY_TOKEN MAP_VALUE_TOKEN map 
            {
              MapDefinition RESULT =null;
		...
		MapDefinition def = (MapDefinition)((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 def.map.put(key, val);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 18: // templatebody ::= GMLID_TOKEN 
            {
              Object RESULT =null;
		 RESULT = new GMLId(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 17: // templatebody ::= LINK_CALL_TOKEN 
            {
              Object RESULT =null;
		 RESULT = new Link(); 
              CUP$TemplatingParser$result = parser.getSymbolFactory().newSymbol("templatebody",3, ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), RESULT);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // templatebody ::= VALUE_TOKEN 
            {
              Object RESULT =null;
		 RESULT = new Value(); 
              CUP$TemplatingParser$result = parser.getSymbolFactory().newSymbol("templatebody",3, ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), RESULT);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // templatebody ::= NAME_TOKEN 
            {
              Object RESULT =null;
		 RESULT = new Name(); 
              CUP$TemplatingParser$result = parser.getSymbolFactory().newSymbol("templatebody",3, ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), RESULT);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // templatebody ::= INDEX_CALL_TOKEN 
            {
              Object RESULT =null;
		 RESULT = new Index(); 
              CUP$TemplatingParser$result = parser.getSymbolFactory().newSymbol("templatebody",3, ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()), RESULT);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // templatebody ::= ODD_CALL_TOKEN 
            {
              Object RESULT =null;
		...
		String call = (String)((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 RESULT = new OddEven(call, true); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // templatebody ::= EVEN_CALL_TOKEN 
            {
              Object RESULT =null;
		int callleft = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).left;
		int callright = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).right;
		String call = (String)((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 RESULT = new OddEven(call, false); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // templatebody ::= MAP_CALL_TOKEN 
            {
              Object RESULT =null;
		int callleft = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).left;
		int callright = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).right;
		String[] call = (String[])((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 if(call[0].equalsIgnoreCase("name")) RESULT = new MapCall(call[1], MapCall.Type.Name);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // templatebody ::= FEATURE_TEMPLATE_CALL_TOKEN 
            {
              Object RESULT =null;
		int callleft = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).left;
		int callright = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).right;
		String[] call = (String[])((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 RESULT = new FeatureTemplateCall(call[1], call[0]); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // templatebody ::= PROPERTY_TEMPLATE_CALL_TOKEN 
            {
              Object RESULT =null;
		int callleft = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).left;
		int callright = ((java_cup.runtime.Symbol)CUP$TemplatingParser$stack.peek()).right;
		String[] call = (String[])((java_cup.runtime.Symbol) CUP$TemplatingParser$stack.peek()).value;
		 RESULT = new PropertyTemplateCall(call[1], call[0]); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // templatebody ::= TEXT_TOKEN 
            {
              Object RESULT =null;
