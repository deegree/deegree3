    ...
    extends FeatureStoreType
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the relationalMapping property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<String> getRelationalMapping() {
        if (relationalMapping == null) {
            relationalMapping = new ArrayList<String>();
        }
