...
/** CUP v0.10k generated parser.
  * @version Tue Aug 04 15:25:11 CEST 2009
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\017\000\002\003\003\000\002\002\004\000\002\003" +
    "\003\000\002\003\003\000\002\004\005\000\002\004\003" +
    "\000\002\004\005\000\002\006\005\000\002\006\003\000" +
    "\002\006\005\000\002\005\005\000\002\005\006\000\002" +
    "\005\007\000\002\005\004\000\002\005\005" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\026\000\006\003\006\006\010\001\002\000\004\002" +
    "\001\001\002\000\006\002\ufff9\004\025\001\002\000\004" +
    "\002\ufffe\001\002\000\004\002\uffff\001\002\000\012\002" +
    "\ufffc\003\014\004\013\005\015\001\002\000\004\002\012" +
    "\001\002\000\004\002\000\001\002\000\006\003\023\006" +
    "\024\001\002\000\006\002\ufff4\004\ufff4\001\002\000\006" +
    "\003\016\006\017\001\002\000\006\002\ufff3\004\ufff3\001" +
    "\002\000\010\002\ufff7\004\ufff7\005\020\001\002\000\010" +
    "\002\ufff6\004\ufff6\006\021\001\002\000\006\002\ufff5\004" +
    "\ufff5\001\002\000\004\002\ufffd\001\002\000\004\002\ufffb" +
    "\001\002\000\006\002\ufffc\004\013\001\002\000\006\003" +
    "\026\006\030\001\002\000\004\002\ufff8\001\002\000\004" +
    "\002\ufffa\001\002\000\006\003\014\005\015\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\026\000\012\003\010\004\003\005\004\006\006\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\004\004\021\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\006\005\004\006\026\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "" });
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // interval ::= TOKEN SLASH error 
            {
              Object RESULT = null;
		...
		Object min = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 String msg = "Missing '/' after " + min + ".";
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // interval ::= TOKEN SLASH TOKEN SLASH TOKEN 
            {
              Object RESULT = null;
		...
		Object res = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new DimensionInterval(min, max, res); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // interval ::= TOKEN SLASH TOKEN SLASH 
            {
              Object RESULT = null;
		...
		Object max = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new DimensionInterval(min, max, 0); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // interval ::= TOKEN SLASH TOKEN 
            {
              Object RESULT = null;
		int minleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int minright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		Object max = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new DimensionInterval(min, max, 0); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // intervals ::= interval COMMA error 
            {
              Object RESULT = null;
		...
		Object err = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 String msg = (String)(err == null ? "Expected another interval after '" + val + ",'." : ((Exception)err).getMessage());
                                                   parser.report_error(msg, null);
                                                   RESULT = new Exception(msg); 
              CUP$parser$result = new java_cup.runtime.Symbol(4/*intervals*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // intervals ::= interval 
            {
              Object RESULT = null;
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 if(val instanceof Exception){
              ...
              CUP$parser$result = new java_cup.runtime.Symbol(4/*intervals*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // intervals ::= interval COMMA intervals 
            {
              Object RESULT = null;
		int valleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int valright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		Object vals = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // values ::= TOKEN COMMA error 
            {
              Object RESULT = null;
		int valleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int valright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new LinkedList();
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // values ::= TOKEN COMMA values 
            {
              Object RESULT = null;
		int valleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int valright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		Object vals = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 if(vals instanceof LinkedList) ((LinkedList)vals).addFirst(val);
          ...
          case 3: // strt ::= error 
            {
              Object RESULT = null;
		 String msg = "No value, list, interval or interval list was found.";
                                      parser.report_error(msg, null);
                                      RESULT = new Exception(msg); 
