...
public class RasterAPITextureTileProvider implements TextureTileProvider {
    ...
    public TextureTile getTextureTile( float minX, float minY, float maxX, float maxY ) {
        ...
        // if (System.currentTimeMillis() - begin2 > 100) {
        ...
        TextureTile tile = new TextureTile( minX, minY, maxX, maxY, subset.getColumns(), subset.getRows(), pixelBuffer,
                                            false );
        // LOG.debug( "#getTextureTile(): total " + elapsed + " milliseconds" );
        return tile;
    }
    ...
    //
    // RasterAPITextureTileProvider textureProvider = new RasterAPITextureTileProvider(new File ("bla"));
    // long begin = System.currentTimeMillis();
    // TextureTile tile = textureProvider.getTextureTile( 2579600f, 5616500f, 2580100f, 5617000f, 0.7f );
    // long elapsed = System.currentTimeMillis() - begin;
