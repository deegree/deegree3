...
/**
 * The <code>BufferIO</code> class TODO add class documentation here.
 * 
...
public class BufferIO {
    private final static Logger LOG = LoggerFactory.getLogger( BufferIO.class );
     ...
     *    BufferIO.writeBufferToStream( out, myFloatBuffer );
     * }
     * 
     * private void readObject( ObjectInputStream in ){
     *    myFloatBuffer = BufferIO.readFloatBufferFromStream( in );
     * }
     * </code>
     * </p>
     * 
     ...
     * 
     * private void writeObject( ObjectOutputStream out ){
     *    BufferIO.writeBufferToStream( out, myByteBuffer );
     * }
     * 
     * private void readObject( ObjectInputStream in ){
     *    myByteBuffer = BufferIO.readByteBufferFromStream( in );
     * }
     * </code>
     * </p>
     * 
