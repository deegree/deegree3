...
package org.deegree.crs.configuration.deegree.xml.stax;
...
import org.deegree.crs.configuration.deegree.xml.CRSParser;
import org.deegree.crs.configuration.deegree.xml.DeegreeCRSProvider;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.CoordinateSystemParser;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.DatumParser;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.EllipsoidParser;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.PrimemeridianParser;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.ProjectionParser;
import org.deegree.crs.configuration.deegree.xml.stax.parsers.TransformationParser;
...
public class Parser implements CRSParser<StAXResource> {
    ...
    public Parser( DeegreeCRSProvider<StAXResource> provider, Properties properties ) {
        ...
        try {
            ...
            cUrl = StAXParsingHelper.getText( reader, new QName( CRS_NS, "PrimeMeridiansFile" ), "pm-definitions.xml",
                                              true );
            url = StAXParsingHelper.resolve( cUrl, reader );
            ...
            cUrl = StAXParsingHelper.getText( reader, new QName( CRS_NS, "DatumsFile" ), "datum-definitions.xml", true );
            url = StAXParsingHelper.resolve( cUrl, reader );
