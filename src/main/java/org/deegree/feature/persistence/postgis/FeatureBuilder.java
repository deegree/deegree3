...
class FeatureBuilder {
    ...
    FeatureBuilder( PostGISFeatureStore fs, FeatureType ft, FeatureTypeMapping ftMapping, Connection conn ) {
        this.fs = fs;
        this.ft = ft;
            ...
            if ( pt instanceof SimplePropertyType ) {
                ...
                while ( rs2.next() ) {
                    ...
                    if ( wkb != null ) {
                        try {
                            ...
                            geom.setCoordinateSystem( fs.storageSRS );
                ...
                while ( rs2.next() ) {
                    ...
                    if ( subFid != null ) {
                        ...
                        String uri = "#" + subFid;
                        FeatureReference ref = new FeatureReference( fs.resolver, uri, null );
