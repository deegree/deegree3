 ...
 * whereClause-representation into the relevant expressions.
 * 
 * TODO NOT is not implemented at the moment.
 * 
...
public class GenerateWhereClauseList {
    ...
    public List<Pair<StringBuilder, Collection<Object>>> generateList() {
        ...
        for ( int pointerOfOrConditions = sizeOfORConditions.length == 1 ? 0 : 1; pointerOfOrConditions < sizeOfORConditions.length; pointerOfOrConditions++ ) {
                ...
                if ( countBracket != 0 ) {
                    ...
                    for ( Pair<StringBuilder, Object> a : clauseParamPairListTemp ) {
                        ...
                        if ( i > -1 ) {
                            ...
                            parsedExpressionAfterTemp = parsedExpressionAfterTemp.replace( a.first.toString().trim(),
                                                                                           "" );
