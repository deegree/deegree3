...
package org.deegree.cs.configuration.deegree.db;
...
/**
 * The <code>CRSRemover</code> class deletes a CRS from the database. The provided CRS if first identified with the one
...
public class CRSRemover {
    ...
    /**
     * Command-line tool for removing a CRS from the CRS db. It can be a given in WKT form (in a file), or as a
     * reference to the xml crs file.
     * 
     ...
     * jdbc:derby:${your-workspace-path}/d3_core/src/META-INF/deegreeCRS, otherwise the database will be accessed
    ...
    public static void main( String[] args )
        ...
        if ( args.length != 2 ) {
            throw new Exception( "Exactly 2 arguments have to be provided ( 'xml|wkt  crs-code-type|wkt-filename' )" );
        }
