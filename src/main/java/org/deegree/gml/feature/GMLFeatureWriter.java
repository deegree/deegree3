 ...
 * This implementation is aware of xlinks (local as well as remote) and allows
 * to set the <code>traverseXlinkDepth</code> parameter, which controls the
 * number of feature levels that are exported inline.
 * </p>
 * 
...
public class GMLFeatureWriter {
	 ...
	 * @param writer
	 * @param outputCRS
	 *            crs used for exported geometries, may be <code>null</code> (in
	 *            that case, the crs of the geometries is used)
	 */
	 ...
	 * @param outputCRS
	 *            crs used for exported geometries, may be <code>null</code> (in
	 *            this case, the original crs of the geometries is used)
	 * @param formatter
	 *            formatter to use for exporting coordinates, e.g. to limit the
	 *            number of decimal places, may be <code>null</code> (use 5
	 *            decimal places)
	 ...
	 *            properties to be exported, may be <code>null</code> (export
	 *            all properties)
	...
	public GMLFeatureWriter(GMLVersion version, XMLStreamWriter writer, CRS outputCRS, CoordinateFormatter formatter,
			String referenceTemplate, PropertyName[] requestedProps, int traverseXlinkDepth, int traverseXlinkExpiry,
			XLinkPropertyName[] xlinkProps, boolean exportSfGeometries) {
	 ...
	 * @throws TransformationException
	 */
	public void export(FeatureCollection fc, QName name) throws XMLStreamException, UnknownCRSException,
	...
	private void export(Feature feature, int inlineLevels) throws XMLStreamException, UnknownCRSException,
			TransformationException {
	 ...
	 * @throws TransformationException
	 */
	protected void export(Property property, int inlineLevels) throws XMLStreamException, UnknownCRSException,
			TransformationException {
	...
	private void export(TypedObjectNode genericXML, int inlineLevels) throws XMLStreamException, UnknownCRSException,
			TransformationException {
	...
	private void writeStartElementWithNS(String namespaceURI, String localname) throws XMLStreamException {
		if (namespaceURI == null || namespaceURI.length() == 0) {
			writer.writeStartElement(localname);
		} else {
	...
	private void writeEmptyElementWithNS(String namespaceURI, String localname) throws XMLStreamException {
		if (namespaceURI == null || namespaceURI.length() == 0) {
