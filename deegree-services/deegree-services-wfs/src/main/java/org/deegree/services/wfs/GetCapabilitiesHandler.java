...
class GetCapabilitiesHandler extends OWSCapabilitiesXMLAdapter {
	...
	/**
	 * Produces a <code>WFS_Capabilities</code> document compliant to the specified WFS
	 * version.
	 * @throws XMLStreamException
	 * @throws IllegalArgumentException if the specified version is not 1.0.0, 1.1.0 or
	 * 2.0.0
	 */
	...
	/**
	 * Produces a <code>WFS_Capabilities</code> document that complies to the WFS 1.0.0
	 * specification.
	 * @throws XMLStreamException
	 */
	...
	private void exportGetDCPType100(String getURL) throws XMLStreamException {
	...
	private void exportPostDCPType100(String postURL) throws XMLStreamException {
		if (postURL != null) {
			writer.writeStartElement(WFS_NS, "DCPType");
			writer.writeStartElement(WFS_NS, "HTTP");
	...
	/**
	 * Produces a <code>WFS_Capabilities</code> document that complies to the WFS 1.1.0
	 * specification.
	 * @throws XMLStreamException
	 */
	void export110() throws XMLStreamException {
		...
		if (sections == null || sections.contains("OPERATIONSMETADATA")) {
			...
			if (enableTransactions) {
				...
				params.add(new Domain("idgen",
						Arrays.asList(new String[] { "GenerateNew", "UseExisting", "ReplaceDuplicate" })));
	...
	private void writeOutputFormats110(XMLStreamWriter writer) throws XMLStreamException {
	...
	/**
	 * Produces a <code>WFS_Capabilities</code> document that complies to the WFS 2.0.0
	 * specification.
	 * @throws XMLStreamException
	 */
	void export200() throws XMLStreamException {
		...
		if (sections == null || sections.contains("OPERATIONSMETADATA")) {
			...
			if (master.getStoredQueryHandler().isManagedStoredQuerySupported()) {
				...
				createStoredQueryParams.add(new Domain("language",
						Collections.singletonList("urn:ogc:def:queryLanguage:OGC-WFS::WFSQueryExpression")));
	...
	private void addOperation(WFSRequestType wfsRequestType, List<Domain> params, List<DCP> getAndPost, List<DCP> post,
			List<DCP> get, List<Operation> operations) {
	...
	private void writeOutputFormats200(XMLStreamWriter writer) throws XMLStreamException {
