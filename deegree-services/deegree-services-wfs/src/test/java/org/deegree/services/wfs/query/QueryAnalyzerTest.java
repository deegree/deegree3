...
public class QueryAnalyzerTest {
	...
	@Test
	public void testQueryAnalyzer() throws Exception {
	...
	private org.deegree.protocol.wfs.query.Query createQueryCadastralZoning() throws UnknownCRSException {
	...
	private org.deegree.protocol.wfs.query.Query createQueryAdministrativeUnit() throws UnknownCRSException {
	 ...
	 * xmlns:gml="http://www.opengis.net/gml/3.2" xsi:
	 * schemaLocation="http://www.opengis.net/wfs/2.0 http://schemas.opengis.net/wfs/2.0/wfs.xsd"
	 * xmlns:de.hh.up="https://registry.gdi-de.org/id/de.hh.up"> <wfs:Query
	 * typeNames="de.hh.up:ortsteile">
	 * <wfs:PropertyName>de.hh.up:bezirk_name</wfs:PropertyName>
	 * <wfs:PropertyName>de.hh.up:stadtteil</wfs:PropertyName>
	 * <wfs:PropertyName>de.hh.up:ortsteilnummer</wfs:PropertyName>
	 * <wfs:PropertyName>de.hh.up:bezirk</wfs:PropertyName>
	 * <wfs:PropertyName>de.hh.up:ags</wfs:PropertyName> <fes:Filter> <fes:Intersects>
	 * <fes:ValueReference>de.hh.up:geom</fes:ValueReference> <gml:Point
	 * srsName="EPSG:4326"> <gml:pos>10.041668189056937 53.54036348655801</gml:pos>
	 * </gml:Point> </fes:Intersects> </fes:Filter> </wfs:Query> <wfs:Query
	 * typeNames="de.hh.up:pk_grenzen">
	 * <wfs:PropertyName>de.hh.up:polizeirevier</wfs:PropertyName>
	 * <wfs:PropertyName>de.hh.up:pk</wfs:PropertyName> <fes:Filter> <fes:Intersects>
	 * <fes:ValueReference>de.hh.up:geom</fes:ValueReference> <gml:Point
	 * srsName="EPSG:4326"> <gml:pos>10.041668189056937 53.54036348655801</gml:pos>
	 * </gml:Point> </fes:Intersects> </fes:Filter> </wfs:Query> </wfs:GetFeature>
	 */
