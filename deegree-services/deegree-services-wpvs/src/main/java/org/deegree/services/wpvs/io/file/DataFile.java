...
public class DataFile<T extends PositionableModel> {
	 ...
	 * @throws IOException
	 */
	public DataObjectInfo<T> get(long position) throws IOException {
	 ...
	 * @throws IOException
	 */
	public long add(DataObjectInfo<T> object) throws IOException {
		...
		if (!addedData.isEmpty()) {
			...
			if (!channel.isOpen()) {
				throw new IOException(
						"Could not open file: " + dataFile + " for writing all information will be lost.");
			}
