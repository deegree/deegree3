...
public class WROSerializer extends ObjectSerializer<WorldRenderableObject> {
	...
	private void writeEnvelope(DataOutputStream out, Envelope env) throws IOException {
	 ...
	 * @param doi to be serialized with a {@link DataOutputStream}
	 ...
	 * @throws IOException
	 */
	private WorldRenderableObject readWRO(DataInputStream in) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void write(WorldRenderableObject wro, DataOutputStream out) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void write(RenderableQualityModel rqm, DataOutputStream out) throws IOException {
	 ...
	 * @throws IOException
	 */
	private RenderableQualityModel readQualityModel(DataInputStream in) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void write(PrototypeReference prototypeReference, DataOutputStream out) throws IOException {
	 ...
	 * @throws IOException
	 */
	private PrototypeReference readPrototypeReference(DataInputStream in) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void write(RenderableQualityModelPart rqmp, DataOutputStream out) throws IOException {
		if (rqmp != null) {
	 ...
	 * @throws IOException
	 */
	private RenderableQualityModelPart readRenderableQMPart(DataInputStream in) throws IOException {
		int type = in.readInt();
	 ...
	 * @throws IOException
	 */
	private void writeStyle(SimpleGeometryStyle style, DataOutputStream out) throws IOException {
		if (style != null) {
	 ...
	 * @throws IOException
	 */
	private SimpleGeometryStyle readStyle(DataInputStream in) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void writePlainGeometry(RenderableGeometry renderableGeometry, DataOutputStream out) throws IOException {
	...
	private void writeTexturedGeometry(RenderableTexturedGeometry renderableTexturedGeometry, DataOutputStream out)
		...
		FloatBuffer fb = getBuffer(renderableTexturedGeometry.getTextureCoordinates(),
				renderableTexturedGeometry.getTexturePosition(), renderableTexturedGeometry.getTextureOrdinateCount(),
				VertexType.TextureCoordinates);
