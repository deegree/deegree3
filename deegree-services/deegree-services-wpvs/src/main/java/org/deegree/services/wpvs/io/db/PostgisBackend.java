...
public class PostgisBackend extends DBBackend<PGgeometry> {
	...
	/**
	 * @param connectionID pointing to the configured database connection.
	 * @param type
	 */
	...
	@Override
	protected Envelope getDatasetEnvelope(Connection con, String tableName, String geomColumn) throws SQLException {
