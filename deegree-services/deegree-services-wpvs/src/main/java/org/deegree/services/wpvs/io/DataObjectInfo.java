...
/**
 * The <code>DataObjectInfo</code> class wraps the information needed to fill the backend
 * into one class.
 *
...
public class DataObjectInfo<P extends PositionableModel> {
	...
	/**
	 * @param insertedOrdinates the insertedOrdinates to set
	 */
	...
	/**
	 * @param insertedTextureOrdinates the insertedTextureOrdinates to set
	 */
