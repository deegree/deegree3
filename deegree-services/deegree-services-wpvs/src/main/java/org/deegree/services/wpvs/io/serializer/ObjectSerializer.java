...
public abstract class ObjectSerializer<T extends PositionableModel> {
	...
	/**
	 * Returns the size of the object after serialization, without the header information,
	 * just the fields.
	 * @param object to get the size from
	...
	/**
	 * Writes the default header, consisting of the totalSize, id and the
	 * currentTimeMillis().
	 * @param buffer
	 * @param object to write the header from.
	 */
	...
	/**
	 * Returns the size of the object after serialization, with the header information and
	 * the fields.
	 * @param object to get the size from
	...
	/**
	 * Read the creation time of this object and reset the position to it's start
	 * position.
	 * @param buffer to read from
	...
	/**
	 * Read the size of the serialized object and reset the position to it's start
	 * position.
	 * @param buffer to read from
	 ...
	 * @param doi to be serialized with the {@link ObjectOutputStream}
