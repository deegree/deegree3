 ...
 * <p>
 * A {@link ProcessletInput} instance is always one of the following:
 * <ul>
 * <li>{@link LiteralInput}: Literal data of a simple quantity (e.g., one number) with optional UOM (unit-of-measure)
 * information.</li>
 * <li>{@link BoundingBoxInput}: A spatial {@link Envelope}.</li>
 * <li>{@link ComplexInput}: A complex parameter (e.g. a data structure encoded in XML or a raw stream).</li>
 * </ul>
 * </p>
 *
