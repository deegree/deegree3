...
/**
 * The <code>ValueType</code> annotates the value of a literal input parameter. It can either be a value or a range.
 * <p>
...
public @interface ValueType {
    ...
    public Range range() default @Range(minimum = NOT_SET, maximum = NOT_SET, spacing = NOT_SET);
}
