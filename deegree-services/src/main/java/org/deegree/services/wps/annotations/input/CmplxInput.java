...
/**
 * The <code>ComplexOutput</code> annotates an input parameter of {@link Type#Complex}.
 * <p>
 * Note: The name of this annotation is slightly 'un-Java', this way it won't interfere with
 * {@link org.deegree.services.wps.input.ComplexInput}
 * <p>
...
public @interface CmplxInput {
    ...
    public double maximumMegabytes() default 1;
