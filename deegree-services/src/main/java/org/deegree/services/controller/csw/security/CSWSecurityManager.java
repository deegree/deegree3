...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package org.deegree.services.controller.csw.security;
...
public interface CSWSecurityManager {
     ...
     * @param creds
     * @param isSoap
     * @return {@link GetCapabilities}
     * @throws SecurityException
     */
    GetCapabilities preprocess( GetCapabilities getCapabilities, Credentials creds, boolean isSoap )
                            throws SecurityException;
