...
/**
 * Wraps the execution of the CITE SOS 1.0.0 TestSuite as a JUnit-test suite.
 * 
...
public class SOSCite100IT {
    ...
    private String testLabel = "SOS100";
    ...
    private static Collection getResultSnippets( String out )
        ...
        while ( currentLine < lines.size() ) {
            ...
            if ( trimmed.startsWith( "Testing" ) && trimmed.endsWith( "..." ) && !trimmed.startsWith( "Testing suite" ) ) {
