...
%>
                ...
                <textarea name="xmlarea" cols="120" rows="10"></textarea> <br /><br/> 
                  <table>
                  <tr>
                <td><input name="host" size="50" type="text" value="<%=targetURL%>" /></td>
            <td>Username: <input name="username" size="20" type="text" value="" /></td> 
            </tr>
            <tr>
            <td><input value="SEND" onclick="postRequest ()" type="button" /></td>
            <td>Password: <input name="password" size="20" type="password" value="" /></td>
            </tr>
                </table>
            </form>
