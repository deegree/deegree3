...
public class ExecuteResponse {
	 ...
	 * @param statusLocation location where updated ExecuteResponse documents can be
	 * polled from or null if the response document should not be stored as a
	 * web-accessible resource
	 * @param serviceInstance GetCapabilities URL of the service that produced the request
	 * @param status execution status of the process
	 * @param outputDefinitions
	 * @param outputs outputs produced by the process
	 * @param request
	 */
	public ExecuteResponse(StorageLocation statusLocation, URL serviceInstance, ProcessExecution status,
			List<RequestedOutput> outputDefinitions, ProcessletOutputs outputs, ExecuteRequest request) {
	...
	/**
	 * Returns whether the inputs and requested outputs should be included in the response
	 * document.
