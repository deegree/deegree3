...
/**
 * The <code>OutputParameter</code> annotates an output parameter of a process.
 * <p>
...
public @interface OutputParameter {
    ...
    public LitOutput literal() default @LitOutput(dataType = @ReferenceType);

    /** if type is {@link Type#Complex}, this value should be set. */
    public CmplxOutput complex() default @CmplxOutput(formats={});
