...
/**
 * Responsible for the generation of WPS ExecuteResponse documents from
 * {@link ExecuteResponse} objects.
 *
 * @see ExecuteResponse
...
public class ExecuteResponseXMLWriter extends XMLAdapter {
	 ...
	 * @param writer writer where the XML is written to
	 * @param response object to be exported
	...
	private static void exportDataInputs(XMLStreamWriter writer, ExecuteResponse response) throws XMLStreamException {
	...
	private static void exportStatus(XMLStreamWriter writer, ProcessExecution state) throws XMLStreamException {
		...
		if (creationTime == -1) {
			// use creation time of document if process execution has not been finished
			// yet
	...
	private static void exportXMLOutput(XMLStreamWriter writer, ComplexOutputImpl output) throws XMLStreamException {
		...
		// NOTE: Providing the encoding attribute doesn't make any sense for inline XML
		// output (always defined by the
	...
	private static void exportBinaryOutput(XMLStreamWriter writer, ComplexOutputImpl output) throws XMLStreamException {
