...
public class InputReference {
	...
	/**
	 * Creates a new {@link InputReference} that points to a web accessible resource which
	 * can be retrieved using a simple HTTP Get operation.
	 * @param href http url of the resource
	...
	/**
	 * Creates a new {@link InputReference} that points to a web accessible resource which
	 * can be retrieved using a HTTP Post operation (post body is specified as an
	 * {@link OMElement}).
	 * @param href http url of the resource
	 * @param headers extra headers to be sent with the request
	 * @param postBodyElement element that encapsulates the post body
	 */
	 ...
	 * @param href http url of the resource
	 * @param headers extra headers to be sent with the request
	 * @param postBodyReference URL of the post body content
	 */
	 ...
	 * @throws IOException if accessing the referenced content fails
	 */
