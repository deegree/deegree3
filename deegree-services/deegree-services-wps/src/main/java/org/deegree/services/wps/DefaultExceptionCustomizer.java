...
public class DefaultExceptionCustomizer implements ExceptionCustomizer {
	 ...
	 * @param processId of the process this exception customizer is used for.
	 */
	...
	public OWSException mutualExclusive(String parameter, String excludes) {
		return new OWSException(
				processMsg + ": given parameters '" + parameter + "' and '" + excludes + "' are mutually exclusive.",
	...
	public OWSException inputEvalutationNotSupported(CodeType inputParameterId, Pair<String, String> kvp,
			String explanation) {
		String msg = "Evaluating " + kvp + " for input parameter '" + inputParameterId + "' is not supported, because: "
				+ explanation;
		return new OWSException(msg, OWSException.INVALID_PARAMETER_VALUE, inputParameterId.toString());
	...
	public OWSException inputInvalidOccurrence(CodeType inputParameterId, int minOccurs, int maxOccurs,
		...
		msg.append("Input parameter '")
			.append(inputParameterId)
			.append("' is present ")
			.append(actualOccurs)
			.append(" times, ");
	...
	public OWSException inputMissingParameters(CodeType inputParameterId, String... parameters) {
		return new OWSException(processMsg + " missing parameters for input" + inputParameterId
				+ ". At least one of following parameters is required but missing: " + Arrays.toString(parameters)
