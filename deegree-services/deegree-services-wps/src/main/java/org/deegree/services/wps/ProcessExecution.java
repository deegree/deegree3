...
public class ProcessExecution implements ProcessletExecutionInfo {
	...
	/**
	 * Creates a new {@link ProcessExecution} for a {@link Processlet} that has been
	...
	/**
	 * Returns the percentage of process that has been completed, where 0 means the
	 * process has just started, and 99 means the process is almost complete. This value
	...
	/**
	 * Returns optional additional human-readable text associated with the acceptance of
	...
	/**
	 * Returns optional additional human-readable text associated with the starting of the
	 * process execution.
	 * @return optional additional human-readable text, null if it is not available
	 */
	 ...
	 * @return the time when the process execution has been started (in milliseconds) or
	 ...
	 * @return the time that the process execution has been finished (in milliseconds) or
	 * -1 if the process has not been finished yet
	 */
	...
	/**
	 * Returns optional additional human-readable text associated with the pausing of the
	 * process execution.
	 * @return optional additional human-readable text, null if it is not available
	 */
	...
	/**
	 * Returns optional additional human-readable text associated with the successful
	 * finishing of the process execution.
	 * @return optional additional human-readable text, null if it is not available
	 */
	...
	/**
	 * Returns the exception that describes the reason for the failure of the process
	 * execution.
	 * @return the exception that describes the reason for the failure of the process
	 * execution.
	 */
	 ...
	 * @param msg additional human-readable client information, may be null
	 */
	 ...
	 * @param e exception that describes the reason for the failure
	 */
