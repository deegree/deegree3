...
/**
 * Represents an input or output parameter from a KVP Execute request with optional value
 * and attributes.
 *
...
class AttributedParameter {
	...
	/**
	 * Creates a new {@link AttributedParameter} from its string representation (as
	 * specified in section 10.2.2.1 of OGC 05-007r7).
	 * @param s encoded input or output parameter
	 * @return corresponding {@link AttributedParameter}
	 * @throws IllegalArgumentException if the format is invalid
	 */
	static AttributedParameter valueOf(String s) throws IllegalArgumentException {
