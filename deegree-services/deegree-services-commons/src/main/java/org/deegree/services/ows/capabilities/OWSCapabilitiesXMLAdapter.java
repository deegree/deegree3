...
public class OWSCapabilitiesXMLAdapter extends OWSCommonXMLAdapter {
	...
	/**
	 * Exports the given {@link ServiceIdentificationType} as an OWS 1.0.0
	 * <code>ServiceIdentification</code> element.
	 * @param writer used to append the XML, must not be <code>null</code>
	 * @param serviceIdentification configuration object that provides most of the
	 * required metadata, must not be <code>null</code>
	 * @param serviceName OGC-style abbreviation of the service, e.g. WFS, must not be
	 * <code>null</code>
	 * @param serviceVersions supported protocol versions, must not be <code>null</code>
	 * and contain at least one entry
	 * @throws XMLStreamException if writing the XML fails
	 */
	public static void exportServiceIdentification100(XMLStreamWriter writer,
			ServiceIdentification serviceIdentification, final String serviceName, final List<Version> serviceVersions)
		...
		if (serviceIdentification.getKeywords() != null) {
			for (Pair<List<LanguageString>, org.deegree.commons.tom.ows.CodeType> keywords : serviceIdentification
				.getKeywords()) {
	...
	/**
	 * Exports the given {@link ServiceIdentificationType} as an OWS 1.1.0
	 * <code>ServiceIdentification</code> element.
	 * @param writer used to append the XML, must not be <code>null</code>
	 * @param serviceID configuration object that provides most of the required metadata,
	...
	public static void exportServiceIdentification110New(XMLStreamWriter writer, ServiceIdentification serviceID,
			final String serviceName, final List<Version> serviceVersions) throws XMLStreamException {
		...
		if (serviceVersions == null || serviceVersions.isEmpty()) {
			LOG.warn(
					"Service versions name may not be null, wrong call to exportServiceIdentification110, setting to unknown");
	...
	public static void exportKeyWords110New(XMLStreamWriter writer,
			List<Pair<List<LanguageString>, org.deegree.commons.tom.ows.CodeType>> list) throws XMLStreamException {
	...
	/**
	 * Exports a {@link ServiceProviderType} as an OWS 1.0.0 <code>ServiceProvider</code>
	 * element.
	 * @param writer writer to append the xml
	 * @param serviceProvider <code>ServiceProviderType</code> to export
	 * @throws XMLStreamException
	 */
	...
	/**
	 * Exports a {@link ServiceProviderType} as an OWS 1.1.0 <code>ServiceProvider</code>
	 * element.
	 * @param writer writer to append the xml
	 * @param serviceProvider <code>ServiceProviderType</code> to export
	 * @throws XMLStreamException
	...
	/**
	 * Exports a {@link ServiceProviderType} as an OWS 1.1.0 <code>ServiceProvider</code>
	 * element. Validated against ows schema by rb at 23.02.2009.
	 * @param writer writer to append the xml
	 * @param serviceProvider <code>ServiceProviderType</code> to export
	 * @throws XMLStreamException
	 */
	...
	/**
	 * Exports the {@link OperationsMetadata} as an OWS 1.0.0
	 * <code>OperationsMetadata</code> element.
	 * @param writer writer to append the xml, must not be <code>null</code>
	 * @param operationsMd operations metadata, must not be <code>null</code>
	 * @throws XMLStreamException
	 */
	public static void exportOperationsMetadata100(XMLStreamWriter writer, OperationsMetadata operationsMd)
		...
		for (Operation operation : operationsMd.getOperation()) {
			...
			// <element name="Parameter" type="ows:DomainType" minOccurs="0"
			// maxOccurs="unbounded">
	...
	/**
	 * Exports an {@link OperationsMetadata} instance as an OWS 1.1.0
	 * <code>OperationsMetadata</code> element.
	 * @param writer writer to append the xml, must not be <code>null</code>
	 * @param operationsMd operations metadata, must not be <code>null</code>
	 * @throws XMLStreamException
	 ...
	 * <p>
	 * The namespace of the produced elements is given as a parameter so it is usable for
	 * different OWS versions. It has been checked that this method produces the correct
	 * output for the following OWS versions/namespaces:
	 * </p>
	 * <table border="1">
	 * <tr>
	 * <th>OWS version</th>
	 ...
	 * </table>
	 * @param writer writer to append the xml
	 * @param serviceProvider metadata to export
	 * @param owsNS namespace for the generated elements
	 * @throws XMLStreamException
	 */
	...
	private static void exportVersions(XMLStreamWriter writer, List<Version> versions, String owsNS,
			String versionElementName) throws XMLStreamException {
	 ...
	 * </table>
	 * @param writer writer to append the xml
	 * @param serviceContact <code>ServiceContactType</code> to export
	 * @param owsNS namespace for the generated elements
	 * @throws XMLStreamException
	 */
	 ...
	 * </table>
	 * @param writer writer to append the xml
	 * @param party <code>ResponsibleParty</code> to export
	 * @param owsNS namespace for the generated elements
	 * @throws XMLStreamException
	 */
	 ...
	 * </table>
	 * @param writer writer to append the xml
	 * @param dcp <code>DCPType</code> to export
	 * @param owsNS namespace for the generated elements
	 * @throws XMLStreamException
	 */
	public static void exportDCP(XMLStreamWriter writer, DCP dcp, String owsNS) throws XMLStreamException {
	...
	private static void exportCodeTypeNew(XMLStreamWriter writer, org.deegree.commons.tom.ows.CodeType codeType,
			String localName, String owsNS) throws XMLStreamException {
		if (codeType != null) {
	...
	private static void exportLanguageStringType(XMLStreamWriter writer, LanguageStringType lst, String localName,
			String owsNS) throws XMLStreamException {
	 ...
	 * @param writer
	 * @param strings to export
	 * @param owsNS the name space to use
	...
	public static void exportDomainType100(XMLStreamWriter writer, Domain domain) throws XMLStreamException {
	...
	public static void exportDomainType110(XMLStreamWriter writer, Domain domain) throws XMLStreamException {
	...
	private static void exportExtendedCapabilities(XMLStreamWriter writer, QName extendedCapabilities,
			OperationsMetadata operationsMd) throws XMLStreamException {
