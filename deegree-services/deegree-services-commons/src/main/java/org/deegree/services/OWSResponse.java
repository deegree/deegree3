 ...
 * <p>
 * This is similar to {@link HttpServletResponse}, but reduces potential pitfalls and offers specific functionality
 * that's common for {@link OWS} implementations.
 * </p>
 * <p>
 * Special functionality:
 * <ul>
 * <li><b>Buffering</b>: By default, output is buffered and only sent to the client when {@link #commit()} is called.
 ...
 * Alternatively, buffering can be disabled by calling {@link #disableBuffering()} to turn of buffering overhead.</li>
 * <li><b>XML output</b>: Convenience methods for getting an {@link XMLStreamWriter}.</li>
 * <li><b>Transparent compression</b>: If the client supports it (and the mime type of the output is suitable for this),
 * output is automatically written in gzipped form.</li>
 * <li><b>Logging</b>:</li>
 * </ul>
 * </p>
 * 
...
public class OWSResponse {
     ...
     * <p>
     * This method may only be called, if neither {@link #getOutputStream(String))} nor {@link #getXMLStream(String))}
     ...
     * 
     * @param contentType
     *            mime type of the response content, can be <code>null</code>
     * @return
     * @throws IOException
     ...
     * <p>
     * {@link OWS} implementation should never call this, as it is called by the {@link OGCFrontController}.
     * </p>
     * 
     * @throws IOException
     */
     ...
     * <p>
     * This is only possible if the response has not been committed yet and buffering is enabled.
     * </p>
     * 
     * @throws IllegalStateException
     */
