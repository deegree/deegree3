...
* ``DisabledResources``: When a feature is imported all xlink:href attribute references are resolved. By configuring one or multiple base URL patterns all references starting with those patterns are not resolved.
