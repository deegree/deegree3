...
Most of the functions are currently described in the _wiki, but new ones will be described here (the descriptions from the wiki will be ported soon TODO TODO).
