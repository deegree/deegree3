...
by schema file http://schemas.deegree.org/proxy/3.4.0/proxy.xsd. The
...
[source,xml]
----
<ProxyConfiguration configVersion="3.4.0"
                    xmlns="http://www.deegree.org/proxy"
                    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                    xsi:schemaLocation="http://www.deegree.org/proxy http://schemas.deegree.org/proxy/3.4.0/proxy.xsd"
