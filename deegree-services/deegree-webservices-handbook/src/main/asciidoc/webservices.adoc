...
<deegreeWFS
  ...
  http://schemas.deegree.org/core/3.5/services/wfs/wfs_configuration.xsd">
...
http://schemas.deegree.org/core/3.5/services/wfs/wfs_configuration.xsd. The
...
<deegreeWMTS
  ...
  http://schemas.deegree.org/core/3.5/services/wmts/wmts.xsd">
...
http://schemas.deegree.org/core/3.5/services/wmts/wmts.xsd. The root
...
<GeoTIFFTileMatrixSet   xmlns="http://www.deegree.org/datasource/tile/tilematrixset/geotiff"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xsi:schemaLocation="http://www.deegree.org/datasource/tile/tilematrixset/geotiff http://schemas.deegree.org/core/3.5/datasource/tile/tilematrixset/geotiff/geotiff.xsd">
...
<GeoTIFFTileStore xmlns="http://www.deegree.org/datasource/tile/geotiff"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xsi:schemaLocation="http://www.deegree.org/datasource/tile/geotiff http://schemas.deegree.org/core/3.5/datasource/tile/geotiff/geotiff.xsd">
    <TileDataSet>
...
<TileLayers xmlns="http://www.deegree.org/layers/tile"
           ...
           xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
           xsi:schemaLocation="http://www.deegree.org/layers/tile http://schemas.deegree.org/core/3.5/layers/tile/tile.xsd">
 <TileLayer>
...
xmlns:d="http://www.deegree.org/metadata/description"
xmlns:s="http://www.deegree.org/metadata/spatial"
xsi:schemaLocation="http://www.deegree.org/themes/standard http://schemas.deegree.org/core/3.5/themes/themes.xsd">
...
<deegreeWMTS xmlns="http://www.deegree.org/services/wmts"
            xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
            xsi:schemaLocation="http://www.deegree.org/services/wmts http://schemas.deegree.org/core/3.5/services/wmts/wmts.xsd">
...
<CachingTileStore xmlns="http://www.deegree.org/datasource/tile/cache"
                 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                 xsi:schemaLocation="http://www.deegree.org/datasource/tile/cache http://schemas.deegree.org/core/3.5/datasource/tile/cache/cache.xsd">
...
<deegreeCSW
  ...
  http://schemas.deegree.org/core/3.5/services/csw/csw_configuration.xsd">
</deegreeCSW>
----
...
http://schemas.deegree.org/core/3.5/services/csw/csw_configuration.xsd. The
...
<deegreeWPS xmlns="http://www.deegree.org/services/wps" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  xsi:schemaLocation="http://www.deegree.org/services/wps http://schemas.deegree.org/core/3.5/services/wps/wps_configuration.xsd">
</deegreeWPS>
----
...
http://schemas.deegree.org/core/3.5/services/wps/wps_configuration.xsd. The
...
<deegreeServicesMetadata xmlns="http://www.deegree.org/services/metadata"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  xsi:schemaLocation="http://www.deegree.org/services/metadata http://schemas.deegree.org/core/3.5/services/metadata/metadata.xsd">
...
http://schemas.deegree.org/core/3.5/services/metadata/metadata.xsd. The
