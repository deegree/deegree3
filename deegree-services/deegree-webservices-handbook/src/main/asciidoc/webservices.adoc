...
The GetFeature operation allows to specify the properties to include in the response by the element PropertyName, e.g. (WFS 2.0.0):
...
This is limited to simple XPath expression, where each step is a qualified name.
