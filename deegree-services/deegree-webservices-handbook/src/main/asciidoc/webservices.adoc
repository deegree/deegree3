...
http://schemas.deegree.org/3.5/services/wfs/wfs_configuration.xsd. The
...
http://schemas.deegree.org/3.5/services/wmts/wmts.xsd. The root
...
http://schemas.deegree.org/3.5/services/csw/csw_configuration.xsd. The
...
http://schemas.deegree.org/3.5/services/wps/wps_configuration.xsd. The
...
http://schemas.deegree.org/3.5/services/metadata/metadata.xsd. The
