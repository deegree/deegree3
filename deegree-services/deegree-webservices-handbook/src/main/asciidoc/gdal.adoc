...
NOTE: deegree uses version 3.5 of the GDAL jar file.
...
<GDALTileStore
  ...
  xsi:schemaLocation="http://www.deegree.org/datasource/tile/gdal http://schemas.deegree.org/3.5/datasource/tile/gdal/gdal.xsd">
  <TileDataSet>
