...
<DataSourceConnectionProvider
  ...
  xsi:schemaLocation="http://www.deegree.org/connectionprovider/datasource http://schemas.deegree.org/core/3.5/connectionprovider/datasource/datasource.xsd">
...
http://schemas.deegree.org/core/3.5/connectionprovider/datasource/datasource.xsd. The
...
http://schemas.deegree.org/core/3.5/jdbc/jdbc.xsd. The root element is
