...
If you are confused by the two options and unsure which version to pick,
...
image:images/terminal.png[deegree webservices starting
up,scaledwidth=50.0%]

Tip

If you don't see this terminal window, make sure that the `+java+`
...
If you want to run deegree webservices on system startup automatically,
...
If you are running Apache Tomcat we recommend that you read and apply
...
If you are running Apache Tomcat read the
...
The deegree console provides access to the server file system. Therefore
