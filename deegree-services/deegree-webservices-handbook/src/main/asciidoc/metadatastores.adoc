...
<ISOMemoryMetadataStore
  ...
  xsi:schemaLocation="http://schemas.deegree.org/core/3.5/datasource/metadata/iso19139/memory/memory.xsd">
...
<ISOMetadataStore
  ...
  http://schemas.deegree.org/core/3.5/datasource/metadata/iso19115/iso19115.xsd">
