...
public class Capabilities100XMLAdapter extends XMLAdapter {
	 ...
	 * @param request
	 * @param xmlWriter
	 * @param sections the capabilities sections to export
	 * @param coverages all coverages of this WCS web service
	 * @param serviceMetadata metadata for the service
	 * @param mainConf
	 * @param writer
	 * @param updateSequence of this wcs
	 * @throws XMLStreamException
	 */
	public static void export(XMLStreamWriter xmlWriter, GetCapabilities request,
			ServiceIdentificationType identification, ServiceProviderType provider, List<String> allowedOperations,
			Set<Sections> sections, List<WCSCoverage> coverages, DeegreeServicesMetadataType serviceMetadata,
			DeegreeServiceControllerType mainConf, XMLStreamWriter writer, int updateSequence)
			throws XMLStreamException {
	...
	private static void exportContentMetadata(XMLStreamWriter writer, List<WCSCoverage> coverages, int updateSequence,
			boolean isSection) throws XMLStreamException {
	...
	private static void exportCoverage(XMLStreamWriter writer, WCSCoverage coverage) throws XMLStreamException {
		if (coverage != null) {
	...
	private static void exportService(XMLStreamWriter writer, ServiceIdentificationType identification,
			ServiceProviderType provider, int updateSequence, boolean isSection) throws XMLStreamException {
	...
	private static void exportResponsibleParty(XMLStreamWriter writer, ServiceContactType serviceContactType,
			String providerName) throws XMLStreamException {
		if (serviceContactType != null) {
			...
			if (serviceContactType.getAddress() != null || !isEmpty(serviceContactType.getPhone())
					|| !isEmpty(serviceContactType.getFacsimile())
					|| !isEmpty(serviceContactType.getOnlineResource())) {
				// -> contactInfo[0,1]
	 ...
	 * @throws XMLStreamException
	 */
	public static void exportMetadataLink(XMLStreamWriter writer, String type, String link) throws XMLStreamException {
	 ...
	 * @throws XMLStreamException
	 */
	public static void exportKeyword(XMLStreamWriter writer, LanguageStringType lst) throws XMLStreamException {
		if (lst != null) {
	 ...
	 * @throws XMLStreamException
	 */
	public static void exportCodeType(XMLStreamWriter writer, CodeType ct) throws XMLStreamException {
		if (ct != null) {
