 ...
 * <p>
 * This class represents the main entry point for access to coverages. You can create a
 * WCService with the static createService methods that takes a service configuration (see
 * resources/schema/wcs/wcs_configuration.xsd and
 * resources/schema/example/conf/wcs/wcs_configuration.xml). An WCService contains one or
