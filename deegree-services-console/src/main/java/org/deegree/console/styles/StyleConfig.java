...
public class StyleConfig extends ManagedXMLConfig {
    ...
    public StyleConfig( String id, boolean active, boolean ignore, StyleConfigManager manager, URL schemaUrl ) {
        super( id, active, ignore, manager, schemaUrl, CONFIG_TEMPLATE );
    }
