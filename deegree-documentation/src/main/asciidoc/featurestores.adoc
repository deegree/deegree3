...
<ShapeFeatureStore
  ...
  https://schemas.deegree.org/core/3.5/datasource/feature/shape/shape.xsd">
...
<SQLFeatureStore
  ...
  https://schemas.deegree.org/core/3.5/datasource/feature/sql/sql.xsd">
...
image::console_setup_tables1.png[Feature store resources provide access to geo objects,scaledwidth=80.0%]

Once you clicked the *Setup tables* link, a preview of the generated SQL script will be presented. In order to execute the SQL script, click the link *Execute*:

image::console_setup_tables2.png[Feature store resources provide access to geo objects,scaledwidth=80.0%]

The SQL statements will now be executed against your database and the tables will be created:

image::console_setup_tables3.png[Feature store resources provide access to geo objects,scaledwidth=80.0%]

Next, reinitialize the other workspace resources by clicking *Reload* next to your active workspace. If there are no error
messages showing, the execution of the SQL script using *Setup tables* was successful!
