...
Using the vendorspecific parameter CQL2_FILTER a more complex expression can be used to filter the underlying data source. The CQL2_FILTER supports T_AFTER and S_INTERSECTS. Examples:
----
