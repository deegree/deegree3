...
[source,xml]
----
<MultiResolutionRaster xmlns="http://www.deegree.org/datasource/coverage/raster" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.deegree.org/datasource/coverage/raster https://schemas.deegree.org/core/3.6/datasource/coverage/raster/raster.xsd" originLocation="outer">
  <StorageCRS>EPSG:26912</StorageCRS>
  <Resolution>
