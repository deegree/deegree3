...
<ProcessDefinition processVersion="1.0.0" xmlns="http://www.deegree.org/processes/java"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.deegree.org/processes/java https://schemas.deegree.org/core/3.5/processes/java/java.xsd">
...
sent using deegree's generic client.
...
of occurrences, type) and respond with an _ExceptionReport_ if the
...
(https://schemas.deegree.org/core/3.5/processes/java/java.xsd).
...
<FMEServer xmlns="http://www.deegree.org/processes/fme" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
           xsi:schemaLocation="http://www.deegree.org/processes/fme https://schemas.deegree.org/core/3.5/processes/fme/fme.xsd">
