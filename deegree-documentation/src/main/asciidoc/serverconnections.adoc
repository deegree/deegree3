...
<DataSourceConnectionProvider
  ...
  xsi:schemaLocation="http://www.deegree.org/connectionprovider/datasource https://schemas.deegree.org/core/3.6/connectionprovider/datasource/datasource.xsd">
...
<JDBCConnection xmlns="http://www.deegree.org/jdbc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xsi:schemaLocation="http://www.deegree.org/jdbc https://schemas.deegree.org/core/3.6/jdbc/jdbc.xsd">
