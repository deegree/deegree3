 ...
 */
public class MappingGroup extends MappingElement {

    private List<MappingElement> mappingElements = new ArrayList<MappingElement>();

    public MappingGroup( String formFieldPath, String schemaPath, List<MappingElement> mappingElements ) {
        super( formFieldPath, schemaPath );
