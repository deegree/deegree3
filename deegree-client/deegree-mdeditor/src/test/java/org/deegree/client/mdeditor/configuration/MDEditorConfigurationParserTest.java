...
public class MDEditorConfigurationParserTest extends TestCase {
    ...
    public void testParseConfiguration()
        ...
        assertNotNull( conf.getFormConfigurations() );
        assertEquals( 2, conf.getFormConfigurations().size() );

        FormConfigurationDescription desc = conf.getFormConfigurations().get( 0 );
        assertNotNull( desc );
        ...
        assertNotNull( conf.getGlobalConfigurations() );
        assertEquals( 1, conf.getGlobalConfigurations().size() );
