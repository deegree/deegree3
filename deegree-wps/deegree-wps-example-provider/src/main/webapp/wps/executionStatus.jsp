...
<%-- $HeadURL: svn+ssh://mschneider@svn.wald.intevation.org/deegree/deegree3/trunk/deegree-demos/deegree-wps-demo/src/main/webapp/wps/executionStatus.jsp $
...
<table border="1" cellpadding="3" cellspacing="0">
  ...
  <tr align="center">
    ...
    <td><%=p.getExecutionState() == ExecutionState.SUCCEEDED ? 100
