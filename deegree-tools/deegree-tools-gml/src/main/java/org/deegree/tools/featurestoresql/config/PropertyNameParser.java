...
public class PropertyNameParser {
	...
	/**
	 * Parses the property names from the passed file. The properties are parsed line by
	 * line. Empty lines as well as comments (starting with #) are ignored. Leading and
	 * trailing white spaces are removed.
	 * @param pathToFile the path to the file, never <code>null</code>
	 * @return the parsed properties, may be <code>null</code> if the properties file
