...
public abstract class ModelClass {
     ...
     * @throws IOException
     */
    public void writeImports( BufferedWriter out, Map<QName, FeatureClass> featClasses )
                            throws IOException {
    ...
    protected static void openMethod( Writer out, String access, String returnType, String name,
                                      List<StringPair> params, List<String> thro, boolean override )
                            throws IOException {
        out.write( SP );
        if ( override ) {
            out.write( "@Override\n" );
