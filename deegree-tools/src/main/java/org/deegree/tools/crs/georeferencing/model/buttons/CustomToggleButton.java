 ...
 */
public class CustomToggleButton extends AbstractButton {
    ...
    public CustomToggleButton( int size, String id ) {
        this.size = new Dimension( 10, 5 );
        this.id = id;
        custom = new JRadioButton();
        custom.setName( id );
        customTextField = new JTextField( size );
        customTextField.setName( id );
    }
