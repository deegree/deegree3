...
public class RTBClient {
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            System.err.println( "An Exception occurred while building your raster tree, error message: "
                                + e.getMessage() );
            if ( verbose ) {
                e.printStackTrace();
            }
    ...
    private static void startRTB( RasterTreeBuilder rtb, CommandLine line )
                            ...
                            UnknownCRSException, IOException {
    ...
    private static Options initOptions() {
        ...
        option = new Option( OPT_OUTPUT_TYPE_ABBREV, OPT_OUTPUT_TYPE, true, "the output format (defaults to "
