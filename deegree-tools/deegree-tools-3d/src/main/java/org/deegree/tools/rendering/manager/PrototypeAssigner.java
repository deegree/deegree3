...
public class PrototypeAssigner {
    ...
    private static void startManager( CommandLine line )
        ...
        try {
            ...
            throw new IllegalArgumentException( QL + " may only be a number between 0 and 5: "
        ...
        if ( building != null ) {
            ...
            PrototypeReference pr = new PrototypeReference( prototypeID, rotation,
                                                            new float[] { (float) translation[0],
                                                                         (float) translation[1] }, width, height, depth );
            ...
            DataObjectInfo<WorldRenderableObject> updated = new DataObjectInfo<WorldRenderableObject>(
                                                                                                       buildingID,
                                                                                                       Type.BUILDING.getModelTypeName(),
                                                                                                       building.getName(),
                                                                                                       building.getExternalReference(),
                                                                                                       building.getBbox(),
                                                                                                       building );
