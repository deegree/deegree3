...
/**
 * {@link DiskLayout} implementation for the disk cache used by <a href="http://tilecache.org/">TileCache</a>.
 * <p>
...
public class TileCacheDiskLayout implements DiskLayout {
     ...
     * 
     * @param baseDir
     *            layer directory, must not be <code>null</code>
     * @param fileType
     *            suffix of the tile files (without '.'), must not be <code>null</code>
     */
