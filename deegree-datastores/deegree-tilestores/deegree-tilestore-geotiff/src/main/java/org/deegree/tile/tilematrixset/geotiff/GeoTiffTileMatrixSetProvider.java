...
public class GeoTiffTileMatrixSetProvider extends TileMatrixSetProvider {
    ...
    private static final URL SCHEMA_URL = GeoTiffTileMatrixSetProvider.class.getResource( "/META-INF/schemas/datasource/tile/tilematrixset/3.2.0/geotiff/geotiff.xsd" );
