...
public class SQLFeatureStoreConfigWriter {
    ...
    private static final String SCHEMA_LOCATION = "http://www.deegree.org/datasource/feature/sql http://schemas.deegree.org/core/3.5/datasource/feature/sql/sql.xsd";
