...
/**
 * Provides methods for storing / retrieving {@link GMLObject} instances in binary form,
 * e.g. in BLOBs.
 *
 * TODO improve namespace handling (should not be done for every single blob) TODO get
...
public class BlobCodec {
	 ...
	 * @param gmlVersion gml version to use, must not be <code>null</code>
	 * @param compression compression method to use, must not be <code>null</code>
	 */
	 ...
	 * @param object object to be encoded, must not be <code>null</code>
	 * @param nsContext
	 * @param os output stream to write to, must not be <code>null</code>
	 * @param crs
	...
	public void encode(GMLObject object, final Map<String, String> nsContext, OutputStream os, ICRS crs)
			throws FeatureStoreException, XMLStreamException, FactoryConfigurationError, UnknownCRSException,
	...
	private XMLStreamWriter getXMLWriter(OutputStream os) throws XMLStreamException, IOException {
	 ...
	 * @param is input stream to read from, must not be <code>null</code>
	 * @param nsContext
	...
	public GMLObject decode(InputStream is, Map<String, String> nsContext, AppSchema schema, ICRS crs,
			GMLReferenceResolver idResolver) throws XMLParsingException, XMLStreamException, UnknownCRSException,
