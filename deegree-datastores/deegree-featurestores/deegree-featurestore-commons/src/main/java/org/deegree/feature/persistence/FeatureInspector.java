...
/**
 * Enables the inspection of {@link Feature} instances to be inserted in a
 * {@link FeatureStoreTransaction}.
 * <p>
...
public interface FeatureInspector {
	 ...
	 * @param f feature to be inspected, never <code>null</code>
	 ...
	 * Invokes the inspection of the given {@link Feature}.
	 * @param f feature to be inspected, never <code>null</code>
	 * @param transaction transaction if feature is inspected in context of a
	 * {@link FeatureStoreTransaction}, may be <code>null</null>
	 * @return inspected feature, may be a different or modified instance
	 * @throws GeometryInspectionException if the inspector rejects the {@link Geometry}
	 */
