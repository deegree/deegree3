...
public class EbrimEOMDStoreTransaction implements MetadataStoreTransaction {
	...
	public int performDelete(DeleteOperation operation) throws MetadataStoreException {
		...
		try {
			...
			AbstractWhereBuilder wb = new PostGISWhereBuilder(null,
					new EOPropertyNameMapper(typeNames, useLegacyPredicates), (OperatorFilter) constraint, null, null,
	 ...
	 */
	private void insert(RegistryPackage registryPackage) throws MetadataStoreException {
	...
	private void insertExtrinsicObject(ExtrinsicObject eo, int regPackId, Connection conn) throws SQLException {
	...
	private void insertAssociation(Association association, int regPackId, Connection conn) throws SQLException {
