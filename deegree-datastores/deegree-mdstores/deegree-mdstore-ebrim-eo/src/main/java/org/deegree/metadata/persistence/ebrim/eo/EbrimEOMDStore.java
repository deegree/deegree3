...
public class EbrimEOMDStore implements MetadataStore<RegistryObject> {
    ...
    private MetadataResultSet<RegistryObject> getAdhocQueries( final List<String> idList ) {
        ...
        return new MetadataResultSet<RegistryObject>() {
            ...
            @Override
            public RegistryObject getRecord()
                                    throws MetadataStoreException {
                return current;
            }
    ...
    /**
     * NOTE: Although autoCommit=true disables cursor-based access (streaming), it is currently set for very good
     * reasons: It was found that it can ruin the performance of INNER SELECTs. Ask Andreas P. / Markus before changing
     * this!
     * 
     * @param autoCommit
     * @return
