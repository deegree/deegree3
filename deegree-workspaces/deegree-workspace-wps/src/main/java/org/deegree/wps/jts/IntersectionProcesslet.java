 ...
 *
 */
public class IntersectionProcesslet implements Processlet {
	...
	public void process(ProcessletInputs in, ProcessletOutputs out, ProcessletExecutionInfo info)
		...
		Geometry intersection = geometry1.getIntersection(geometry2);

		ComplexOutput intersectionOutput = (ComplexOutput) out.getParameter("Intersection");
		writeGeometry(intersectionOutput, intersection);
	}
