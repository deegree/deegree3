...
public class ConvexHullProcesslet implements Processlet {
	...
	public void process(ProcessletInputs in, ProcessletOutputs out, ProcessletExecutionInfo info)
		...
		Geometry hulledGeometry = geometry.getConvexHull();

		ComplexOutput hullOutput = (ComplexOutput) out.getParameter("ConvexHull");
		writeGeometry(hullOutput, hulledGeometry);
	}
