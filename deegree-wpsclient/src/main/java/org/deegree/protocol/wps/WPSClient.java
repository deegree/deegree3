...
public class WPSClient {
     ...
     * 
     */
    public WPSClient( URL capabilitiesURL ) throws Exception {
        try {
    ...
    public String executeProcessStringResult(InputObject[] inputobject, String processIdentifier){
        ...
        ProcessExecution processExecution = new ProcessExecution(getProcessInfo(processIdentifier).getProcessDescription());
    ...
    public InputObject setInputasFile(String identifier, String filePath) throws Exception{
