...
//    private static Random generator;
    ...
    private class Processing implements Runnable {
        ...
        Processing( HttpSession session, int threads, int requests, String capab, Map<String, String> paramsSet, boolean showImg ) {
        ...
        public void run() {
            try {
                ...
                Constructor<?> ctor = WPVSStressTest.class.getDeclaredConstructor( int.class, int.class, String.class, Map.class );
...
//    }
    ...
    private void renderResizedImage( HttpServletResponse response, String shot, int width, int height ) throws IOException {
    ...
    private void doStep1( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
    ...
    @SuppressWarnings("unchecked")
    private void doStep3( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
    ...
    private void doStep2( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
