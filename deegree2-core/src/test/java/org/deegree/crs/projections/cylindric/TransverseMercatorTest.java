//$HeadURL: svn+ssh://developername@svn.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/crs/projections/cylindric/TransverseMercatorTest.java $
/*----------------------------------------------------------------------------
...
public class TransverseMercatorTest extends ProjectionTest {
    ...
    public void testConsistency() {
        consistencyTest( projection_25832, 0, 500000, new Point2d( Math.toRadians( 9 ),
                                                                   0 ), Unit.METRE,
                                                                   0.9996, true, false, "transverseMercator" );
