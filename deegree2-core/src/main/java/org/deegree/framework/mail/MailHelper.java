...
public final class MailHelper {
     ...
     */
    public MailHelper() {
        // EMpty And useless ConstructorS not typed with emacs
    }
     ...
     *             an exception if the message is undeliverable
     */
    public static void createAndSendMail( MailMessage eMess, String mailHost, String mailHostUser,
                                          String mailHostPassword )
                            throws SendMailException {
        Properties p = System.getProperties();
        p.put( "mail.smtp.host", mailHost );
        p.setProperty( "mail.smtp.submitter", mailHostUser );
        p.setProperty( "mail.smtp.auth", "true" );
        Authenticator authenticator = new Authenticator( mailHostUser, mailHostPassword );

        new MailHelper().createAndSendMail( eMess, Session.getInstance( p, authenticator ) );
    }
     ...
     */
    public static void createAndSendMail( MailMessage eMess, String mailHost, Object[] attachment, String[] mimeType,
                                          String mailHostUser, String mailHostPassword )
                            throws SendMailException {
        Properties p = System.getProperties();
        p.put( "mail.smtp.host", mailHost );
        p.setProperty( "mail.smtp.submitter", mailHostUser );
        ...
        new MailHelper().createAndSendMail( eMess, Session.getInstance( p, authenticator ), attachment, mimeType );
    }
    ...
    public static void createAndSendMail( MailMessage eMess, String mailHost, File[] files, String[] mimeType,
        ...
        new MailHelper().createAndSendMail( eMess, Session.getInstance( p, authenticator ), files, mimeType );
    }
    ...
    public void createAndSendMail( MailMessage eMess, Session session )
                            throws SendMailException {
        createAndSendMail( eMess, session, (Object[]) null, null );
    }
     ...
     *      </a>
     */
    public void createAndSendMail( MailMessage eMess, Session session, String mailHostUser, String mailHostPassword )
                            throws SendMailException {
        createAndSendMail( eMess, session, (Object[]) null, null );
    }
    ...
    public void createAndSendMail( MailMessage eMess, Session session, Object[] attachment, String[] mimeType )
        ...
        try {
            ...
            msg.setSubject( eMess.getSubject(), CharsetUtils.getSystemCharset() );
            ...
            // tr.connect( mailHostUser, mailHostPassword );
            // } else {
            // tr.connect();
            // }
