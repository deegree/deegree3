...
public class Ellipsoid extends Identifiable implements Serializable {

    private static final long serialVersionUID = -2734558237905436138L;
     ...
     */
    public Ellipsoid( Unit units, double semiMajorAxis, double semiMinorAxis, Identifiable id ) {
        super( id );
        this.units = units;
    ...
    public Ellipsoid( Unit units, double semiMajorAxis, double semiMinorAxis, String[] identifiers, String[] names,
        ...
        this( units, semiMajorAxis, semiMinorAxis, new Identifiable( identifiers, names, versions, descriptions,
                                                                     areasOfUse ) );
    }
     ...
     */
    public Ellipsoid( double semiMajorAxis, Unit units, double inverseFlattening, Identifiable id ) {
        super( id );
        this.units = units;
        this.semiMajorAxis = semiMajorAxis;
    ...
    public Ellipsoid( double semiMajorAxis, Unit units, double inverseFlattening, String[] identifiers, String[] names,
                      String[] versions, String[] descriptions, String[] areasOfUse ) {
        this( semiMajorAxis, units, inverseFlattening, new Identifiable( identifiers, names, versions, descriptions,
                                                                         areasOfUse ) );
    }
     ...
     *            containing all id relevant data.
     */
    public Ellipsoid( double semiMajorAxis, double eccentricity, Unit units, Identifiable id ) {
        super( id );
        this.units = units;
        this.semiMajorAxis = semiMajorAxis;
    ...
    public Ellipsoid( double semiMajorAxis, double eccentricity, Unit units, String[] identifiers, String[] names,
                      String[] versions, String[] descriptions, String[] areasOfUse ) {
        this( semiMajorAxis, eccentricity, units, new Identifiable( identifiers, names, versions, descriptions,
                                                                    areasOfUse ) );
    }
