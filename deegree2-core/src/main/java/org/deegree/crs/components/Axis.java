...
public class Axis implements Serializable {
    ...
    private static final long serialVersionUID = -4527409382797041807L;
    ...
    public Axis( Unit units, String name, String orientation ) {
        ...
        if ( orientation != null ) {
            ...
            } else if ( tmp.contains( "south" ) || tmp.contains( "sued" ) ) {
    ...
    public String toString() {
        return new StringBuilder( "name: " ).append( name ).append( " orientation: " ).append( getOrientationAsString() ).append( " units: " ).append( units ).toString();
    }
