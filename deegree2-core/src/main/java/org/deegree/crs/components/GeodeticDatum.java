...
public class GeodeticDatum extends Datum {
     ...
     *            containing all relevant id data.
     */
    public GeodeticDatum( Ellipsoid ellipsoid, PrimeMeridian primeMeridian, Identifiable id ) {
    ...
    public GeodeticDatum( Ellipsoid ellipsoid, PrimeMeridian primeMeridian, Helmert toWGS84, String[] identifiers,
        ...
        this( ellipsoid, primeMeridian, toWGS84, new Identifiable( identifiers, names, versions, descriptions,
                                                                   areasOfUse ) );
    }
    ...
    public GeodeticDatum( Ellipsoid ellipsoid, Helmert toWGS84, String[] identifiers ) {
        this( ellipsoid, PrimeMeridian.GREENWICH, toWGS84, new Identifiable( identifiers, null, null, null, null ) );
    }
     ...
     */
    public GeodeticDatum( Ellipsoid ellipsoid, PrimeMeridian primeMeridian, Helmert toWGS84, String[] identifiers ) {
        this( ellipsoid, primeMeridian, toWGS84, new Identifiable( identifiers, null, null, null, null ) );
    }
    ...
    public GeodeticDatum( Ellipsoid ellipsoid, PrimeMeridian primeMeridian, Helmert toWGS84, String identifier,
        ...
        this( ellipsoid, primeMeridian, toWGS84, new Identifiable( new String[] { identifier }, new String[] { name },
                                                                   new String[] { version },
    ...
    public GeodeticDatum( Ellipsoid ellipsoid, Helmert toWGS84, String identifier, String name ) {
        this( ellipsoid, PrimeMeridian.GREENWICH, toWGS84, new Identifiable( new String[] { identifier },
    ...
    public GeodeticDatum( Ellipsoid ellipsoid, String identifier, String name ) {
        this( ellipsoid, PrimeMeridian.GREENWICH, null, new Identifiable( new String[] { identifier },
                                                                          new String[] { name }, null, null, null ) );
    }
     ...
     * (non-Javadoc)
     *
     * @see org.deegree.crs.Identifiable#toString()
     */
    @Override
