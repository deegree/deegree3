...
public final class Unit extends Identifiable implements Serializable {

    private static final long serialVersionUID = 4176657042228182638L;
    ...
    public Unit( final String symbol, final String name, final String id ) {
        super( new Identifiable( new String[] { id }, new String[] { name }, null, null, null ) );
        this.symbol = symbol;
        this.scale = 1;
        this.baseType = this;
    }
    ...
    /**
     * 
     * @return symbol (short string) for a Unit
     */
