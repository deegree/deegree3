...
public class MatrixTransform extends CRSTransformation {
     ...
     * @param numCol
     */
    private MatrixTransform( CoordinateSystem source, CoordinateSystem target, int numRow, int numCol, Identifiable id ) {
     ...
     */
    public MatrixTransform( CoordinateSystem source, CoordinateSystem target, final GMatrix matrix, Identifiable id ) {
    ...
    public MatrixTransform( CoordinateSystem source, CoordinateSystem target, final GMatrix matrix ) {
        this( source, target, matrix, new Identifiable( createFromTo( source.getIdentifier(), target.getIdentifier() ) ) );
    }
     ...
     *            an identifiable instance containing information about this transformation
     */
    public MatrixTransform( CoordinateSystem source, CoordinateSystem target, final Matrix3d matrix, Identifiable id ) {
     ...
     *            an identifiable instance containing information about this transformation
     */
    public MatrixTransform( CoordinateSystem source, CoordinateSystem target, Matrix4d matrix, Identifiable id ) {
     ...
     */
    public MatrixTransform( CoordinateSystem source, CoordinateSystem target, Matrix4d matrix,
                            String transformationName, Identifiable id ) {
