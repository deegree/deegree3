...
public class LeastSquareApproximation extends PolynomialTransformation {
    ...
    private static final long serialVersionUID = -8228847133699923749L;
    ...
    public LeastSquareApproximation( List<Double> firstParameters, List<Double> secondParameters,
        ...
        this( firstParameters, secondParameters, sourceCRS, targetCRS, scaleX, scaleY, new Identifiable( "EPSG::9645" ) );
    }
