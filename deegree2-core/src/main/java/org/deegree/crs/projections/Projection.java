...
public abstract class Projection extends Identifiable implements Serializable {

    private static final long serialVersionUID = 7369289115314441772L;
    ...
    public Projection( GeographicCRS geographicCRS, double falseNorthing, double falseEasting, Point2d naturalOrigin,
                       Unit units, double scale, boolean conformal, boolean equalArea, Identifiable id ) {
        super( id );
        this.scale = scale;
