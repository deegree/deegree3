...
class GetFeatureInfoResponseValidator extends ResponseValidator {
     ...
     * <li>a GML document
     * <li>a XML document
     * <li>any other kind of document that is valid against the formats defined for GetFeatureInfo
     * in the capabilities
     * </ul>
     ...
     * @param user
     * @return the validated response or the unaltered response.
     ...
     * @param mime
     * @param user
     * @return the html parameter.
     */
    private byte[] validateHTML( byte[] html, String mime, User user ) {
        // TODO
        // define useful post-validation for xml-documents
        // at the moment everything is valid
        return html;
