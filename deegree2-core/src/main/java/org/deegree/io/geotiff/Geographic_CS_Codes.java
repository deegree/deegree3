...
public class Geographic_CS_Codes {
    ...
    public static int getGeogrpahicCSTypeCode( String code )
                            throws GeoTiffException {
        if ( containsGeographicCSTypeCode( code ) ) {
            int value = Geographic_CS_Codes.geographic_cs_type_codes.get( code );
            return value;
        }
        throw new GeoTiffException( "Error in accessing Geogrpahics CS Type Code.\n" + "  Code: " + code
                                    + " not found." );
