...
public class TransactionException extends DatastoreException {
    ...
    /**
     * Constructs an instance of <code>TransactionException</code> with the specified detail
     * message.
     *
     * @param msg
     *            the detail message
    ...
    /**
     * Constructs an instance of <code>TransactionException</code> with the specified cause.
     *
     * @param cause
