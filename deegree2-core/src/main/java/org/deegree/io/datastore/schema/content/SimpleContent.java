...
/**
 * Marker interface for content of {@link MappedSimplePropertyType}s.
 *
...
public interface SimpleContent {
     ...
     *
     * @return true, if the content is updateable, false otherwise
     */
     ...
     *
     * @return true, if the content is suitable as a sort criterion, false otherwise
     */
