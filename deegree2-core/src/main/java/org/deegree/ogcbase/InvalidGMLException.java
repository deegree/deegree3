...
public class InvalidGMLException extends OGCWebServiceException {
     ...
     * @param message
     */
    public InvalidGMLException( String message ) {
        super( message );
    }
     ...
     * @param message
     */
    public InvalidGMLException( String locator, String message ) {
     ...
     * @param code
     */
    public InvalidGMLException( String locator, String message, ExceptionCode code ) {
