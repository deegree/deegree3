...
public class InvalidConfigurationException extends OGCWebServiceException {
     ...
     * @param message
     */
    public InvalidConfigurationException( String locator, String message ) {
     ...
     * @param code
     */
    public InvalidConfigurationException( String locator, String message, ExceptionCode code ) {
