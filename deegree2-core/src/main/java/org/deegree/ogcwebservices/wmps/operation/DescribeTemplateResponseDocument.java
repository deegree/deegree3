...
/**
 * 
 * Represents an Initial Response document for a WMPS DescribeTemplateResponse
 * 
...
public class DescribeTemplateResponseDocument extends DefaultOGCWebServiceResponse {
     ...
     * @param request
     */
    public DescribeTemplateResponseDocument( OGCWebServiceRequest request ) {
        super( request );
    }
    ...
    public void createEmptyDocument()
        ...
        URL url = DescribeTemplateResponseDocument.class.getResource( XML_TEMPLATE );
        if ( url == null ) {
