 ...
 * <p>
 * ...?request=GetAvailableTemplates&version=1.0.0
 * </p>
 * or as XML:
 * <p>
 * 
 ...
 * &lt;deegreewmps:GetAvailableTemplates xmlns:deegreewmps=&quot;http://www.deegree.org/wmps&quot; version=&quot;1.0.0&quot;/&gt;
 * </pre>
 * 
 * </p>
 * 
...
public class GetAvailableTemplates extends WMPSRequestBase {
     ...
     */
    public GetAvailableTemplates( String id, String version, Map<String, String> vendorSpecificParameter ) {
     ...
     * 
     * @param parameter
     * @return new {@link GetAvailableTemplates}
     */
    public static GetAvailableTemplates create( Map<String, String> parameter ) {
        String id = "" + System.currentTimeMillis();
        String version = retrieveVersionParameter( parameter );
        return new GetAvailableTemplates( id, version, parameter );
    }
     ...
     */
    public static GetAvailableTemplates create( Element request )
                            throws XMLParsingException {
        String id = "" + System.currentTimeMillis();
        String version;
        try {
        ...
        return new GetAvailableTemplates( id, version, new HashMap<String, String>() );
    }
