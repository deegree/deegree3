...
/**
 * Value of (optional) updateSequence parameter in GetCapabilities operation request is greater than
 * current value of service metadata updateSequence number
 * <p>
 * locator = None, omit �locator� parameter
 *
 * @version $Revision$
...
public class InvalidUpdateSequenceException extends OGCWebServiceException {
    ...
    private static final long serialVersionUID = 4236980134724213283L;
