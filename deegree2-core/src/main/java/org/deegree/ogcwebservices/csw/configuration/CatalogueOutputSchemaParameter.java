...
/**
 * Specialized implementation of the <code>OWSDomainType</code> used for specifying the
...
public class CatalogueOutputSchemaParameter extends OWSDomainType {
     ...
     * @param metadata
     */
    public CatalogueOutputSchemaParameter( String name,
                                           CatalogueOutputSchemaValue[] specializedValues,
