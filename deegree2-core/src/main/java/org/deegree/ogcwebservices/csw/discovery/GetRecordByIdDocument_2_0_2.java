...
public class GetRecordByIdDocument_2_0_2 extends GetRecordByIdDocument {
    ...
    GetRecordById parse( String id )
        ...
        try {
            ...
            outputSchema = XMLTools.getNodeAsString( contextNode, "@outputSchema", nsContext, null);
        ...
        return new GetRecordById( id, version, vendorSpecificParameters, ids, elementSetName, outputSchema );
    }
