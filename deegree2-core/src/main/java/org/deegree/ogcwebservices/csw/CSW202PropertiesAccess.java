...
public class CSW202PropertiesAccess {
    ...
    private static final ILogger LOG = LoggerFactory.getLogger( CSW202PropertiesAccess.class );
    ...
    public static Connection getConnection()
        ...
        props.setProperty( "user", getString( "db.user" ) );
        props.setProperty( "password", getString( "db.password" ) );
        return DriverManager.getConnection( getString( "db.url" ), props );
    }
