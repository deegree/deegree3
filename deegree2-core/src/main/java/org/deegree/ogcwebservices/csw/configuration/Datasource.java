...
public class Datasource {
     ...
     *
     * @return the data service assigned with the <code>Datasource</code>
     */
    ...
    /**
     * returns the {@link OnlineResource} where to access the capabilities of the the OWS assigned
     * with the <code>Datasource</code>
     *
     * @return the OnlineResource where to access the capabilities of the the OWS assigned with the
