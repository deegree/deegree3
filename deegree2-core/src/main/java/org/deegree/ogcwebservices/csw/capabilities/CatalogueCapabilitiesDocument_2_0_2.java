 ...
 *
 */
public class CatalogueCapabilitiesDocument_2_0_2 extends CatalogueCapabilitiesDocument {

    private static final long serialVersionUID = -5403408250387290444L;

    private static final ILogger LOG = LoggerFactory.getLogger( CatalogueCapabilitiesDocument_2_0_2.class );

    protected static final URI OGCNS = CommonNamespaces.OGCNS;

    private static final String XML_TEMPLATE = "CatalogueCapabilities2.0.2Template.xml";
    ...
    public void createEmptyDocument()
        ...
        URL url = CatalogueCapabilitiesDocument_2_0_2.class.getResource( XML_TEMPLATE );
        if ( url == null ) {
