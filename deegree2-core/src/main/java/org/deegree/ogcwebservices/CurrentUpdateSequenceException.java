...
public class CurrentUpdateSequenceException extends OGCWebServiceException {
     ...
     * @param message
     */
    public CurrentUpdateSequenceException( String message ) {
        super( message );
     ...
     * @param message
     */
    public CurrentUpdateSequenceException( String locator, String message ) {
     ...
     * @param code
     */
    public CurrentUpdateSequenceException( String locator, String message, ExceptionCode code ) {
