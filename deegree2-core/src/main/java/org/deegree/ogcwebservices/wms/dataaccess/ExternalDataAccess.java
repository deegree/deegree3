...
public interface ExternalDataAccess {
     ...
     *
     * @param url
     *            URL containing configuration informations for data access
     * @throws IOException
     */
     ...
     *
     * @param gfi
     * @return {@link GetFeatureInfoResult} as result to passed {@link GetFeatureInfo} request
     */
     ...
     *
     * @param glg
     * @return {@link BufferedImage} as result to passed {@link GetLegendGraphic} request
     */
