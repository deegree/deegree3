...
/**
 * <code>GetTransformationDocument</code> TODO add documentation here
 *
...
public class GetTransformationDocument extends WCTSRequestBaseDocument{
     ...
     */
    public GetTransformationDocument( String requestID, Element rootElement ) throws IllegalArgumentException {
        super( rootElement );
        //nottin yet
    }
    /**
     * @return the getTransformationRequest.
     */
    public final GetTransformation getRequest() {
        return getTransformationRequest;
    }
