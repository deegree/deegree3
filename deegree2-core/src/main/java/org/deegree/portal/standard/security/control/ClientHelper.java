...
public class ClientHelper {
    ...
    /**
     * Tries to acquire a <code>SecurityAccess</code> for the credentials (username, password)
     * stored in the associated <code>HttpSesssion</code> of the given
     * <code>AbstractListener</code>.
     *
     * @param listener
    ...
    /**
     * Tries to acquire a <code>SecurityTransaction</code> for the credentials (username,
     * password) stored in the associated <code>HttpSesssion</code>.
     *
     * @param listener
     * @throws GeneralSecurityException
