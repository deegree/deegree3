 ...
 */
public class LoadTemplateListener extends AbstractMetadataListener {

    private static ILogger LOG = LoggerFactory.getLogger( LoadTemplateListener.class );
    ...
    public void actionPerformed( WebEvent event, ResponseHandler responseHandler )
        ...
        LOG.logDebug( "load template request param: ", param );
        ...
        String s = getValue( config.getXPath( "accessConstraints" ) );
        if ( s == null ) {
