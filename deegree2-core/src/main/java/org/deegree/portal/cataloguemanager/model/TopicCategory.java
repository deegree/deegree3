...
@XmlRootElement(name = "topicCategory")
public class TopicCategory {

    @XmlElement(name = "MD_TopicCategoryCode", required = true)
    protected String mdTopicCategoryCode;
     ...
     *     
     */
    public String getMDTopicCategoryCode() {
     ...
     *     
     */
    public void setMDTopicCategoryCode(String value) {
