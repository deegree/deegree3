 ...
 */
public class GetResponsiblePartiesListener extends AbstractMetadataListener {
    ...
    public void actionPerformed( WebEvent event, ResponseHandler responseHandler )
        ...
        List<RespPartyConfiguration> respParties = config.getResponsibleParties();
        String charEnc = Charset.defaultCharset().displayName();
        responseHandler.setContentType( "application/json; charset=" + charEnc );
        responseHandler.writeAndClose( false, respParties );        
    }
