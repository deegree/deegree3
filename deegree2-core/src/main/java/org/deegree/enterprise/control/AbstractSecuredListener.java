...
/**
 * This abstract <tt>Listener</tt> ensures that only privileged users have access to the services
 * provided by derived implementations.
 * <p> - This class is extended by Listeners that may require security checks. - The extended
