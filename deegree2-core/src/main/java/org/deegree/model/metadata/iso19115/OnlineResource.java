...
public class OnlineResource implements Serializable {
     ...
     * @param protocol
     */
    public OnlineResource( String applicationprofile, FunctionCode functioncode, Linkage linkage,
                           String onlineresourcedescription, String onlineresourcename, String protocol ) {
    ...
    /**
     * @return online resource description
     */
