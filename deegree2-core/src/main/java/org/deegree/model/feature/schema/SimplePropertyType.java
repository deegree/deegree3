...
public class SimplePropertyType extends AbstractPropertyType {
    ...
    /**
     * Constructs a new instance of <code>SimplePropertyType</code> from the given parameters.
     *
     * @param name
     * @param type
     * @param minOccurs
     * @param maxOccurs
     */
    public SimplePropertyType( QualifiedName name, int type, int minOccurs, int maxOccurs ) {
