...
/**
 *
 * The specialisation of the OrientablePrimitive as a curve. Note that a orientated geometry can only have one
...
public interface OrientableCurve extends OrientablePrimitive {
    ...
    /**
     * @return the curve boundary of an orientable curve.
     */
