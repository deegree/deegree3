 ...
 *         <p>
 */
public abstract class PrimitiveBoundaryImpl extends BoundaryImpl implements PrimitiveBoundary, Serializable {
     ...
     * @param srs
     */
    protected PrimitiveBoundaryImpl( CoordinateSystem srs ) {
        super( srs );
    }
}
