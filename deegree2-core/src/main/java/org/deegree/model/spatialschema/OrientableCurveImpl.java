 ...
 *         <p>
 */
public abstract class OrientableCurveImpl extends OrientablePrimitiveImpl implements OrientableCurve, Serializable {
     ...
     */
    protected OrientableCurveImpl( CoordinateSystem crs ) throws GeometryException {
        super( crs, '+' );
    }
     ...
     * @throws GeometryException
     */
    protected OrientableCurveImpl( CoordinateSystem crs, char orientation ) throws GeometryException {
