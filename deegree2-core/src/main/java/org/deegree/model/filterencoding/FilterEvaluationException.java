...
/**
 * This exception is thrown when the evaluation of a <tt>Filter</tt> expression (or subexpression)
 * is impossible, e.g. a PropertyIsLessThan- Comparison is to be applied against a <tt>String</tt>-value.
 *
