 ...
 */
public class DBSchemaToDatastoreConfSQLXSDAccess {
    ...
    static {
        try {
            String fileName = "DBSchemaToDatastoreConfSchema.properties";
            InputStream is = DBSchemaToDatastoreConfSQLXSDAccess.class.getResourceAsStream( fileName );
            props.load( is );
            is.close();
        } catch ( IOException e ) {
     ...
     */
    public static String getXSDFragment( String key, Object... arguments ) {
        ...
        // to avoid NPEs
        return "$XSDFragment with key: " + key + " not found$";
    }
}
