...
/**
 * <code>Export3DFile</code> shows a dialog to the user in which export parameters can be set, and calls the
...
public class Export3DFile {
    private static ILogger LOG = LoggerFactory.getLogger( Export3DFile.class );
    ...
    /**
     * Will hold a class name of the exporter selected by the user (set in the anonymous Actionlistener of the the
     * ok-button of the ExportDialog)
     */
     ...
     *
     * @param toExport
     *            the actual branchgroup
     * @return the String representation of the exported branch group.
     */
    public StringBuilder exportBranchgroup( BranchGroup toExport ) {
    ...
    /**
     * Creates a parameter dialog which by clicking ok sets all the values fromt the original map to the result map if
