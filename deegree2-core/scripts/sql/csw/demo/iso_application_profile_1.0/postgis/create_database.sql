...
CREATE TABLE CI_Citation ( 
    ...
    otherCitationDetails varchar(500),
    context varchar(50)
) 
 ;
...
CREATE TABLE DQ_ConformanceResult (
    ID integer DEFAULT NEXTVAL('DQ_ConformanceResult_ID_seq'::TEXT),
    fk_element integer,
...
CREATE TABLE DQ_Element ( 
    ...
    measureIdentCode varchar(150),
    measureIdentCodeSpace varchar(250),
    type varchar(50),
...
CREATE TABLE DQ_QuantitativeResult (
    ID integer DEFAULT NEXTVAL('DQ_QuantitativeResult_ID_seq'::TEXT),
    fk_element integer,
...
CREATE TABLE DS_AssociationTypeCode (
    ID integer DEFAULT NEXTVAL('DS_AssociationTypeCode_ID_seq'::TEXT),
    codeListValue varchar(50),
    codeSpace varchar(500)
)
 ;
...
CREATE TABLE Language (
    ...
    ID integer DEFAULT NEXTVAL('Language_ID_seq'::TEXT)
)
 ;
...
CREATE TABLE MD_AggregateInfo (
    ID integer DEFAULT NEXTVAL('MD_AggregateInfo_ID_seq'::TEXT),
    FK_DataIdent integer,
    FK_DateSetName integer,
    FK_TypeCode integer
)
 ;
...
CREATE TABLE MD_DataIdentification ( 
    ...
    supplementalInformation varchar(1000),
    uuid varchar(250)
) 
 ;
...
CREATE TABLE MD_Metadata ( 
    ...
    dateStamp timestamp,
    mdStandName varchar(100),
    mdStandVersion varchar(100),
...
CREATE TABLE PT_Locale (
    ID integer DEFAULT NEXTVAL('PT_Locale_ID_seq'::TEXT),
    languageCode varchar(150),
    country varchar(150),
    FK_CharacterEncoding integer
)
 ;
...
CREATE TABLE PublicationDate (
    ...
    ID integer DEFAULT NEXTVAL('PublicationDate_ID_seq'::TEXT)
)
 ;

CREATE TABLE QuantitativeRes_Value (
    ID integer DEFAULT NEXTVAL('QuantitativeRes_Value_ID_seq'::TEXT),
    fk_quantitativeResult integer,
    value varchar(50)
)
 ;
...
SELECT AddGeometryColumn('', 'ex_boundingpolygon','geom', 4326,'POLYGON',2);
SELECT AddGeometryColumn('', 'ex_geogrbbox','geom', 4326,'POLYGON',2);
...
ALTER TABLE MD_ApplicationSchemaInformation ADD CONSTRAINT PK_MD_ApplicationSchemaInformation PRIMARY KEY (ID) ;
...
ALTER TABLE MD_VectorSpatialReprenstation ADD CONSTRAINT PK_MD_VectorSpatialReprenstation PRIMARY KEY (ID) ;
...
ALTER TABLE DQ_ConformanceResult ADD CONSTRAINT UQ_DQ_ConformanceResult_ID UNIQUE (ID) ;
ALTER TABLE DQ_Element ADD CONSTRAINT UQ_DQ_Element_ID UNIQUE (ID) ;
ALTER TABLE DQ_QuantitativeResult ADD CONSTRAINT UQ_DQ_QuantitativeResult_ID UNIQUE (ID) ;
ALTER TABLE DS_AssociationTypeCode ADD CONSTRAINT DS_AssociationTypeCode_codeListValue UNIQUE (codeListValue) ;
ALTER TABLE DS_AssociationTypeCode ADD CONSTRAINT DS_AssociationTypeCode_ID UNIQUE (ID) ;
...
ALTER TABLE Language ADD CONSTRAINT UQ_Language_ID UNIQUE (ID) ;
ALTER TABLE MD_AggregateInfo ADD CONSTRAINT MD_AggregateInfo_ID UNIQUE (ID) ;
...
ALTER TABLE PT_Locale ADD CONSTRAINT PT_Locale_ID UNIQUE (ID) ;
ALTER TABLE PublicationDate ADD CONSTRAINT UQ_PublicationDate_ID UNIQUE (ID) ;
...
CREATE SEQUENCE DQ_ConformanceResult_ID_seq ;
CREATE SEQUENCE DQ_DataQuality_ID_seq ;
CREATE SEQUENCE DQ_Element_ID_seq ;
CREATE SEQUENCE DQ_QuantitativeResult_ID_seq ;
CREATE SEQUENCE DS_AssociationTypeCode_ID_seq;
...
CREATE SEQUENCE MD_AggregateInfo_ID_seq;
...
CREATE SEQUENCE MD_Constraints_ID_seq ;
...
CREATE SEQUENCE PT_Locale_ID_seq;
CREATE SEQUENCE PublicationDate_ID_seq ;
CREATE SEQUENCE QuantitativeRes_Value_ID_seq ;
...
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( '4mmCartridgeTape' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( '8mmCartridgeTape' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( '1quarterInchCartridgeTape' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( 'digitalLinearTape' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( 'onLine' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( 'satellite' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( 'telephoneLink' ) ;
INSERT INTO MD_MediumNameCode ( codeListValue) VALUES ( 'hardcopy' ) ;
...
-- Codelist DCP Type
insert into sv_dcplist ( codeListValue ) values ( 'WebServices' );
...
insert into ds_associationtypecode ( codeListValue ) values ( 'crossReference' );
insert into ds_associationtypecode ( codeListValue ) values ( 'largerWorkCitation' );
insert into ds_associationtypecode ( codeListValue ) values ( 'partOfSeamlessDatabase' );
insert into ds_associationtypecode ( codeListValue ) values ( 'source' );
insert into ds_associationtypecode ( codeListValue ) values ( 'stereoMate' );