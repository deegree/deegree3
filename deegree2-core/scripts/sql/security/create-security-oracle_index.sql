...
create index idx_FK_SEC_OBJ1 on SEC_JT_ROLES_SECOBJECTS (FK_SECURABLE_OBJECTS);
...
create index idx_FK_SEC_OBJ_TYPES on SEC_SECURED_OBJECTS(FK_SECURED_OBJECT_TYPES);