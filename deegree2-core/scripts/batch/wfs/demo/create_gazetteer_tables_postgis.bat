...
shp2pgsql -s 26912 -c ..\..\data\utah\vector\SGID024_Municipalities2004_edited imp_municipalities > ..\..\data\imp_municipalities.sql
psql -f ..\..\data\imp_municipalities.sql -d deegreetest -U deegreetest
shp2pgsql -s 26912  -c ..\..\data\utah\vector\SGID100_CountyBoundaries_edited imp_counties > ..\..\data\imp_counties.sql
psql -f ..\..\data\imp_counties.sql -d deegreetest -U deegreetest
