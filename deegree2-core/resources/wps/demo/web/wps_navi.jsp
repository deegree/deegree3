...
<%
    String docPath = "http://download.deegree.org/deegree" + Version.getVersionNumber() + "/docs/wps";
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>deegree processingService</title>
        <link rel="stylesheet" type="text/css" href="css/deegree.css" />
    </head>
    <body>
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
                <th>deegree Web&nbsp;Processing&nbsp;Service</th>
            </tr>
            <tr>
                <td class="menu">
                    <a href="wps_basic.html" target="main">Basic WPS Requests</a><br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td class="menu">
                    ...
                    <a href="<%=docPath %>/deegree_wps_documentation_en.pdf" target="_blank">deegree WPS</a> [PDF]<br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td>
                    <a href="wps.jsp" target="_top">WPS home page</a><br />
