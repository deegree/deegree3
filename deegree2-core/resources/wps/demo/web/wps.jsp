        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td valign="top" style="width:250px">
                    <iframe name="navi" frameborder="0" src="wps_navi.jsp" scrolling="auto" width="100%" height="650"></iframe>
                </td>
                <td style="width:20px">&nbsp;</td>
                <!-- Body -->
                <td align="left" valign="top">
                    <iframe name="main" frameborder="0" src="wps_main.html" scrolling="auto" width="100%" height="650"></iframe>
                </td>
            </tr>
        </table>
    </body>
