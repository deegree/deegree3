        ...
        <table width="100%">
            ...
            <tr>
                <td valign="top"colspan="3">
                    <iframe name="header" frameborder="0" src="csw_header.jsp" scrolling="auto" width="100%" height="115px"></iframe>
                </td>
            </tr>
            <!-- Content -->
            <tr>
                ...
                <td valign="top" style="width:250px">
                    <iframe name="navi" frameborder="0" src="csw_navi.jsp" scrolling="auto" width="100%" height="650"></iframe>
                </td>
                <td style="width:20px">&nbsp;</td>
                <!-- Body -->
                <td align="left" valign="top">
                    <iframe name="main" frameborder="0" src="csw_appselect_<%=lang %>.jsp" scrolling="auto" width="95%" height="650"></iframe>
                </td>
            </tr>
        </table>
    </body>
