...
<%
    String docPath = "http://download.deegree.org/deegree" + Version.getVersionNumber() + "/docs/wpvs";
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>deegree perspectiveviewService</title>
        <link rel="stylesheet" type="text/css" href="css/deegree.css" />
    </head>
    <body>
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
                <th>deegree Web Perspective View Service</th>
            </tr>
            <tr>
                <td class="menu">
                    <a href="wpvs_basic.html" target="main">Basic WPVS Requests</a><br />
                    <a href="client/wpvsclient.jsp" target="_blank">WPVS Client</a>
                </td>
            </tr>
        </table>
        <br />
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td class="menu">
                    <strong>WPVS</strong><br />
                    <a href="<%=docPath %>/deegree_wpvs_documentation_en.pdf" target="_blank">deegree WPVS</a> [PDF]<br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td>
                    <a href="wpvs.jsp" target="_top">WPVS home page</a><br />
