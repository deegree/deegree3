<?xml version="1.0" encoding="UTF-8"?>
  <!--
    Default conversion script for transforming the GML response to a GetFeatureInfo request into a HTML-format. author: Andreas Poth last edited by:
    $Author: hrubach $ version: $Revision: 25184 $, $Date: 2010-07-06 17:11:17 +0200 (Di, 06 Jul 2010) $ (c) deegree - LGPL
  -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ll="http://www.lat-lon.de" xmlns:fo="http://www.w3.org/1999/XSL/Format"
        ...
        <td bgcolor="#A0A5C5">
          ...
          <xsl:for-each select="./child::*">
            <font face="Helvetica, Arial, sans-serif">
              ...
              <!--
                <xsl:for-each select="./child::*"> <xsl:value-of select="local-name( . )"/> = <xsl:value-of select="."/> <br/> </xsl:for-each>
              -->
              <xsl:for-each select="./child::*">
