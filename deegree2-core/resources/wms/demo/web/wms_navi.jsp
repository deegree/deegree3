...
<%
    String docPath = "http://download.deegree.org/deegree" + Version.getVersionNumber() + "/docs/wms";
%>
<html>
    <head>
    ...
    <body>
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
                <th>deegree Web&nbsp;Map&nbsp;Service</th>
            </tr>
            <tr>
                <td class="menu">
                    <a href="wms_basic.html" target="main">Basic WMS requests</a><br />
                    <a href="wms_getmap.html" target="main">Special WMS GetMap requests</a><br />
                    <a href="wms_deegree.html" target="main">Special features of deegree WMS</a><br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td class="menu">
                    ...
                    <a href="<%=docPath %>/deegree_wms_documentation_en.pdf" target="blank">deegree WMS</a> [PDF]<br />
                    <a href="<%=docPath %>/deegree_charts_documentation_en.pdf" target="_blank">deegree Charts</a> [PDF]<br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td>
                    <a href="wms.jsp" target="_top">WMS home page</a><br />
