...
<%
    String docPath = "http://download.deegree.org/deegree" + Version.getVersionNumber() + "/docs/wcs";
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>deegree coverageService</title>
        <link rel="stylesheet" type="text/css" href="css/deegree.css" />
    </head>
    <body>
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
                <th>deegree Web&nbsp;Coverage&nbsp;Service</th>
            </tr>
            <tr>
                <td class="menu">
                    <a href="wcs_basic.html" target="main">Basic WCS requests</a>
                </td>
            </tr>
        </table>
        <br />
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td class="menu">
                    ...
                    <a href="<%=docPath %>/deegree_wcs_documentation_en.pdf" target="_blank">deegree WCS</a> [PDF]<br />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td>
                    <a href="wcs.jsp" target="_top">WCS home page</a><br />
